...
Contribution metrics are not available for organizations with [Zero Data Retention](/docs/en/data-usage#data-retention) enabled. The analytics dashboard will show usage metrics only.
