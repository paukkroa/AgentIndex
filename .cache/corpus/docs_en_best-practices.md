...
| --- | --- | --- |
| **Provide verification criteria** | *”implement a function that validates email addresses"* | *"write a validateEmail function. example test cases: [[email protected]](/cdn-cgi/l/email-protection#dca9afb9ae9cb9a4bdb1acb0b9f2bfb3b1) is true, invalid is false, [[email protected]](/cdn-cgi/l/email-protection#d9acaabcab99f7bab6b4) is false. run the tests after implementing”* |
