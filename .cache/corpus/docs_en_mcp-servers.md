...
[Connect Claude Code to tools via MCP](/docs/en/mcp#connect-claude-code-to-tools-via-mcp)[Plugins reference](/docs/en/plugins-reference#mcp-servers)[Best Practices for Claude Code](/docs/en/best-practices#connect-mcp-servers)
