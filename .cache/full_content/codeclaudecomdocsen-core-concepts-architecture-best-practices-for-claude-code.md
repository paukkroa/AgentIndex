...
| --- | --- | --- |
| **Provide verification criteria** | *”implement a function that validates email addresses"* | *"write a validateEmail function. example test cases: [[email protected]](/cdn-cgi/l/email-protection#c7b2b4a2b587a2bfa6aab7aba2e9a4a8aa) is true, invalid is false, [[email protected]](/cdn-cgi/l/email-protection#8df8fee8ffcda3eee2e0) is false. run the tests after implementing”* |
