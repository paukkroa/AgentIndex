...
* [next](../howto/argparse.html "Argparse Tutorial") |
* [previous](cmdlinelibs.html "Command-line interface libraries") |
...
# `argparse` — Parser for command-line options, arguments and subcommands[¶](#module-argparse "Link to this heading")
...
## ArgumentParser objects[¶](#argumentparser-objects "Link to this heading")

*class* argparse.ArgumentParser(*prog=None*, *usage=None*, *description=None*, *epilog=None*, *parents=[]*, *formatter\_class=argparse.HelpFormatter*, *prefix\_chars='-'*, *fromfile\_prefix\_chars=None*, *argument\_default=None*, *conflict\_handler='error'*, *add\_help=True*, *allow\_abbrev=True*, *exit\_on\_error=True*, *\**, *suggest\_on\_error=False*, *color=True*)[¶](#argparse.ArgumentParser "Link to this definition")
...
*class* argparse.RawDescriptionHelpFormatter[¶](#argparse.RawDescriptionHelpFormatter "Link to this definition")

*class* argparse.RawTextHelpFormatter[¶](#argparse.RawTextHelpFormatter "Link to this definition")

*class* argparse.ArgumentDefaultsHelpFormatter[¶](#argparse.ArgumentDefaultsHelpFormatter "Link to this definition")

*class* argparse.MetavarTypeHelpFormatter[¶](#argparse.MetavarTypeHelpFormatter "Link to this definition")
...
## The add\_argument() method[¶](#the-add-argument-method "Link to this heading")

ArgumentParser.add\_argument(*name or flags...*, *\**[, *action*][, *nargs*][, *const*][, *default*][, *type*][, *choices*][, *required*][, *help*][, *metavar*][, *dest*][, *deprecated*])[¶](#argparse.ArgumentParser.add_argument "Link to this definition")
...
### Action classes[¶](#action-classes "Link to this heading")
...
*class* argparse.Action(*option\_strings*, *dest*, *nargs=None*, *const=None*, *default=None*, *type=None*, *choices=None*, *required=False*, *help=None*, *metavar=None*)[¶](#argparse.Action "Link to this definition")
:   `Action` objects are used by an [`ArgumentParser`](#argparse.ArgumentParser "argparse.ArgumentParser") to represent the information
    ...
    \_\_call\_\_(*parser*, *namespace*, *values*, *option\_string=None*)[¶](#argparse.Action.__call__ "Link to this definition")
...
*class* argparse.BooleanOptionalAction[¶](#argparse.BooleanOptionalAction "Link to this definition")
...
## The parse\_args() method[¶](#the-parse-args-method "Link to this heading")

ArgumentParser.parse\_args(*args=None*, *namespace=None*)[¶](#argparse.ArgumentParser.parse_args "Link to this definition")
...
### Option value syntax[¶](#option-value-syntax "Link to this heading")
...
### Invalid arguments[¶](#invalid-arguments "Link to this heading")
...
### Arguments containing `-`[¶](#arguments-containing "Link to this heading")
...
### Argument abbreviations (prefix matching)[¶](#argument-abbreviations-prefix-matching "Link to this heading")
...
### Beyond `sys.argv`[¶](#beyond-sys-argv "Link to this heading")
...
### The Namespace object[¶](#the-namespace-object "Link to this heading")

*class* argparse.Namespace[¶](#argparse.Namespace "Link to this definition")
...
## Other utilities[¶](#other-utilities "Link to this heading")

### Subcommands[¶](#subcommands "Link to this heading")

ArgumentParser.add\_subparsers(*\**[, *title*][, *description*][, *prog*][, *parser\_class*][, *action*][, *dest*][, *required*][, *help*][, *metavar*])[¶](#argparse.ArgumentParser.add_subparsers "Link to this definition")
:   Many programs split up their functionality into a number of subcommands,
    ...
    * [metavar](#metavar) - string presenting available subcommands in help; by default it
    ...
    The [`add_subparsers()`](#argparse.ArgumentParser.add_subparsers "argparse.ArgumentParser.add_subparsers") method also supports `title` and `description`
    ...
    *deprecated* argument, which allows to deprecate the subparser.
    ...
    of the [`add_subparsers()`](#argparse.ArgumentParser.add_subparsers "argparse.ArgumentParser.add_subparsers") method with calls to [`set_defaults()`](#argparse.ArgumentParser.set_defaults "argparse.ArgumentParser.set_defaults") so
    ...
    argument to the [`add_subparsers()`](#argparse.ArgumentParser.add_subparsers "argparse.ArgumentParser.add_subparsers") call will work:
...
### FileType objects[¶](#filetype-objects "Link to this heading")

*class* argparse.FileType(*mode='r'*, *bufsize=-1*, *encoding=None*, *errors=None*)[¶](#argparse.FileType "Link to this definition")
:   The [`FileType`](#argparse.FileType "argparse.FileType") factory creates objects that can be passed to the type
    ...
    [`FileType`](#argparse.FileType "argparse.FileType") objects as their type will open command-line arguments as
    ...
    convert this into [`sys.stdin`](sys.html#sys.stdin "sys.stdin") for readable [`FileType`](#argparse.FileType "argparse.FileType") objects and
    [`sys.stdout`](sys.html#sys.stdout "sys.stdout") for writable [`FileType`](#argparse.FileType "argparse.FileType") objects:
...
### Argument groups[¶](#argument-groups "Link to this heading")

ArgumentParser.add\_argument\_group(*title=None*, *description=None*, *\**[, *argument\_default*][, *conflict\_handler*])[¶](#argparse.ArgumentParser.add_argument_group "Link to this definition")
:   By default, [`ArgumentParser`](#argparse.ArgumentParser "argparse.ArgumentParser") groups command-line arguments into
    ...
    The [`add_argument_group()`](#argparse.ArgumentParser.add_argument_group "argparse.ArgumentParser.add_argument_group") method returns an argument group object which
    ...
    Deprecated since version 3.11, removed in version 3.14: Calling [`add_argument_group()`](#argparse.ArgumentParser.add_argument_group "argparse.ArgumentParser.add_argument_group") on an argument group now raises an
    ...
    Deprecated since version 3.14: Passing [prefix\_chars](#prefix-chars) to [`add_argument_group()`](#argparse.ArgumentParser.add_argument_group "argparse.ArgumentParser.add_argument_group")
    is now deprecated.

### Mutual exclusion[¶](#mutual-exclusion "Link to this heading")

ArgumentParser.add\_mutually\_exclusive\_group(*required=False*)[¶](#argparse.ArgumentParser.add_mutually_exclusive_group "Link to this definition")
:   Create a mutually exclusive group. `argparse` will make sure that only
    ...
    The [`add_mutually_exclusive_group()`](#argparse.ArgumentParser.add_mutually_exclusive_group "argparse.ArgumentParser.add_mutually_exclusive_group") method also accepts a *required*
    ...
    *title* and *description* arguments of
    ...
    Deprecated since version 3.11, removed in version 3.14: Calling [`add_argument_group()`](#argparse.ArgumentParser.add_argument_group "argparse.ArgumentParser.add_argument_group") or [`add_mutually_exclusive_group()`](#argparse.ArgumentParser.add_mutually_exclusive_group "argparse.ArgumentParser.add_mutually_exclusive_group")
...
### Parser defaults[¶](#parser-defaults "Link to this heading")

ArgumentParser.set\_defaults(*\*\*kwargs*)[¶](#argparse.ArgumentParser.set_defaults "Link to this definition")
:   Most of the time, the attributes of the object returned by [`parse_args()`](#argparse.ArgumentParser.parse_args "argparse.ArgumentParser.parse_args")
    ...
    actions. [`set_defaults()`](#argparse.ArgumentParser.set_defaults "argparse.ArgumentParser.set_defaults") allows some additional
    ...
    Note that defaults can be set at both the parser level using [`set_defaults()`](#argparse.ArgumentParser.set_defaults "argparse.ArgumentParser.set_defaults")
...
ArgumentParser.get\_default(*dest*)[¶](#argparse.ArgumentParser.get_default "Link to this definition")
...
### Printing help[¶](#printing-help "Link to this heading")
...
ArgumentParser.print\_usage(*file=None*)[¶](#argparse.ArgumentParser.print_usage "Link to this definition")
...
ArgumentParser.print\_help(*file=None*)[¶](#argparse.ArgumentParser.print_help "Link to this definition")
...
### Partial parsing[¶](#partial-parsing "Link to this heading")

ArgumentParser.parse\_known\_args(*args=None*, *namespace=None*)[¶](#argparse.ArgumentParser.parse_known_args "Link to this definition")
:   Sometimes a script only needs to handle a specific set of command-line
    ...
    In these cases, the [`parse_known_args()`](#argparse.ArgumentParser.parse_known_args "argparse.ArgumentParser.parse_known_args") method can be
    useful.
...
### Customizing file parsing[¶](#customizing-file-parsing "Link to this heading")

ArgumentParser.convert\_arg\_line\_to\_args(*arg\_line*)[¶](#argparse.ArgumentParser.convert_arg_line_to_args "Link to this definition")
:   Arguments that are read from a file (see the *fromfile\_prefix\_chars*
    ...
    argument per line. [`convert_arg_line_to_args()`](#argparse.ArgumentParser.convert_arg_line_to_args "argparse.ArgumentParser.convert_arg_line_to_args") can be overridden for
    fancier reading.
...
### Exiting methods[¶](#exiting-methods "Link to this heading")

ArgumentParser.exit(*status=0*, *message=None*)[¶](#argparse.ArgumentParser.exit "Link to this definition")
...
ArgumentParser.error(*message*)[¶](#argparse.ArgumentParser.error "Link to this definition")
...
### Intermixed parsing[¶](#intermixed-parsing "Link to this heading")

ArgumentParser.parse\_intermixed\_args(*args=None*, *namespace=None*)[¶](#argparse.ArgumentParser.parse_intermixed_args "Link to this definition")

ArgumentParser.parse\_known\_intermixed\_args(*args=None*, *namespace=None*)[¶](#argparse.ArgumentParser.parse_known_intermixed_args "Link to this definition")
:   A number of Unix commands allow the user to intermix optional arguments with
    ...
    and [`parse_known_intermixed_args()`](#argparse.ArgumentParser.parse_known_intermixed_args "argparse.ArgumentParser.parse_known_intermixed_args") methods
    ...
    [`parse_known_intermixed_args()`](#argparse.ArgumentParser.parse_known_intermixed_args "argparse.ArgumentParser.parse_known_intermixed_args") returns a two item tuple
...
### Registering custom types or actions[¶](#registering-custom-types-or-actions "Link to this heading")

ArgumentParser.register(*registry\_name*, *value*, *object*)[¶](#argparse.ArgumentParser.register "Link to this definition")
...
*exception* argparse.ArgumentError[¶](#argparse.ArgumentError "Link to this definition")
:   An error from creating or using an argument (optional or positional).

    The string value of this exception is the message, augmented with
    information about the argument that caused it.

*exception* argparse.ArgumentTypeError[¶](#argparse.ArgumentTypeError "Link to this definition")
...
* [`argparse` — Parser for command-line options, arguments and subcommands](#)
  + [ArgumentParser objects](#argumentparser-objects)
    ...
    - [epilog](#epilog)
    - [parents](#parents)
    - [formatter\_class](#formatter-class)
    - [prefix\_chars](#prefix-chars)
    - [fromfile\_prefix\_chars](#fromfile-prefix-chars)
    - [argument\_default](#argument-default)
    - [allow\_abbrev](#allow-abbrev)
    - [conflict\_handler](#conflict-handler)
    - [add\_help](#add-help)
    - [exit\_on\_error](#exit-on-error)
    - [suggest\_on\_error](#suggest-on-error)
    - [color](#color)
  + [The add\_argument() method](#the-add-argument-method)
  ...
  + [The parse\_args() method](#the-parse-args-method)
...
[Command-line interface libraries](cmdlinelibs.html "previous chapter")

#### Next topic

[Argparse Tutorial](../howto/argparse.html "next chapter")

### This page

* [Report a bug](../bugs.html)
* [Improve this page](../improve-page-nojs.html)
* [Show source](https://github.com/python/cpython/blob/main/Doc/library/argparse.rst?plain=1)
