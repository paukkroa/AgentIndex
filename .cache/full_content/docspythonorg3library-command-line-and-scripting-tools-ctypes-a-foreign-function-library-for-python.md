...
* [next](cmdlinelibs.html "Command-line interface libraries") |
* [previous](errno.html "errno — Standard errno system symbols") |
...
# `ctypes` — A foreign function library for Python[¶](#module-ctypes "Link to this heading")
...
## ctypes tutorial[¶](#ctypes-tutorial "Link to this heading")
...
### Loading dynamic link libraries[¶](#loading-dynamic-link-libraries "Link to this heading")
...
### Accessing functions from loaded dlls[¶](#accessing-functions-from-loaded-dlls "Link to this heading")
...
[`ValueError`](exceptions.html#ValueError "ValueError") is raised when you call an `stdcall` function with the
...
### Fundamental data types[¶](#fundamental-data-types "Link to this heading")

`ctypes` defines a number of primitive C compatible data types:

| ctypes type | C type | Python type |
| --- | --- | --- |
| [`c_bool`](#ctypes.c_bool "ctypes.c_bool") | \_Bool | bool (1) |
| [`c_char`](#ctypes.c_char "ctypes.c_char") | char | 1-character bytes object |
| [`c_wchar`](#ctypes.c_wchar "ctypes.c_wchar") | `wchar_t` | 1-character string |
| [`c_byte`](#ctypes.c_byte "ctypes.c_byte") | char | int |
| [`c_ubyte`](#ctypes.c_ubyte "ctypes.c_ubyte") | unsigned char | int |
| [`c_short`](#ctypes.c_short "ctypes.c_short") | short | int |
| [`c_ushort`](#ctypes.c_ushort "ctypes.c_ushort") | unsigned short | int |
| [`c_int`](#ctypes.c_int "ctypes.c_int") | int | int |
| [`c_int8`](#ctypes.c_int8 "ctypes.c_int8") | `int8_t` | int |
| [`c_int16`](#ctypes.c_int16 "ctypes.c_int16") | `int16_t` | int |
| [`c_int32`](#ctypes.c_int32 "ctypes.c_int32") | `int32_t` | int |
| [`c_int64`](#ctypes.c_int64 "ctypes.c_int64") | `int64_t` | int |
| [`c_uint`](#ctypes.c_uint "ctypes.c_uint") | unsigned int | int |
| [`c_uint8`](#ctypes.c_uint8 "ctypes.c_uint8") | `uint8_t` | int |
| [`c_uint16`](#ctypes.c_uint16 "ctypes.c_uint16") | `uint16_t` | int |
| [`c_uint32`](#ctypes.c_uint32 "ctypes.c_uint32") | `uint32_t` | int |
| [`c_uint64`](#ctypes.c_uint64 "ctypes.c_uint64") | `uint64_t` | int |
| [`c_long`](#ctypes.c_long "ctypes.c_long") | long | int |
| [`c_ulong`](#ctypes.c_ulong "ctypes.c_ulong") | unsigned long | int |
| [`c_longlong`](#ctypes.c_longlong "ctypes.c_longlong") | \_\_int64 or long long | int |
| [`c_ulonglong`](#ctypes.c_ulonglong "ctypes.c_ulonglong") | unsigned \_\_int64 or unsigned long long | int |
| [`c_size_t`](#ctypes.c_size_t "ctypes.c_size_t") | `size_t` | int |
| [`c_ssize_t`](#ctypes.c_ssize_t "ctypes.c_ssize_t") | `ssize_t` or [Py\_ssize\_t](../c-api/intro.html#c.Py_ssize_t "Py_ssize_t") | int |
| [`c_time_t`](#ctypes.c_time_t "ctypes.c_time_t") | `time_t` | int |
| [`c_float`](#ctypes.c_float "ctypes.c_float") | float | float |
| [`c_double`](#ctypes.c_double "ctypes.c_double") | double | float |
| [`c_longdouble`](#ctypes.c_longdouble "ctypes.c_longdouble") | long double | float |
| [`c_char_p`](#ctypes.c_char_p "ctypes.c_char_p") | char\* (NUL terminated) | bytes object or `None` |
| [`c_wchar_p`](#ctypes.c_wchar_p "ctypes.c_wchar_p") | wchar\_t\* (NUL terminated) | string or `None` |
| [`c_void_p`](#ctypes.c_void_p "ctypes.c_void_p") | void\* | int or `None` |
...
| ctypes type | C type | Python type |
| --- | --- | --- |
| [`c_float_complex`](#ctypes.c_float_complex "ctypes.c_float_complex") | float complex | complex |
| [`c_double_complex`](#ctypes.c_double_complex "ctypes.c_double_complex") | double complex | complex |
| [`c_longdouble_complex`](#ctypes.c_longdouble_complex "ctypes.c_longdouble_complex") | long double complex | complex |
...
### Calling functions, continued[¶](#calling-functions-continued "Link to this heading")
...
### Calling variadic functions[¶](#calling-variadic-functions "Link to this heading")
...
### Calling functions with your own custom data types[¶](#calling-functions-with-your-own-custom-data-types "Link to this heading")
...
### Specifying the required argument types (function prototypes)[¶](#specifying-the-required-argument-types-function-prototypes "Link to this heading")
...
### Return types[¶](#return-types "Link to this heading")
...
### Passing pointers (or: passing parameters by reference)[¶](#passing-pointers-or-passing-parameters-by-reference "Link to this heading")

Sometimes a C api function expects a *pointer* to a data type as parameter,
probably to write into the corresponding location, or if the data is too large
to be passed by value. This is also known as *passing parameters by reference*.

`ctypes` exports the [`byref()`](#ctypes.byref "ctypes.byref") function which is used to pass parameters
...
### Structures and unions[¶](#structures-and-unions "Link to this heading")
...
The field type must be a `ctypes` type like [`c_int`](#ctypes.c_int "ctypes.c_int"), or any other
...
See [`CField`](#ctypes.CField "ctypes.CField"):
...
### Structure/union layout, alignment and byte order[¶](#structure-union-layout-alignment-and-byte-order "Link to this heading")
...
[`_layout_`](#ctypes.Structure._layout_ "ctypes.Structure._layout_") class attribute in the subclass definition; see
the attribute documentation for details.

It is possible to specify the maximum alignment for the fields and/or for the
structure itself by setting the class attributes [`_pack_`](#ctypes.Structure._pack_ "ctypes.Structure._pack_")
and/or [`_align_`](#ctypes.Structure._align_ "ctypes.Structure._align_"), respectively.
...
### Bit fields in structures and unions[¶](#bit-fields-in-structures-and-unions "Link to this heading")
...
See the [`_layout_`](#ctypes.Structure._layout_ "ctypes.Structure._layout_") attribute for details on the default
...
### Pointers[¶](#pointers "Link to this heading")
...
[`POINTER()`](#ctypes.POINTER "ctypes.POINTER") function, which accepts any `ctypes` type, and returns a
new type:
...
### Thread safety without the GIL[¶](#thread-safety-without-the-gil "Link to this heading")

From Python 3.13 onward, the [GIL](../glossary.html#term-GIL) can be disabled on the [free-threaded build](../glossary.html#term-free-threaded-build).
...
is not also attempting to do the same. If this is an issue, consider using a [`threading.Lock`](threading.html#threading.Lock "threading.Lock")
...
### Type conversions[¶](#type-conversions "Link to this heading")
...
into another type. `ctypes` provides a [`cast()`](#ctypes.cast "ctypes.cast") function which can be
...
### Incomplete Types[¶](#incomplete-types "Link to this heading")
...
### Callback functions[¶](#callback-functions "Link to this heading")
...
### Accessing values exported from dlls[¶](#accessing-values-exported-from-dlls "Link to this heading")
...
`ctypes` can access values like this with the [`in_dll()`](#ctypes._CData.in_dll "ctypes._CData.in_dll") class methods of
...
### Surprises[¶](#surprises "Link to this heading")
...
### Variable-sized data types[¶](#variable-sized-data-types "Link to this heading")
...
## ctypes reference[¶](#ctypes-reference "Link to this heading")

### Finding shared libraries[¶](#finding-shared-libraries "Link to this heading")
...
### Listing loaded shared libraries[¶](#listing-loaded-shared-libraries "Link to this heading")
...
The `ctypes.util` module provides the [`dllist()`](#ctypes.util.dllist "ctypes.util.dllist") function,
...
### Loading shared libraries[¶](#loading-shared-libraries "Link to this heading")

There are several ways to load shared libraries into the Python process. One
way is to instantiate one of the following classes:

*class* ctypes.CDLL(*name*, *mode=DEFAULT\_MODE*, *handle=None*, *use\_errno=False*, *use\_last\_error=False*, *winmode=None*)[¶](#ctypes.CDLL "Link to this definition")
:   Instances of this class represent loaded shared libraries. Functions in these
    ...
    Changed in version 3.12: The *name* parameter can now be a [path-like object](../glossary.html#term-path-like-object).
...
*class* ctypes.OleDLL(*name*, *mode=DEFAULT\_MODE*, *handle=None*, *use\_errno=False*, *use\_last\_error=False*, *winmode=None*)[¶](#ctypes.OleDLL "Link to this definition")
:   Instances of this class represent loaded shared libraries,
    ...
    Changed in version 3.3: [`WindowsError`](exceptions.html#WindowsError "WindowsError") used to be raised,
    which is now an alias of [`OSError`](exceptions.html#OSError "OSError").

    Changed in version 3.12: The *name* parameter can now be a [path-like object](../glossary.html#term-path-like-object).

*class* ctypes.WinDLL(*name*, *mode=DEFAULT\_MODE*, *handle=None*, *use\_errno=False*, *use\_last\_error=False*, *winmode=None*)[¶](#ctypes.WinDLL "Link to this definition")
:   Instances of this class represent loaded shared libraries,
    functions in these libraries use the `stdcall` calling convention, and are
...
*class* ctypes.PyDLL(*name*, *mode=DEFAULT\_MODE*, *handle=None*)[¶](#ctypes.PyDLL "Link to this definition")
...
`ctypes` maintains a thread-local copy of the system’s [`errno`](errno.html#module-errno "errno: Standard errno system symbols.")
...
PyDLL.\_handle[¶](#ctypes.PyDLL._handle "Link to this definition")
:   The system handle used to access the library.

PyDLL.\_name[¶](#ctypes.PyDLL._name "Link to this definition")
...
*class* ctypes.LibraryLoader(*dlltype*)[¶](#ctypes.LibraryLoader "Link to this definition")
:   Class which loads shared libraries. *dlltype* should be one of the
    ...
    LoadLibrary(*name*)[¶](#ctypes.LibraryLoader.LoadLibrary "Link to this definition")
...
### Foreign functions[¶](#foreign-functions "Link to this heading")
...
*class* ctypes.\_CFuncPtr[¶](#ctypes._CFuncPtr "Link to this definition")
...
### Function prototypes[¶](#function-prototypes "Link to this heading")
...
ctypes.CFUNCTYPE(*restype*, *\*argtypes*, *use\_errno=False*, *use\_last\_error=False*)[¶](#ctypes.CFUNCTYPE "Link to this definition")
...
ctypes.WINFUNCTYPE(*restype*, *\*argtypes*, *use\_errno=False*, *use\_last\_error=False*)[¶](#ctypes.WINFUNCTYPE "Link to this definition")
...
ctypes.PYFUNCTYPE(*restype*, *\*argtypes*)[¶](#ctypes.PYFUNCTYPE "Link to this definition")
...
:   Returns a foreign function that will call a COM method. *vtbl\_index* is
    ...
    If *iid* is not specified, an [`OSError`](exceptions.html#OSError "OSError") is raised if the COM method
    call fails. If *iid* is specified, a [`COMError`](#ctypes.COMError "ctypes.COMError") is raised
    instead.
...
If the [`errcheck`](#ctypes._CFuncPtr.errcheck "ctypes._CFuncPtr.errcheck") function returns the argument tuple it receives
...
ctypes.addressof(*obj*)[¶](#ctypes.addressof "Link to this definition")
:   Returns the address of the memory buffer as integer. *obj* must be an
    instance of a ctypes type.

    Raises an [auditing event](sys.html#auditing) `ctypes.addressof` with argument `obj`.

ctypes.alignment(*obj\_or\_type*)[¶](#ctypes.alignment "Link to this definition")
:   Returns the alignment requirements of a ctypes type. *obj\_or\_type* must be a
    ctypes type or instance.

ctypes.byref(*obj*[, *offset*])[¶](#ctypes.byref "Link to this definition")
...
ctypes.CopyComPointer(*src*, *dst*)[¶](#ctypes.CopyComPointer "Link to this definition")
...
ctypes.cast(*obj*, *type*)[¶](#ctypes.cast "Link to this definition")
...
ctypes.create\_string\_buffer(*init*, *size=None*)[¶](#ctypes.create_string_buffer "Link to this definition")
...
ctypes.create\_unicode\_buffer(*init*, *size=None*)[¶](#ctypes.create_unicode_buffer "Link to this definition")
...
ctypes.util.find\_library(*name*)[¶](#ctypes.util.find_library "Link to this definition")
:   Try to find a library and return a pathname. *name* is the library name
    ...
    See [Finding shared libraries](#ctypes-finding-shared-libraries) for complete documentation.
...
:   Try to provide a list of paths of the shared libraries loaded into the current
    ...
    can raise [`OSError`](exceptions.html#OSError "OSError") if the underlying platform APIs fail.
    The exact functionality is system dependent.

    On most platforms, the first element of the list represents the current
    executable file. It may be an empty string.

    [Availability](intro.html#availability): Windows, macOS, iOS, glibc, BSD libc, musl

    Added in version 3.14.

ctypes.FormatError([*code*])[¶](#ctypes.FormatError "Link to this definition")
:   Returns a textual description of the error code *code*. If no error code is
    ...
    [`GetLastError()`](#ctypes.GetLastError "ctypes.GetLastError").
...
ctypes.memmove(*dst*, *src*, *count*)[¶](#ctypes.memmove "Link to this definition")
:   Same as the standard C memmove library function: copies *count* bytes from
    *src* to *dst*. *dst* and *src* must be integers or ctypes instances that can
    be converted to pointers.

ctypes.memset(*dst*, *c*, *count*)[¶](#ctypes.memset "Link to this definition")
:   Same as the standard C memset library function: fills the memory block at
    address *dst* with *count* bytes of value *c*. *dst* must be an integer
    specifying an address, or a ctypes instance.

ctypes.POINTER(*type*, */*)[¶](#ctypes.POINTER "Link to this definition")
...
ctypes.pointer(*obj*, */*)[¶](#ctypes.pointer "Link to this definition")
...
ctypes.resize(*obj*, *size*)[¶](#ctypes.resize "Link to this definition")
:   This function resizes the internal memory buffer of *obj*, which must be an
    instance of a ctypes type. It is not possible to make the buffer smaller
    than the native size of the objects type, as given by `sizeof(type(obj))`,
    but it is possible to enlarge the buffer.

ctypes.set\_errno(*value*)[¶](#ctypes.set_errno "Link to this definition")
...
ctypes.set\_last\_error(*value*)[¶](#ctypes.set_last_error "Link to this definition")
...
ctypes.sizeof(*obj\_or\_type*)[¶](#ctypes.sizeof "Link to this definition")
:   Returns the size in bytes of a ctypes type or instance memory buffer.
    Does the same as the C `sizeof` operator.

ctypes.string\_at(*ptr*, *size=-1*)[¶](#ctypes.string_at "Link to this definition")
...
ctypes.WinError(*code=None*, *descr=None*)[¶](#ctypes.WinError "Link to this definition")
:   Creates an instance of [`OSError`](exceptions.html#OSError "OSError"). If *code* is not specified,
    [`GetLastError()`](#ctypes.GetLastError "ctypes.GetLastError") is called to determine the error code. If *descr* is not
...
ctypes.wstring\_at(*ptr*, *size=-1*)[¶](#ctypes.wstring_at "Link to this definition")
:   Return the wide-character string at *void \*ptr*.
    If *size* is specified, it is used as the number of
    characters of the string, otherwise the string is assumed to be
    zero-terminated.

    Raises an [auditing event](sys.html#auditing) `ctypes.wstring_at` with arguments `ptr`, `size`.

ctypes.memoryview\_at(*ptr*, *size*, *readonly=False*)[¶](#ctypes.memoryview_at "Link to this definition")
:   Return a [`memoryview`](stdtypes.html#memoryview "memoryview") object of length *size* that references memory
    ...
    This function is similar to [`string_at()`](#ctypes.string_at "ctypes.string_at") with the key
    ...
    (While [`from_address()`](#ctypes._CData.from_address "ctypes._CData.from_address") only takes integers, *ptr* can also
    be given as a [`ctypes.POINTER`](#ctypes.POINTER "ctypes.POINTER") or a [`byref()`](#ctypes.byref "ctypes.byref") object.)

    Raises an [auditing event](sys.html#auditing) `ctypes.memoryview_at` with arguments `address`, `size`, `readonly`.

    Added in version 3.14.

### Data types[¶](#data-types "Link to this heading")

*class* ctypes.\_CData[¶](#ctypes._CData "Link to this definition")
:   This non-public class is the common base class of all ctypes data types.
    ...
    from\_buffer(*source*[, *offset*])[¶](#ctypes._CData.from_buffer "Link to this definition")
    ...
    from\_buffer\_copy(*source*[, *offset*])[¶](#ctypes._CData.from_buffer_copy "Link to this definition")
    ...
    from\_address(*address*)[¶](#ctypes._CData.from_address "Link to this definition")
    ...
    from\_param(*obj*)[¶](#ctypes._CData.from_param "Link to this definition")
    ...
    in\_dll(*library*, *name*)[¶](#ctypes._CData.in_dll "Link to this definition")
    ...
    :   The pointer type that was created by calling
        [`POINTER()`](#ctypes.POINTER "ctypes.POINTER") for corresponding ctypes data type. If a pointer type
...
### Fundamental data types[¶](#ctypes-fundamental-data-types-2 "Link to this heading")

*class* ctypes.\_SimpleCData[¶](#ctypes._SimpleCData "Link to this definition")
...
*class* ctypes.c\_byte[¶](#ctypes.c_byte "Link to this definition")
:   Represents the C signed char datatype, and interprets the value as
    small integer. The constructor accepts an optional integer initializer; no
    overflow checking is done.

*class* ctypes.c\_char[¶](#ctypes.c_char "Link to this definition")
...
*class* ctypes.c\_char\_p[¶](#ctypes.c_char_p "Link to this definition")
...
*class* ctypes.c\_double[¶](#ctypes.c_double "Link to this definition")
:   Represents the C double datatype. The constructor accepts an
    optional float initializer.

*class* ctypes.c\_longdouble[¶](#ctypes.c_longdouble "Link to this definition")
...
*class* ctypes.c\_float[¶](#ctypes.c_float "Link to this definition")
:   Represents the C float datatype. The constructor accepts an
    optional float initializer.

*class* ctypes.c\_double\_complex[¶](#ctypes.c_double_complex "Link to this definition")
:   Represents the C double complex datatype, if available. The
    constructor accepts an optional [`complex`](functions.html#complex "complex") initializer.

    Added in version 3.14.

*class* ctypes.c\_float\_complex[¶](#ctypes.c_float_complex "Link to this definition")
:   Represents the C float complex datatype, if available. The
    constructor accepts an optional [`complex`](functions.html#complex "complex") initializer.

    Added in version 3.14.

*class* ctypes.c\_longdouble\_complex[¶](#ctypes.c_longdouble_complex "Link to this definition")
:   Represents the C long double complex datatype, if available. The
    constructor accepts an optional [`complex`](functions.html#complex "complex") initializer.

    Added in version 3.14.

*class* ctypes.c\_int[¶](#ctypes.c_int "Link to this definition")
...
:   Represents the C [PyObject](../c-api/structures.html#c.PyObject "PyObject")\* datatype. Calling this without an
    ...
    Changed in version 3.14: `py_object` is now a [generic type](../glossary.html#term-generic-type).
...
*class* ctypes.Union(*\*args*, *\*\*kw*)[¶](#ctypes.Union "Link to this definition")
:   Abstract base class for unions in native byte order.

    Unions share common attributes and behavior with structures;
    see [`Structure`](#ctypes.Structure "ctypes.Structure") documentation for details.

*class* ctypes.BigEndianUnion(*\*args*, *\*\*kw*)[¶](#ctypes.BigEndianUnion "Link to this definition")
:   Abstract base class for unions in *big endian* byte order.

    Added in version 3.11.

*class* ctypes.LittleEndianUnion(*\*args*, *\*\*kw*)[¶](#ctypes.LittleEndianUnion "Link to this definition")
:   Abstract base class for unions in *little endian* byte order.

    Added in version 3.11.

*class* ctypes.BigEndianStructure(*\*args*, *\*\*kw*)[¶](#ctypes.BigEndianStructure "Link to this definition")
:   Abstract base class for structures in *big endian* byte order.

*class* ctypes.LittleEndianStructure(*\*args*, *\*\*kw*)[¶](#ctypes.LittleEndianStructure "Link to this definition")
:   Abstract base class for structures in *little endian* byte order.

Structures and unions with non-native byte order cannot contain pointer type
fields, or any other data types containing pointer type fields.

*class* ctypes.Structure(*\*args*, *\*\*kw*)[¶](#ctypes.Structure "Link to this definition")
:   Abstract base class for structures in *native* byte order.

    Concrete structure and union types must be created by subclassing one of these
    types, and at least define a [`_fields_`](#ctypes.Structure._fields_ "ctypes.Structure._fields_") class variable. `ctypes` will
    ...
    :   A sequence defining the structure fields. The items must be 2-tuples or
        ...
        Later assignments will raise an [`AttributeError`](exceptions.html#AttributeError "AttributeError").
        ...
        created, [`sizeof()`](#ctypes.sizeof "ctypes.sizeof") is called on it, and so on.
        Later assignments to `_fields_` will raise an [`AttributeError`](exceptions.html#AttributeError "AttributeError").
        ...
        plus the [`_fields_`](#ctypes.Structure._fields_ "ctypes.Structure._fields_") defined in the sub-subclass, if any.
    ...
    :   An optional small integer that allows overriding the alignment of
        ...
        (see [`_layout_`](#ctypes.Structure._layout_ "ctypes.Structure._layout_")).
        ...
        If it is intended, set [`_layout_`](#ctypes.Structure._layout_ "ctypes.Structure._layout_") to `'ms'`
        explicitly.
    ...
    :   An optional string naming the struct/union layout. It can currently
        ...
        * `"gcc-sysv"`: the layout used by GCC with the System V or “SysV-like”
          ...
          With this layout, [`_pack_`](#ctypes.Structure._pack_ "ctypes.Structure._pack_") must be unset or zero.
        ...
        * On Windows: `"ms"`
        * When [`_pack_`](#ctypes.Structure._pack_ "ctypes.Structure._pack_") is specified: `"ms"`.
          (This is deprecated; see [`_pack_`](#ctypes.Structure._pack_ "ctypes.Structure._pack_") documentation.)
        * Otherwise: `"gcc-sysv"`

        `_layout_` must already be defined when
        [`_fields_`](#ctypes.Structure._fields_ "ctypes.Structure._fields_") is assigned, otherwise it will have no effect.
...
*class* ctypes.CField(*\*args*, *\*\*kw*)[¶](#ctypes.CField "Link to this definition")
:   Descriptor for fields of a [`Structure`](#ctypes.Structure "ctypes.Structure") and [`Union`](#ctypes.Union "ctypes.Union").
    For example:
    ...
    `CField` objects are created via [`_fields_`](#ctypes.Structure._fields_ "ctypes.Structure._fields_");
    ...
    :   Offset of the field, in bytes.
        ...
        *storage unit*; see [`bit_offset`](#ctypes.CField.bit_offset "ctypes.CField.bit_offset").
    ...
    :   For non-bitfields, equivalent to [`byte_size`](#ctypes.CField.byte_size "ctypes.CField.byte_size").

        For bitfields, this contains a backwards-compatible bit-packed
        value that combines [`bit_size`](#ctypes.CField.bit_size "ctypes.CField.bit_size") and
        [`bit_offset`](#ctypes.CField.bit_offset "ctypes.CField.bit_offset").
    ...
    :   The location of a bitfield within its *storage unit*, that is, within
        [`byte_size`](#ctypes.CField.byte_size "ctypes.CField.byte_size") bytes of memory starting at
        [`byte_offset`](#ctypes.CField.byte_offset "ctypes.CField.byte_offset").

        To get the field’s value, read the storage unit as an integer,
        [shift left](../reference/expressions.html#shifting) by `bit_offset` and
...
### Arrays and pointers[¶](#arrays-and-pointers "Link to this heading")

*class* ctypes.Array(*\*args*)[¶](#ctypes.Array "Link to this definition")
...
ctypes.ARRAY(*type*, *length*)[¶](#ctypes.ARRAY "Link to this definition")
:   Create an array.
...
*class* ctypes.\_Pointer[¶](#ctypes._Pointer "Link to this definition")
...
*exception* ctypes.ArgumentError[¶](#ctypes.ArgumentError "Link to this definition")
:   This exception is raised when a foreign function call cannot convert one of the
    passed arguments.

*exception* ctypes.COMError(*hresult*, *text*, *details*)[¶](#ctypes.COMError "Link to this definition")
...
* [`ctypes` — A foreign function library for Python](#)
  + [ctypes tutorial](#ctypes-tutorial)
    ...
    - [Accessing functions from loaded dlls](#accessing-functions-from-loaded-dlls)
    - [Calling functions](#calling-functions)
    - [Fundamental data types](#fundamental-data-types)
    - [Calling functions, continued](#calling-functions-continued)
    - [Calling variadic functions](#calling-variadic-functions)
    ...
    - [Structure/union layout, alignment and byte order](#structure-union-layout-alignment-and-byte-order)
    - [Bit fields in structures and unions](#bit-fields-in-structures-and-unions)
    - [Arrays](#arrays)
    - [Pointers](#pointers)
    - [Thread safety without the GIL](#thread-safety-without-the-gil)
    - [Type conversions](#type-conversions)
    - [Incomplete Types](#incomplete-types)
    - [Callback functions](#callback-functions)
    - [Accessing values exported from dlls](#accessing-values-exported-from-dlls)
    - [Surprises](#surprises)
  ...
  + [ctypes reference](#ctypes-reference)
    ...
    - [Listing loaded shared libraries](#listing-loaded-shared-libraries)
    - [Loading shared libraries](#loading-shared-libraries)
    - [Foreign functions](#foreign-functions)
    - [Function prototypes](#function-prototypes)
    - [Utility functions](#utility-functions)
    - [Data types](#data-types)
    - [Fundamental data types](#ctypes-fundamental-data-types-2)
...
[`errno` — Standard errno system symbols](errno.html "previous chapter")

#### Next topic

[Command-line interface libraries](cmdlinelibs.html "next chapter")
