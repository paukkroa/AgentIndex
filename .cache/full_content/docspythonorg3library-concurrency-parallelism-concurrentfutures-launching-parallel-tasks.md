...
* [next](concurrent.interpreters.html "concurrent.interpreters — Multiple interpreters in the same process") |
...
:   An abstract class that provides methods to execute calls asynchronously. It
    ...
    map(*fn*, *\*iterables*, *timeout=None*, *chunksize=1*, *buffersize=None*)[¶](#concurrent.futures.Executor.map "Link to this definition")
    ...
    :   Signal the executor that it should free any resources that it is using
        ...
        will shutdown the [`Executor`](#concurrent.futures.Executor "concurrent.futures.Executor") (waiting as if [`Executor.shutdown()`](#concurrent.futures.Executor.shutdown "concurrent.futures.Executor.shutdown")
...
*class* concurrent.futures.InterpreterPoolExecutor(*max\_workers=None*, *thread\_name\_prefix=''*, *initializer=None*, *initargs=()*)[¶](#concurrent.futures.InterpreterPoolExecutor "Link to this definition")
...
:   An [`Executor`](#concurrent.futures.Executor "concurrent.futures.Executor") subclass that executes calls asynchronously using a pool
    ...
    *max\_tasks\_per\_child* is an optional argument that specifies the maximum
    ...
    can result in the [`ProcessPoolExecutor`](#concurrent.futures.ProcessPoolExecutor "concurrent.futures.ProcessPoolExecutor") hanging in some
    ...
    require the *fork* start method for [`ProcessPoolExecutor`](#concurrent.futures.ProcessPoolExecutor "concurrent.futures.ProcessPoolExecutor") you must
...
*exception* concurrent.futures.interpreter.BrokenInterpreterPool[¶](#concurrent.futures.interpreter.BrokenInterpreterPool "Link to this definition")
...
[`concurrent.interpreters` — Multiple interpreters in the same process](concurrent.interpreters.html "next chapter")
