...
* [next](sched.html "sched — Event scheduler") |
* [previous](concurrent.interpreters.html "concurrent.interpreters — Multiple interpreters in the same process") |
...
# `subprocess` — Subprocess management[¶](#module-subprocess "Link to this heading")
...
## Using the `subprocess` Module[¶](#using-the-subprocess-module "Link to this heading")
...
subprocess.run(*args*, *\**, *stdin=None*, *input=None*, *stdout=None*, *stderr=None*, *capture\_output=False*, *shell=False*, *cwd=None*, *timeout=None*, *check=False*, *encoding=None*, *errors=None*, *text=None*, *env=None*, *universal\_newlines=None*, *\*\*other\_popen\_kwargs*)[¶](#subprocess.run "Link to this definition")
...
*class* subprocess.CompletedProcess[¶](#subprocess.CompletedProcess "Link to this definition")
...
*exception* subprocess.SubprocessError[¶](#subprocess.SubprocessError "Link to this definition")
:   Base class for all other exceptions from this module.

    Added in version 3.3.

*exception* subprocess.TimeoutExpired[¶](#subprocess.TimeoutExpired "Link to this definition")
...
*exception* subprocess.CalledProcessError[¶](#subprocess.CalledProcessError "Link to this definition")
...
### Frequently Used Arguments[¶](#frequently-used-arguments "Link to this heading")
...
### Popen Constructor[¶](#popen-constructor "Link to this heading")
...
*class* subprocess.Popen(*args*, *bufsize=-1*, *executable=None*, *stdin=None*, *stdout=None*, *stderr=None*, *preexec\_fn=None*, *close\_fds=True*, *shell=False*, *cwd=None*, *env=None*, *universal\_newlines=None*, *startupinfo=None*, *creationflags=0*, *restore\_signals=True*, *start\_new\_session=False*, *pass\_fds=()*, *\**, *group=None*, *extra\_groups=None*, *user=None*, *umask=-1*, *encoding=None*, *errors=None*, *text=None*, *pipesize=-1*, *process\_group=None*)[¶](#subprocess.Popen "Link to this definition")
...
## Popen Objects[¶](#popen-objects "Link to this heading")
...
Popen.wait(*timeout=None*)[¶](#subprocess.Popen.wait "Link to this definition")
...
Popen.communicate(*input=None*, *timeout=None*)[¶](#subprocess.Popen.communicate "Link to this definition")
:   Interact with process: Send data to stdin. Read data from stdout and stderr,
    ...
    subsequent post-timeout [`communicate()`](#subprocess.Popen.communicate "subprocess.Popen.communicate") call is in undefined behavior
    ...
    After a call to [`communicate()`](#subprocess.Popen.communicate "subprocess.Popen.communicate") raises [`TimeoutExpired`](#subprocess.TimeoutExpired "subprocess.TimeoutExpired"), do
    not call [`wait()`](#subprocess.Popen.wait "subprocess.Popen.wait"). Use an additional [`communicate()`](#subprocess.Popen.communicate "subprocess.Popen.communicate")
...
Popen.send\_signal(*signal*)[¶](#subprocess.Popen.send_signal "Link to this definition")
...
## Windows Popen Helpers[¶](#windows-popen-helpers "Link to this heading")

The [`STARTUPINFO`](#subprocess.STARTUPINFO "subprocess.STARTUPINFO") class and following constants are only available
on Windows.

*class* subprocess.STARTUPINFO(*\**, *dwFlags=0*, *hStdInput=None*, *hStdOutput=None*, *hStdError=None*, *wShowWindow=0*, *lpAttributeList=None*)[¶](#subprocess.STARTUPINFO "Link to this definition")
...
### Windows Constants[¶](#windows-constants "Link to this heading")
...
## Older high-level API[¶](#older-high-level-api "Link to this heading")
...
subprocess.call(*args*, *\**, *stdin=None*, *stdout=None*, *stderr=None*, *shell=False*, *cwd=None*, *timeout=None*, *\*\*other\_popen\_kwargs*)[¶](#subprocess.call "Link to this definition")
:   Run the command described by *args*. Wait for command to complete, then
...
subprocess.check\_call(*args*, *\**, *stdin=None*, *stdout=None*, *stderr=None*, *shell=False*, *cwd=None*, *timeout=None*, *\*\*other\_popen\_kwargs*)[¶](#subprocess.check_call "Link to this definition")
...
subprocess.check\_output(*args*, *\**, *stdin=None*, *stderr=None*, *shell=False*, *cwd=None*, *encoding=None*, *errors=None*, *universal\_newlines=None*, *timeout=None*, *text=None*, *\*\*other\_popen\_kwargs*)[¶](#subprocess.check_output "Link to this definition")
...
## Replacing Older Functions with the `subprocess` Module[¶](#replacing-older-functions-with-the-subprocess-module "Link to this heading")
...
### Replacing **/bin/sh** shell command substitution[¶](#replacing-bin-sh-shell-command-substitution "Link to this heading")
...
### Replacing shell pipeline[¶](#replacing-shell-pipeline "Link to this heading")
...
### Replacing [`os.system()`](os.html#os.system "os.system")[¶](#replacing-os-system "Link to this heading")
...
### Replacing the [`os.spawn`](os.html#os.spawnl "os.spawnl") family[¶](#replacing-the-os-spawn-family "Link to this heading")
...
### Replacing [`os.popen()`](os.html#os.popen "os.popen")[¶](#replacing-os-popen "Link to this heading")
...
## Legacy Shell Invocation Functions[¶](#legacy-shell-invocation-functions "Link to this heading")
...
subprocess.getstatusoutput(*cmd*, *\**, *encoding=None*, *errors=None*)[¶](#subprocess.getstatusoutput "Link to this definition")
...
subprocess.getoutput(*cmd*, *\**, *encoding=None*, *errors=None*)[¶](#subprocess.getoutput "Link to this definition")
...
### Timeout Behavior[¶](#timeout-behavior "Link to this heading")
...
### Converting an argument sequence to a string on Windows[¶](#converting-an-argument-sequence-to-a-string-on-windows "Link to this heading")
...
### Disable use of `posix_spawn()`[¶](#disable-use-of-posix-spawn "Link to this heading")
...
[`concurrent.interpreters` — Multiple interpreters in the same process](concurrent.interpreters.html "previous chapter")

#### Next topic

[`sched` — Event scheduler](sched.html "next chapter")
