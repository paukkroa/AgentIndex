...
* [next](concurrent.html "The concurrent package") |
* [previous](multiprocessing.html "multiprocessing — Process-based parallelism") |
...
# `multiprocessing.shared_memory` — Shared memory for direct access across processes[¶](#module-multiprocessing.shared_memory "Link to this heading")

**Source code:** [Lib/multiprocessing/shared\_memory.py](https://github.com/python/cpython/tree/3.14/Lib/multiprocessing/shared_memory.py)
...
*class* multiprocessing.shared\_memory.SharedMemory(*name=None*, *create=False*, *size=0*, *\**, *track=True*)[¶](#multiprocessing.shared_memory.SharedMemory "Link to this definition")
:   Create an instance of the `SharedMemory` class for either
    ...
    :   * **name** ([*str*](stdtypes.html#str "str") *|* *None*) – The unique name for the requested shared memory, specified as a string.
        ...
        * **track** ([*bool*](functions.html#bool "bool")) – When `True`, register the shared memory block with a resource
    ...
    close()[¶](#multiprocessing.shared_memory.SharedMemory.close "Link to this definition")
    ...
    unlink()[¶](#multiprocessing.shared_memory.SharedMemory.unlink "Link to this definition")
    ...
    buf[¶](#multiprocessing.shared_memory.SharedMemory.buf "Link to this definition")
    :   A memoryview of contents of the shared memory block.

    name[¶](#multiprocessing.shared_memory.SharedMemory.name "Link to this definition")
    :   Read-only access to the unique name of the shared memory block.

    size[¶](#multiprocessing.shared_memory.SharedMemory.size "Link to this definition")
    :   Read-only access to size in bytes of the shared memory block.

The following example demonstrates low-level use of [`SharedMemory`](#multiprocessing.shared_memory.SharedMemory "multiprocessing.shared_memory.SharedMemory")
instances:
...
*class* multiprocessing.managers.SharedMemoryManager([*address*[, *authkey*]])[¶](#multiprocessing.managers.SharedMemoryManager "Link to this definition")
:   A subclass of [`multiprocessing.managers.BaseManager`](multiprocessing.html#multiprocessing.managers.BaseManager "multiprocessing.managers.BaseManager") which can be
    ...
    SharedMemory(*size*)[¶](#multiprocessing.managers.SharedMemoryManager.SharedMemory "Link to this definition")
    ...
    ShareableList(*sequence*)[¶](#multiprocessing.managers.SharedMemoryManager.ShareableList "Link to this definition")
...
*class* multiprocessing.shared\_memory.ShareableList(*sequence=None*, *\**, *name=None*)[¶](#multiprocessing.shared_memory.ShareableList "Link to this definition")
:   Provide a mutable list-like object where all values stored within are
    ...
    * [`int`](functions.html#int "int") (signed 64-bit)
    * [`float`](functions.html#float "float")
    * [`bool`](functions.html#bool "bool")
    * [`str`](stdtypes.html#str "str") (less than 10M bytes each when encoded as UTF-8)
    * [`bytes`](stdtypes.html#bytes "bytes") (less than 10M bytes each)
    * `None`
    ...
    *silently stripped* when fetching them by index from the
    ...
    count(*value*)[¶](#multiprocessing.shared_memory.ShareableList.count "Link to this definition")
    :   Return the number of occurrences of *value*.

    index(*value*)[¶](#multiprocessing.shared_memory.ShareableList.index "Link to this definition")
    :   Return first index position of *value*.
        Raise [`ValueError`](exceptions.html#ValueError "ValueError") if *value* is not present.

    format[¶](#multiprocessing.shared_memory.ShareableList.format "Link to this definition")
    ...
    shm[¶](#multiprocessing.shared_memory.ShareableList.shm "Link to this definition")
...
[`multiprocessing` — Process-based parallelism](multiprocessing.html "previous chapter")

#### Next topic

[The `concurrent` package](concurrent.html "next chapter")

### This page

* [Report a bug](../bugs.html)
* [Improve this page](../improve-page-nojs.html)
* [Show source](https://github.com/python/cpython/blob/main/Doc/library/multiprocessing.shared_memory.rst?plain=1)
