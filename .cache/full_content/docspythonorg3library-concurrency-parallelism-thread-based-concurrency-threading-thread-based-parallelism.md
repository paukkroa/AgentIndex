...
* [next](multiprocessing.html "multiprocessing — Process-based parallelism") |
* [previous](concurrency.html "Concurrent Execution") |
...
# `threading` — Thread-based parallelism[¶](#module-threading "Link to this heading")
...
## GIL and performance considerations[¶](#gil-and-performance-considerations "Link to this heading")
...
threading.active\_count()[¶](#threading.active_count "Link to this definition")
...
threading.current\_thread()[¶](#threading.current_thread "Link to this definition")
...
threading.excepthook(*args*, */*)[¶](#threading.excepthook "Link to this definition")
...
threading.\_\_excepthook\_\_[¶](#threading.__excepthook__ "Link to this definition")
...
threading.get\_ident()[¶](#threading.get_ident "Link to this definition")
...
threading.get\_native\_id()[¶](#threading.get_native_id "Link to this definition")
...
threading.enumerate()[¶](#threading.enumerate "Link to this definition")
...
threading.main\_thread()[¶](#threading.main_thread "Link to this definition")
...
threading.settrace(*func*)[¶](#threading.settrace "Link to this definition")
...
threading.settrace\_all\_threads(*func*)[¶](#threading.settrace_all_threads "Link to this definition")
:   Set a trace function for all threads started from the `threading` module
...
threading.gettrace()[¶](#threading.gettrace "Link to this definition")
:   Get the trace function as set by [`settrace()`](#threading.settrace "threading.settrace").

    Added in version 3.10.

threading.setprofile(*func*)[¶](#threading.setprofile "Link to this definition")
...
threading.setprofile\_all\_threads(*func*)[¶](#threading.setprofile_all_threads "Link to this definition")
:   Set a profile function for all threads started from the `threading` module
    and all Python threads that are currently executing.
...
threading.getprofile()[¶](#threading.getprofile "Link to this definition")
:   Get the profiler function as set by [`setprofile()`](#threading.setprofile "threading.setprofile").

    Added in version 3.10.

threading.stack\_size([*size*])[¶](#threading.stack_size "Link to this definition")
...
threading.TIMEOUT\_MAX[¶](#threading.TIMEOUT_MAX "Link to this definition")
...
### Thread-local data[¶](#thread-local-data "Link to this heading")
...
*class* threading.local[¶](#threading.local "Link to this definition")
:   A class that represents thread-local data.

### Thread objects[¶](#thread-objects "Link to this heading")
...
*class* threading.Thread(*group=None*, *target=None*, *name=None*, *args=()*, *kwargs={}*, *\**, *daemon=None*, *context=None*)[¶](#threading.Thread "Link to this definition")
:   This constructor should always be called with keyword arguments. Arguments
    ...
    *context* is the [`Context`](contextvars.html#contextvars.Context "contextvars.Context") value to use when starting
    ...
    start()[¶](#threading.Thread.start "Link to this definition")
    ...
    run()[¶](#threading.Thread.run "Link to this definition")
    ...
    join(*timeout=None*)[¶](#threading.Thread.join "Link to this definition")
    ...
    name[¶](#threading.Thread.name "Link to this definition")
    ...
    getName()[¶](#threading.Thread.getName "Link to this definition")

    setName()[¶](#threading.Thread.setName "Link to this definition")
    :   Deprecated getter/setter API for [`name`](#threading.Thread.name "threading.Thread.name"); use it directly as a
        property instead.

        Deprecated since version 3.10.

    ident[¶](#threading.Thread.ident "Link to this definition")
    ...
    native\_id[¶](#threading.Thread.native_id "Link to this definition")
    ...
    is\_alive()[¶](#threading.Thread.is_alive "Link to this definition")
    ...
    daemon[¶](#threading.Thread.daemon "Link to this definition")
    ...
    isDaemon()[¶](#threading.Thread.isDaemon "Link to this definition")

    setDaemon()[¶](#threading.Thread.setDaemon "Link to this definition")
    :   Deprecated getter/setter API for [`daemon`](#threading.Thread.daemon "threading.Thread.daemon"); use it directly as a
        property instead.

        Deprecated since version 3.10.

### Lock objects[¶](#lock-objects "Link to this heading")
...
*class* threading.Lock[¶](#threading.Lock "Link to this definition")
:   The class implementing primitive lock objects. Once a thread has acquired a
    ...
    acquire(*blocking=True*, *timeout=-1*)[¶](#threading.Lock.acquire "Link to this definition")
    ...
    release()[¶](#threading.Lock.release "Link to this definition")
    ...
    locked()[¶](#threading.Lock.locked "Link to this definition")
    :   Return `True` if the lock is acquired.

### RLock objects[¶](#rlock-objects "Link to this heading")
...
*class* threading.RLock[¶](#threading.RLock "Link to this definition")
:   This class implements reentrant lock objects. A reentrant lock must be
    ...
    acquire(*blocking=True*, *timeout=-1*)[¶](#threading.RLock.acquire "Link to this definition")
    :   Acquire a lock, blocking or non-blocking.
    ...
    release()[¶](#threading.RLock.release "Link to this definition")
    ...
    locked()[¶](#threading.RLock.locked "Link to this definition")
    :   Return a boolean indicating whether this object is locked right now.

        Added in version 3.14.

### Condition objects[¶](#condition-objects "Link to this heading")
...
*class* threading.Condition(*lock=None*)[¶](#threading.Condition "Link to this definition")
:   This class implements condition variable objects. A condition variable
    ...
    acquire(*\*args*)[¶](#threading.Condition.acquire "Link to this definition")
    :   Acquire the underlying lock. This method calls the corresponding method on
        the underlying lock; the return value is whatever that method returns.

    release()[¶](#threading.Condition.release "Link to this definition")
    :   Release the underlying lock. This method calls the corresponding method on
        the underlying lock; there is no return value.

    locked()[¶](#threading.Condition.locked "Link to this definition")
    :   Return a boolean indicating whether this object is locked right now.

        Added in version 3.14.

    wait(*timeout=None*)[¶](#threading.Condition.wait "Link to this definition")
    ...
    wait\_for(*predicate*, *timeout=None*)[¶](#threading.Condition.wait_for "Link to this definition")
    ...
    notify(*n=1*)[¶](#threading.Condition.notify "Link to this definition")
    ...
    notify\_all()[¶](#threading.Condition.notify_all "Link to this definition")
...
### Semaphore objects[¶](#semaphore-objects "Link to this heading")
...
*class* threading.Semaphore(*value=1*)[¶](#threading.Semaphore "Link to this definition")
:   This class implements semaphore objects. A semaphore manages an atomic
    ...
    acquire(*blocking=True*, *timeout=None*)[¶](#threading.Semaphore.acquire "Link to this definition")
    :   Acquire a semaphore.
    ...
    release(*n=1*)[¶](#threading.Semaphore.release "Link to this definition")
...
*class* threading.BoundedSemaphore(*value=1*)[¶](#threading.BoundedSemaphore "Link to this definition")
...
### [`Semaphore`](#threading.Semaphore "threading.Semaphore") example[¶](#semaphore-example "Link to this heading")
...
### Event objects[¶](#event-objects "Link to this heading")
...
*class* threading.Event[¶](#threading.Event "Link to this definition")
:   Class implementing event objects. An event manages a flag that can be set to
    ...
    wait(*timeout=None*)[¶](#threading.Event.wait "Link to this definition")
...
### Timer objects[¶](#timer-objects "Link to this heading")
...
*class* threading.Timer(*interval*, *function*, *args=None*, *kwargs=None*)[¶](#threading.Timer "Link to this definition")
:   Create a timer that will run *function* with arguments *args* and keyword
    ...
    cancel()[¶](#threading.Timer.cancel "Link to this definition")
    :   Stop the timer, and cancel the execution of the timer’s action. This will
        only work if the timer is still in its waiting stage.

### Barrier objects[¶](#barrier-objects "Link to this heading")
...
*class* threading.Barrier(*parties*, *action=None*, *timeout=None*)[¶](#threading.Barrier "Link to this definition")
:   Create a barrier object for *parties* number of threads. An *action*, when
    provided, is a callable to be called by one of the threads when they are
    released. *timeout* is the default timeout value if none is specified for
    the [`wait()`](#threading.Barrier.wait "threading.Barrier.wait") method.

    wait(*timeout=None*)[¶](#threading.Barrier.wait "Link to this definition")
    ...
    reset()[¶](#threading.Barrier.reset "Link to this definition")
    ...
    abort()[¶](#threading.Barrier.abort "Link to this definition")
    ...
    parties[¶](#threading.Barrier.parties "Link to this definition")
    :   The number of threads required to pass the barrier.

    n\_waiting[¶](#threading.Barrier.n_waiting "Link to this definition")
    :   The number of threads currently waiting in the barrier.

    broken[¶](#threading.Barrier.broken "Link to this definition")
    :   A boolean that is `True` if the barrier is in the broken state.

*exception* threading.BrokenBarrierError[¶](#threading.BrokenBarrierError "Link to this definition")
...
## Using locks, conditions, and semaphores in the `with` statement[¶](#using-locks-conditions-and-semaphores-in-the-with-statement "Link to this heading")
...
[Concurrent Execution](concurrency.html "previous chapter")

#### Next topic

[`multiprocessing` — Process-based parallelism](multiprocessing.html "next chapter")
