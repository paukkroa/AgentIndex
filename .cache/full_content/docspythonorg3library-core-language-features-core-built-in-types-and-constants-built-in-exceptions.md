...
* [next](text.html "Text Processing Services") |
* [previous](stdtypes.html "Built-in Types") |
...
# Built-in Exceptions[¶](#built-in-exceptions "Link to this heading")
...
## Exception context[¶](#exception-context "Link to this heading")

Three attributes on exception objects provide information about the context in
which the exception was raised:

BaseException.\_\_context\_\_[¶](#BaseException.__context__ "Link to this definition")

BaseException.\_\_cause\_\_[¶](#BaseException.__cause__ "Link to this definition")

BaseException.\_\_suppress\_context\_\_[¶](#BaseException.__suppress_context__ "Link to this definition")
...
## Inheriting from built-in exceptions[¶](#inheriting-from-built-in-exceptions "Link to this heading")
...
*exception* BaseException[¶](#BaseException "Link to this definition")
:   The base class for all built-in exceptions. It is not meant to be directly
    ...
    \_\_traceback\_\_[¶](#BaseException.__traceback__ "Link to this definition")
    ...
    add\_note(*note*)[¶](#BaseException.add_note "Link to this definition")
    ...
    \_\_notes\_\_[¶](#BaseException.__notes__ "Link to this definition")
...
*exception* Exception[¶](#Exception "Link to this definition")
:   All built-in, non-system-exiting exceptions are derived from this class. All
    user-defined exceptions should also be derived from this class.

*exception* ArithmeticError[¶](#ArithmeticError "Link to this definition")
...
*exception* BufferError[¶](#BufferError "Link to this definition")
:   Raised when a [buffer](../c-api/buffer.html#bufferobjects) related operation cannot be
    performed.

*exception* LookupError[¶](#LookupError "Link to this definition")
...
## Concrete exceptions[¶](#concrete-exceptions "Link to this heading")

The following exceptions are the exceptions that are usually raised.

*exception* AssertionError[¶](#AssertionError "Link to this definition")
:   Raised when an [`assert`](../reference/simple_stmts.html#assert) statement fails.

*exception* AttributeError[¶](#AttributeError "Link to this definition")
:   Raised when an attribute reference (see [Attribute references](../reference/expressions.html#attribute-references)) or
    ...
    name[¶](#AttributeError.name "Link to this definition")
    :   The name of the attribute that was attempted to be accessed.

    obj[¶](#AttributeError.obj "Link to this definition")
...
*exception* EOFError[¶](#EOFError "Link to this definition")
...
*exception* FloatingPointError[¶](#FloatingPointError "Link to this definition")
:   Not currently used.

*exception* GeneratorExit[¶](#GeneratorExit "Link to this definition")
...
*exception* ImportError[¶](#ImportError "Link to this definition")
:   Raised when the [`import`](../reference/simple_stmts.html#import) statement has troubles trying to
    ...
    name[¶](#ImportError.name "Link to this definition")
    :   The name of the module that was attempted to be imported.

    path[¶](#ImportError.path "Link to this definition")
...
*exception* ModuleNotFoundError[¶](#ModuleNotFoundError "Link to this definition")
...
*exception* IndexError[¶](#IndexError "Link to this definition")
:   Raised when a sequence subscript is out of range. (Slice indices are
    silently truncated to fall in the allowed range; if an index is not an
    integer, [`TypeError`](#TypeError "TypeError") is raised.)

*exception* KeyError[¶](#KeyError "Link to this definition")
:   Raised when a mapping (dictionary) key is not found in the set of existing keys.

*exception* KeyboardInterrupt[¶](#KeyboardInterrupt "Link to this definition")
...
*exception* MemoryError[¶](#MemoryError "Link to this definition")
...
*exception* NameError[¶](#NameError "Link to this definition")
:   Raised when a local or global name is not found. This applies only to
    ...
    name[¶](#NameError.name "Link to this definition")
...
*exception* NotImplementedError[¶](#NotImplementedError "Link to this definition")
...
*exception* OSError([*arg*])[¶](#OSError "Link to this definition")
...
:   This exception is raised when a system function returns a system-related
    ...
    errno[¶](#OSError.errno "Link to this definition")
    :   A numeric error code from the C variable `errno`.

    winerror[¶](#OSError.winerror "Link to this definition")
    ...
    strerror[¶](#OSError.strerror "Link to this definition")
    ...
    filename[¶](#OSError.filename "Link to this definition")

    filename2[¶](#OSError.filename2 "Link to this definition")
    ...
    `mmap.error` have been merged into [`OSError`](#OSError "OSError"), and the
...
*exception* OverflowError[¶](#OverflowError "Link to this definition")
...
*exception* PythonFinalizationError[¶](#PythonFinalizationError "Link to this definition")
...
*exception* RecursionError[¶](#RecursionError "Link to this definition")
...
*exception* ReferenceError[¶](#ReferenceError "Link to this definition")
...
*exception* RuntimeError[¶](#RuntimeError "Link to this definition")
:   Raised when an error is detected that doesn’t fall in any of the other
    categories. The associated value is a string indicating what precisely went
    wrong.

*exception* StopIteration[¶](#StopIteration "Link to this definition")
:   Raised by built-in function [`next()`](functions.html#next "next") and an [iterator](../glossary.html#term-iterator)'s
    ...
    value[¶](#StopIteration.value "Link to this definition")
    ...
    Changed in version 3.7: Enable [**PEP 479**](https://peps.python.org/pep-0479/) for all code by default: a [`StopIteration`](#StopIteration "StopIteration")
    error raised in a generator is transformed into a [`RuntimeError`](#RuntimeError "RuntimeError").

*exception* StopAsyncIteration[¶](#StopAsyncIteration "Link to this definition")
...
*exception* SyntaxError(*message*, *details*)[¶](#SyntaxError "Link to this definition")
:   Raised when the parser encounters a syntax error. This may occur in an
    ...
    filename[¶](#SyntaxError.filename "Link to this definition")
    :   The name of the file the syntax error occurred in.

    lineno[¶](#SyntaxError.lineno "Link to this definition")
    :   Which line number in the file the error occurred in. This is
        1-indexed: the first line in the file has a `lineno` of 1.

    offset[¶](#SyntaxError.offset "Link to this definition")
    :   The column in the line where the error occurred. This is
        1-indexed: the first character in the line has an `offset` of 1.

    text[¶](#SyntaxError.text "Link to this definition")
    :   The source code text involved in the error.

    end\_lineno[¶](#SyntaxError.end_lineno "Link to this definition")
    :   Which line number in the file the error occurred ends in. This is
        1-indexed: the first line in the file has a `lineno` of 1.

    end\_offset[¶](#SyntaxError.end_offset "Link to this definition")
...
*exception* IndentationError[¶](#IndentationError "Link to this definition")
:   Base class for syntax errors related to incorrect indentation. This is a
    subclass of [`SyntaxError`](#SyntaxError "SyntaxError").

*exception* TabError[¶](#TabError "Link to this definition")
:   Raised when indentation contains an inconsistent use of tabs and spaces.
    This is a subclass of [`IndentationError`](#IndentationError "IndentationError").

*exception* SystemError[¶](#SystemError "Link to this definition")
...
*exception* SystemExit[¶](#SystemExit "Link to this definition")
:   This exception is raised by the [`sys.exit()`](sys.html#sys.exit "sys.exit") function. It inherits from
    ...
    code[¶](#SystemExit.code "Link to this definition")
    :   The exit status or error message that is passed to the constructor.
        (Defaults to `None`.)

*exception* TypeError[¶](#TypeError "Link to this definition")
...
*exception* UnboundLocalError[¶](#UnboundLocalError "Link to this definition")
:   Raised when a reference is made to a local variable in a function or method, but
    no value has been bound to that variable. This is a subclass of
    [`NameError`](#NameError "NameError").

*exception* UnicodeError[¶](#UnicodeError "Link to this definition")
:   Raised when a Unicode-related encoding or decoding error occurs. It is a
    ...
    encoding[¶](#UnicodeError.encoding "Link to this definition")
    :   The name of the encoding that raised the error.

    reason[¶](#UnicodeError.reason "Link to this definition")
    :   A string describing the specific codec error.

    object[¶](#UnicodeError.object "Link to this definition")
    :   The object the codec was attempting to encode or decode.

    start[¶](#UnicodeError.start "Link to this definition")
    ...
    end[¶](#UnicodeError.end "Link to this definition")
    :   The index after the last invalid data in [`object`](functions.html#object "object").

        This value should not be negative as it is interpreted as an
        absolute offset but this constraint is not enforced at runtime.

*exception* UnicodeEncodeError[¶](#UnicodeEncodeError "Link to this definition")
:   Raised when a Unicode-related error occurs during encoding. It is a subclass of
    [`UnicodeError`](#UnicodeError "UnicodeError").

*exception* UnicodeDecodeError[¶](#UnicodeDecodeError "Link to this definition")
:   Raised when a Unicode-related error occurs during decoding. It is a subclass of
    [`UnicodeError`](#UnicodeError "UnicodeError").

*exception* UnicodeTranslateError[¶](#UnicodeTranslateError "Link to this definition")
:   Raised when a Unicode-related error occurs during translating. It is a subclass
    of [`UnicodeError`](#UnicodeError "UnicodeError").

*exception* ValueError[¶](#ValueError "Link to this definition")
:   Raised when an operation or function receives an argument that has the
    right type but an inappropriate value, and the situation is not described by a
    more precise exception such as [`IndexError`](#IndexError "IndexError").

*exception* ZeroDivisionError[¶](#ZeroDivisionError "Link to this definition")
...
*exception* EnvironmentError[¶](#EnvironmentError "Link to this definition")

*exception* IOError[¶](#IOError "Link to this definition")

*exception* WindowsError[¶](#WindowsError "Link to this definition")
:   Only available on Windows.

### OS exceptions[¶](#os-exceptions "Link to this heading")

The following exceptions are subclasses of [`OSError`](#OSError "OSError"), they get raised
depending on the system error code.

*exception* BlockingIOError[¶](#BlockingIOError "Link to this definition")
:   Raised when an operation would block on an object (e.g. socket) set
    ...
    characters\_written[¶](#BlockingIOError.characters_written "Link to this definition")
...
*exception* ChildProcessError[¶](#ChildProcessError "Link to this definition")
:   Raised when an operation on a child process failed.
    Corresponds to `errno` [`ECHILD`](errno.html#errno.ECHILD "errno.ECHILD").

*exception* ConnectionError[¶](#ConnectionError "Link to this definition")
...
*exception* BrokenPipeError[¶](#BrokenPipeError "Link to this definition")
...
*exception* ConnectionAbortedError[¶](#ConnectionAbortedError "Link to this definition")
...
*exception* ConnectionRefusedError[¶](#ConnectionRefusedError "Link to this definition")
:   A subclass of [`ConnectionError`](#ConnectionError "ConnectionError"), raised when a connection attempt
    is refused by the peer.
    Corresponds to `errno` [`ECONNREFUSED`](errno.html#errno.ECONNREFUSED "errno.ECONNREFUSED").

*exception* ConnectionResetError[¶](#ConnectionResetError "Link to this definition")
...
*exception* FileExistsError[¶](#FileExistsError "Link to this definition")
:   Raised when trying to create a file or directory which already exists.
    Corresponds to `errno` [`EEXIST`](errno.html#errno.EEXIST "errno.EEXIST").

*exception* FileNotFoundError[¶](#FileNotFoundError "Link to this definition")
:   Raised when a file or directory is requested but doesn’t exist.
    Corresponds to `errno` [`ENOENT`](errno.html#errno.ENOENT "errno.ENOENT").

*exception* InterruptedError[¶](#InterruptedError "Link to this definition")
...
*exception* IsADirectoryError[¶](#IsADirectoryError "Link to this definition")
...
*exception* NotADirectoryError[¶](#NotADirectoryError "Link to this definition")
...
*exception* PermissionError[¶](#PermissionError "Link to this definition")
...
*exception* ProcessLookupError[¶](#ProcessLookupError "Link to this definition")
:   Raised when a given process doesn’t exist.
    Corresponds to `errno` [`ESRCH`](errno.html#errno.ESRCH "errno.ESRCH").

*exception* TimeoutError[¶](#TimeoutError "Link to this definition")
...
*exception* Warning[¶](#Warning "Link to this definition")
:   Base class for warning categories.

*exception* UserWarning[¶](#UserWarning "Link to this definition")
:   Base class for warnings generated by user code.

*exception* DeprecationWarning[¶](#DeprecationWarning "Link to this definition")
...
*exception* PendingDeprecationWarning[¶](#PendingDeprecationWarning "Link to this definition")
...
*exception* SyntaxWarning[¶](#SyntaxWarning "Link to this definition")
...
*exception* RuntimeWarning[¶](#RuntimeWarning "Link to this definition")
:   Base class for warnings about dubious runtime behavior.

*exception* FutureWarning[¶](#FutureWarning "Link to this definition")
:   Base class for warnings about deprecated features when those warnings are
    intended for end users of applications that are written in Python.

*exception* ImportWarning[¶](#ImportWarning "Link to this definition")
:   Base class for warnings about probable mistakes in module imports.

    Ignored by the default warning filters. Enabling the [Python
    Development Mode](devmode.html#devmode) shows this warning.

*exception* UnicodeWarning[¶](#UnicodeWarning "Link to this definition")
:   Base class for warnings related to Unicode.

*exception* EncodingWarning[¶](#EncodingWarning "Link to this definition")
...
*exception* BytesWarning[¶](#BytesWarning "Link to this definition")
:   Base class for warnings related to [`bytes`](stdtypes.html#bytes "bytes") and [`bytearray`](stdtypes.html#bytearray "bytearray").

*exception* ResourceWarning[¶](#ResourceWarning "Link to this definition")
...
## Exception groups[¶](#exception-groups "Link to this heading")
...
*exception* ExceptionGroup(*msg*, *excs*)[¶](#ExceptionGroup "Link to this definition")

*exception* BaseExceptionGroup(*msg*, *excs*)[¶](#BaseExceptionGroup "Link to this definition")
:   Both of these exception types wrap the exceptions in the sequence `excs`.
    ...
    message[¶](#BaseExceptionGroup.message "Link to this definition")
    :   The `msg` argument to the constructor. This is a read-only attribute.

    exceptions[¶](#BaseExceptionGroup.exceptions "Link to this definition")
    :   A tuple of the exceptions in the `excs` sequence given to the
        constructor. This is a read-only attribute.

    subgroup(*condition*)[¶](#BaseExceptionGroup.subgroup "Link to this definition")
    ...
    split(*condition*)[¶](#BaseExceptionGroup.split "Link to this definition")
    ...
    derive(*excs*)[¶](#BaseExceptionGroup.derive "Link to this definition")
...
## Exception hierarchy[¶](#exception-hierarchy "Link to this heading")
...
* [Built-in Exceptions](#)
  ...
  + [Inheriting from built-in exceptions](#inheriting-from-built-in-exceptions)
...
[Built-in Types](stdtypes.html "previous chapter")

#### Next topic

[Text Processing Services](text.html "next chapter")
