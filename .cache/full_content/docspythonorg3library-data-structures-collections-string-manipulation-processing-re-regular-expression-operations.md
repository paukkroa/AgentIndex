...
* [previous](string.templatelib.html "string.templatelib — Support for template string literals") |
...
[`string.templatelib` — Support for template string literals](string.templatelib.html "previous chapter")
