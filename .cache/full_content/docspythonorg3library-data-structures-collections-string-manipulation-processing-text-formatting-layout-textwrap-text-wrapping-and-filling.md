...
* [next](unicodedata.html "unicodedata — Unicode Database") |
* [previous](difflib.html "difflib — Helpers for computing deltas") |
...
# `textwrap` — Text wrapping and filling[¶](#module-textwrap "Link to this heading")
...
textwrap.wrap(*text*, *width=70*, *\**, *initial\_indent=''*, *subsequent\_indent=''*, *expand\_tabs=True*, *replace\_whitespace=True*, *fix\_sentence\_endings=False*, *break\_long\_words=True*, *drop\_whitespace=True*, *break\_on\_hyphens=True*, *tabsize=8*, *max\_lines=None*, *placeholder=' [...]'*)[¶](#textwrap.wrap "Link to this definition")
...
textwrap.fill(*text*, *width=70*, *\**, *initial\_indent=''*, *subsequent\_indent=''*, *expand\_tabs=True*, *replace\_whitespace=True*, *fix\_sentence\_endings=False*, *break\_long\_words=True*, *drop\_whitespace=True*, *break\_on\_hyphens=True*, *tabsize=8*, *max\_lines=None*, *placeholder=' [...]'*)[¶](#textwrap.fill "Link to this definition")
...
textwrap.shorten(*text*, *width*, *\**, *fix\_sentence\_endings=False*, *break\_long\_words=True*, *break\_on\_hyphens=True*, *placeholder=' [...]'*)[¶](#textwrap.shorten "Link to this definition")
...
textwrap.dedent(*text*)[¶](#textwrap.dedent "Link to this definition")
...
textwrap.indent(*text*, *prefix*, *predicate=None*)[¶](#textwrap.indent "Link to this definition")
...
*class* textwrap.TextWrapper(*\*\*kwargs*)[¶](#textwrap.TextWrapper "Link to this definition")
:   The [`TextWrapper`](#textwrap.TextWrapper "textwrap.TextWrapper") constructor accepts a number of optional keyword
    ...
    wrap(*text*)[¶](#textwrap.TextWrapper.wrap "Link to this definition")
    :   Wraps the single paragraph in *text* (a string) so every line is at most
    ...
    fill(*text*)[¶](#textwrap.TextWrapper.fill "Link to this definition")
    :   Wraps the single paragraph in *text*, and returns a single string
        containing the wrapped paragraph.

#### Previous topic

[`difflib` — Helpers for computing deltas](difflib.html "previous chapter")

#### Next topic

[`unicodedata` — Unicode Database](unicodedata.html "next chapter")
