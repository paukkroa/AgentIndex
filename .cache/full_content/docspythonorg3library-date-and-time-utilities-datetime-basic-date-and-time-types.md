...
![timedelta, tzinfo, time, and date inherit from object; timezone inherits from tzinfo; and datetime inherits from date.](../_images/datetime-inheritance.svg)
...
## `timedelta` objects[¶](#timedelta-objects "Link to this heading")
...
### Examples of usage: `timedelta`[¶](#examples-of-usage-timedelta "Link to this heading")
...
## `date` objects[¶](#date-objects "Link to this heading")
...
*classmethod* date.strptime(*date\_string*, *format*)[¶](#datetime.date.strptime "Link to this definition")
...
### Examples of usage: `date`[¶](#examples-of-usage-date "Link to this heading")
...
### Examples of usage: `datetime`[¶](#examples-of-usage-datetime "Link to this heading")
...
## `time` objects[¶](#time-objects "Link to this heading")
...
*classmethod* time.strptime(*date\_string*, *format*)[¶](#datetime.time.strptime "Link to this definition")
...
### Examples of usage: `time`[¶](#examples-of-usage-time "Link to this heading")
...
## `tzinfo` objects[¶](#tzinfo-objects "Link to this heading")
...
## `timezone` objects[¶](#timezone-objects "Link to this heading")
...
## `strftime()` and `strptime()` behavior[¶](#strftime-and-strptime-behavior "Link to this heading")
...
### `strftime()` and `strptime()` format codes[¶](#strftime-and-strptime-format-codes "Link to this heading")
