...
* [next](calendar.html "calendar — General calendar-related functions") |
* [previous](datetime.html "datetime — Basic date and time types") |
...
# `zoneinfo` — IANA time zone support[¶](#module-zoneinfo "Link to this heading")
...
## Using `ZoneInfo`[¶](#using-zoneinfo "Link to this heading")
...
### Configuring the data sources[¶](#configuring-the-data-sources "Link to this heading")
...
#### Compile-time configuration[¶](#compile-time-configuration "Link to this heading")
...
PYTHONTZPATH[¶](#envvar-PYTHONTZPATH "Link to this definition")
...
## The `ZoneInfo` class[¶](#the-zoneinfo-class "Link to this heading")

*class* zoneinfo.ZoneInfo(*key*)[¶](#zoneinfo.ZoneInfo "Link to this definition")
...
*classmethod* ZoneInfo.from\_file(*file\_obj*, */*, *key=None*)[¶](#zoneinfo.ZoneInfo.from_file "Link to this definition")
:   Constructs a `ZoneInfo` object from a file-like object returning bytes
    ...
    [`ValueError`](exceptions.html#ValueError "ValueError") is raised if the data read from *file\_obj* is not a valid
    TZif file.

*classmethod* ZoneInfo.no\_cache(*key*)[¶](#zoneinfo.ZoneInfo.no_cache "Link to this definition")
...
*classmethod* ZoneInfo.clear\_cache(*\**, *only\_keys=None*)[¶](#zoneinfo.ZoneInfo.clear_cache "Link to this definition")
...
ZoneInfo.key[¶](#zoneinfo.ZoneInfo.key "Link to this definition")
...
### String representations[¶](#string-representations "Link to this heading")
...
### Pickle serialization[¶](#pickle-serialization "Link to this heading")
...
zoneinfo.available\_timezones()[¶](#zoneinfo.available_timezones "Link to this definition")
...
zoneinfo.reset\_tzpath(*to=None*)[¶](#zoneinfo.reset_tzpath "Link to this definition")
...
zoneinfo.TZPATH[¶](#zoneinfo.TZPATH "Link to this definition")
...
## Exceptions and warnings[¶](#exceptions-and-warnings "Link to this heading")

*exception* zoneinfo.ZoneInfoNotFoundError[¶](#zoneinfo.ZoneInfoNotFoundError "Link to this definition")
...
*exception* zoneinfo.InvalidTZPathWarning[¶](#zoneinfo.InvalidTZPathWarning "Link to this definition")
...
[`datetime` — Basic date and time types](datetime.html "previous chapter")

#### Next topic

[`calendar` — General calendar-related functions](calendar.html "next chapter")
