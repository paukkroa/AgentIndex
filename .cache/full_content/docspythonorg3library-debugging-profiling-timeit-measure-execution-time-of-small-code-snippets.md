...
* [next](trace.html "trace — Trace or track Python statement execution") |
* [previous](profile.html "The Python Profilers") |
...
# `timeit` — Measure execution time of small code snippets[¶](#module-timeit "Link to this heading")
...
timeit.timeit(*stmt='pass'*, *setup='pass'*, *timer=<default timer>*, *number=1000000*, *globals=None*)[¶](#timeit.timeit "Link to this definition")
...
timeit.repeat(*stmt='pass'*, *setup='pass'*, *timer=<default timer>*, *repeat=5*, *number=1000000*, *globals=None*)[¶](#timeit.repeat "Link to this definition")
:   Create a [`Timer`](#timeit.Timer "timeit.Timer") instance with the given statement, *setup* code and
...
timeit.default\_timer()[¶](#timeit.default_timer "Link to this definition")
:   The default timer, which is always time.perf\_counter(), returns float seconds.
    ...
    Changed in version 3.3: [`time.perf_counter()`](time.html#time.perf_counter "time.perf_counter") is now the default timer.

*class* timeit.Timer(*stmt='pass'*, *setup='pass'*, *timer=<timer function>*, *globals=None*)[¶](#timeit.Timer "Link to this definition")
:   Class for timing execution speed of small code snippets.
    ...
    *stmt* and *setup* may also contain multiple statements separated by `;`
    ...
    timeit(*number=1000000*)[¶](#timeit.Timer.timeit "Link to this definition")
    ...
    autorange(*callback=None*)[¶](#timeit.Timer.autorange "Link to this definition")
    ...
    repeat(*repeat=5*, *number=1000000*)[¶](#timeit.Timer.repeat "Link to this definition")
    ...
    print\_exc(*file=None*)[¶](#timeit.Timer.print_exc "Link to this definition")
...
-n N, --number=N[¶](#cmdoption-timeit-n "Link to this definition")
:   how many times to execute ‘statement’

-r N, --repeat=N[¶](#cmdoption-timeit-r "Link to this definition")
:   how many times to repeat the timer (default 5)

-s S, --setup=S[¶](#cmdoption-timeit-s "Link to this definition")
:   statement to be executed once initially (default `pass`)

-p, --process[¶](#cmdoption-timeit-p "Link to this definition")
...
-u, --unit=U[¶](#cmdoption-timeit-u "Link to this definition")
:   specify a time unit for timer output; can select `nsec`, `usec`, `msec`, or `sec`

    Added in version 3.5.

-v, --verbose[¶](#cmdoption-timeit-v "Link to this definition")
:   print raw timing results; repeat for more digits precision

-h, --help[¶](#cmdoption-timeit-h "Link to this definition")
...
[The Python Profilers](profile.html "previous chapter")

#### Next topic

[`trace` — Trace or track Python statement execution](trace.html "next chapter")
