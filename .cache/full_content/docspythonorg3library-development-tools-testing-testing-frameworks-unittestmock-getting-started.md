...
* [next](test.html "test — Regression tests package for Python") |
* [previous](unittest.mock.html "unittest.mock — mock object library") |
...
# `unittest.mock` — getting started[¶](#unittest-mock-getting-started "Link to this heading")

Added in version 3.3.

## Using Mock[¶](#using-mock "Link to this heading")

### Mock Patching Methods[¶](#mock-patching-methods "Link to this heading")
...
### Mock for Method Calls on an Object[¶](#mock-for-method-calls-on-an-object "Link to this heading")
...
### Mocking Classes[¶](#mocking-classes "Link to this heading")
...
### Naming your mocks[¶](#naming-your-mocks "Link to this heading")
...
### Tracking all Calls[¶](#tracking-all-calls "Link to this heading")
...
### Setting Return Values and Attributes[¶](#setting-return-values-and-attributes "Link to this heading")
...
### Raising exceptions with mocks[¶](#raising-exceptions-with-mocks "Link to this heading")
...
### Side effect functions and iterables[¶](#side-effect-functions-and-iterables "Link to this heading")
...
### Mocking asynchronous iterators[¶](#mocking-asynchronous-iterators "Link to this heading")
...
### Mocking asynchronous context manager[¶](#mocking-asynchronous-context-manager "Link to this heading")
...
### Creating a Mock from an Existing Object[¶](#creating-a-mock-from-an-existing-object "Link to this heading")
...
### Using side\_effect to return per file content[¶](#using-side-effect-to-return-per-file-content "Link to this heading")
...
## Patch Decorators[¶](#patch-decorators "Link to this heading")
...
## Further Examples[¶](#further-examples "Link to this heading")

Here are some more examples for some slightly more advanced scenarios.

### Mocking chained calls[¶](#mocking-chained-calls "Link to this heading")
...
### Partial mocking[¶](#partial-mocking "Link to this heading")

For some tests, you may want to mock out a call to [`datetime.date.today()`](datetime.html#datetime.date.today "datetime.date.today")
to return a known date, but don’t want to prevent the code under test from
creating new date objects. Unfortunately [`datetime.date`](datetime.html#datetime.date "datetime.date") is written in C,
so you cannot just monkey-patch out the static [`datetime.date.today()`](datetime.html#datetime.date.today "datetime.date.today") method.
...
### Mocking a Generator Method[¶](#mocking-a-generator-method "Link to this heading")

A Python generator is a function or method that uses the [`yield`](../reference/simple_stmts.html#yield) statement
to return a series of values when iterated over [[1]](#id3).
...
### Applying the same patch to every test method[¶](#applying-the-same-patch-to-every-test-method "Link to this heading")
...
### Mocking Unbound Methods[¶](#mocking-unbound-methods "Link to this heading")
...
instead. The [`patch()`](unittest.mock.html#unittest.mock.patch "unittest.mock.patch") decorator makes it so simple to patch out methods
...
### Checking multiple calls with mock[¶](#checking-multiple-calls-with-mock "Link to this heading")
...
### Coping with mutable arguments[¶](#coping-with-mutable-arguments "Link to this heading")
...
### Nesting Patches[¶](#nesting-patches "Link to this heading")
...
### Mocking a dictionary with MagicMock[¶](#mocking-a-dictionary-with-magicmock "Link to this heading")
...
### Mock subclasses and their attributes[¶](#mock-subclasses-and-their-attributes "Link to this heading")
...
[[2]](#id5). So if you’re subclassing to add helper methods then they’ll also be
...
### Mocking imports with patch.dict[¶](#mocking-imports-with-patch-dict "Link to this heading")
...
### Tracking order of calls and less verbose call assertions[¶](#tracking-order-of-calls-and-less-verbose-call-assertions "Link to this heading")
...
### More complex argument matching[¶](#more-complex-argument-matching "Link to this heading")
...
* [`unittest.mock` — getting started](#)
  + [Using Mock](#using-mock)
    - [Mock Patching Methods](#mock-patching-methods)
    - [Mock for Method Calls on an Object](#mock-for-method-calls-on-an-object)
    - [Mocking Classes](#mocking-classes)
    - [Naming your mocks](#naming-your-mocks)
    - [Tracking all Calls](#tracking-all-calls)
    - [Setting Return Values and Attributes](#setting-return-values-and-attributes)
    - [Raising exceptions with mocks](#raising-exceptions-with-mocks)
    - [Side effect functions and iterables](#side-effect-functions-and-iterables)
    ...
    - [Using side\_effect to return per file content](#using-side-effect-to-return-per-file-content)
  + [Patch Decorators](#patch-decorators)
  + [Further Examples](#further-examples)
    - [Mocking chained calls](#mocking-chained-calls)
    ...
    - [Mocking Unbound Methods](#mocking-unbound-methods)
    - [Checking multiple calls with mock](#checking-multiple-calls-with-mock)
    - [Coping with mutable arguments](#coping-with-mutable-arguments)
    - [Nesting Patches](#nesting-patches)
    - [Mocking a dictionary with MagicMock](#mocking-a-dictionary-with-magicmock)
    ...
    - [Tracking order of calls and less verbose call assertions](#tracking-order-of-calls-and-less-verbose-call-assertions)
    - [More complex argument matching](#more-complex-argument-matching)

#### Previous topic

[`unittest.mock` — mock object library](unittest.mock.html "previous chapter")

#### Next topic

[`test` — Regression tests package for Python](test.html "next chapter")

### This page

* [Report a bug](../bugs.html)
* [Improve this page](../improve-page-nojs.html)
* [Show source](https://github.com/python/cpython/blob/main/Doc/library/unittest.mock-examples.rst?plain=1)
