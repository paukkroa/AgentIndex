...
* [next](unittest.mock-examples.html "unittest.mock — getting started") |
* [previous](unittest.html "unittest — Unit testing framework") |
...
# `unittest.mock` — mock object library[¶](#module-unittest.mock "Link to this heading")

Added in version 3.3.

**Source code:** [Lib/unittest/mock.py](https://github.com/python/cpython/tree/3.14/Lib/unittest/mock.py)
...
`unittest.mock` provides a core [`Mock`](#unittest.mock.Mock "unittest.mock.Mock") class removing the need to
...
## Quick Guide[¶](#quick-guide "Link to this heading")
...
[`side_effect`](#unittest.mock.Mock.side_effect "unittest.mock.Mock.side_effect") allows you to perform side effects, including raising an
...
## The Mock Class[¶](#the-mock-class "Link to this heading")

[`Mock`](#unittest.mock.Mock "unittest.mock.Mock") is a flexible mock object intended to replace the use of stubs and
test doubles throughout your code. Mocks are callable and create attributes as
new mocks when you access them [[1]](#id3). Accessing the same attribute will always
...
*class* unittest.mock.Mock(*spec=None*, *side\_effect=None*, *return\_value=DEFAULT*, *wraps=None*, *name=None*, *spec\_set=None*, *unsafe=False*, *\*\*kwargs*)[¶](#unittest.mock.Mock "Link to this definition")
:   Create a new [`Mock`](#unittest.mock.Mock "unittest.mock.Mock") object. [`Mock`](#unittest.mock.Mock "unittest.mock.Mock") takes several optional arguments
    ...
    * *name*: If the mock has a name then it will be used in the repr of the
    ...
    assert\_called\_with(*\*args*, *\*\*kwargs*)[¶](#unittest.mock.Mock.assert_called_with "Link to this definition")
    ...
    assert\_called\_once\_with(*\*args*, *\*\*kwargs*)[¶](#unittest.mock.Mock.assert_called_once_with "Link to this definition")
    ...
    assert\_any\_call(*\*args*, *\*\*kwargs*)[¶](#unittest.mock.Mock.assert_any_call "Link to this definition")
    ...
    assert\_has\_calls(*calls*, *any\_order=False*)[¶](#unittest.mock.Mock.assert_has_calls "Link to this definition")
    :   assert the mock has been called with the specified calls.
        The [`mock_calls`](#unittest.mock.Mock.mock_calls "unittest.mock.Mock.mock_calls") list is checked for the calls.

        If *any\_order* is false then the calls must be
    ...
    reset\_mock(*\**, *return\_value=False*, *side\_effect=False*)[¶](#unittest.mock.Mock.reset_mock "Link to this definition")
    :   The reset\_mock method resets all the call attributes on a mock object:
        ...
        *return\_value* parameter when set to `True` resets [`return_value`](#unittest.mock.Mock.return_value "unittest.mock.Mock.return_value"):
    ...
    mock\_add\_spec(*spec*, *spec\_set=False*)[¶](#unittest.mock.Mock.mock_add_spec "Link to this definition")
    ...
    attach\_mock(*mock*, *attribute*)[¶](#unittest.mock.Mock.attach_mock "Link to this definition")
    ...
    configure\_mock(*\*\*kwargs*)[¶](#unittest.mock.Mock.configure_mock "Link to this definition")
    ...
    \_get\_child\_mock(*\*\*kw*)[¶](#unittest.mock.Mock._get_child_mock "Link to this definition")
...
*class* unittest.mock.NonCallableMock(*spec=None*, *wraps=None*, *name=None*, *spec\_set=None*, *\*\*kwargs*)[¶](#unittest.mock.NonCallableMock "Link to this definition")
...
A callable mock which was created with a *spec* (or a *spec\_set*) will
...
*class* unittest.mock.PropertyMock(*\*args*, *\*\*kwargs*)[¶](#unittest.mock.PropertyMock "Link to this definition")
...
*class* unittest.mock.AsyncMock(*spec=None*, *side\_effect=None*, *return\_value=DEFAULT*, *wraps=None*, *name=None*, *spec\_set=None*, *unsafe=False*, *\*\*kwargs*)[¶](#unittest.mock.AsyncMock "Link to this definition")
:   An asynchronous version of [`MagicMock`](#unittest.mock.MagicMock "unittest.mock.MagicMock"). The [`AsyncMock`](#unittest.mock.AsyncMock "unittest.mock.AsyncMock") object will
    ...
    * if `side_effect` is not defined, the async function will return the
    ...
    assert\_awaited\_with(*\*args*, *\*\*kwargs*)[¶](#unittest.mock.AsyncMock.assert_awaited_with "Link to this definition")
    ...
    assert\_awaited\_once\_with(*\*args*, *\*\*kwargs*)[¶](#unittest.mock.AsyncMock.assert_awaited_once_with "Link to this definition")
    ...
    assert\_any\_await(*\*args*, *\*\*kwargs*)[¶](#unittest.mock.AsyncMock.assert_any_await "Link to this definition")
    ...
    assert\_has\_awaits(*calls*, *any\_order=False*)[¶](#unittest.mock.AsyncMock.assert_has_awaits "Link to this definition")
    ...
    reset\_mock(*\*args*, *\*\*kwargs*)[¶](#unittest.mock.AsyncMock.reset_mock "Link to this definition")
...
*class* unittest.mock.ThreadingMock(*spec=None*, *side\_effect=None*, *return\_value=DEFAULT*, *wraps=None*, *name=None*, *spec\_set=None*, *unsafe=False*, *\**, *timeout=UNSET*, *\*\*kwargs*)[¶](#unittest.mock.ThreadingMock "Link to this definition")
:   A version of [`MagicMock`](#unittest.mock.MagicMock "unittest.mock.MagicMock") for multithreading tests. The
    ...
    You can configure the global default timeout by setting [`ThreadingMock.DEFAULT_TIMEOUT`](#unittest.mock.ThreadingMock.DEFAULT_TIMEOUT "unittest.mock.ThreadingMock.DEFAULT_TIMEOUT").

    wait\_until\_called(*\**, *timeout=UNSET*)[¶](#unittest.mock.ThreadingMock.wait_until_called "Link to this definition")
    ...
    wait\_until\_any\_call\_with(*\*args*, *\*\*kwargs*)[¶](#unittest.mock.ThreadingMock.wait_until_any_call_with "Link to this definition")
...
If [`side_effect`](#unittest.mock.Mock.side_effect "unittest.mock.Mock.side_effect") is set then it will be called after the call has
...
### Deleting Attributes[¶](#deleting-attributes "Link to this heading")
...
### Mock names and the name attribute[¶](#mock-names-and-the-name-attribute "Link to this heading")
...
### Attaching Mocks as Attributes[¶](#attaching-mocks-as-attributes "Link to this heading")
...
Mocks created for you by [`patch()`](#unittest.mock.patch "unittest.mock.patch") are automatically given names. To
...
instead raises an [`AttributeError`](exceptions.html#AttributeError "AttributeError"). This is because the interpreter
will often implicitly request these methods, and gets *very* confused to
get a new Mock object when it expects a magic method. If you need magic
method support see [magic methods](#magic-methods).

## The patchers[¶](#the-patchers "Link to this heading")
...
unittest.mock.patch(*target*, *new=DEFAULT*, *spec=None*, *create=False*, *spec\_set=None*, *autospec=None*, *new\_callable=None*, *\*\*kwargs*)[¶](#unittest.mock.patch "Link to this definition")
...
If you use *spec* or *spec\_set* and [`patch()`](#unittest.mock.patch "unittest.mock.patch") is replacing a *class*, then the
...
patch.object(*target*, *attribute*, *new=DEFAULT*, *spec=None*, *create=False*, *spec\_set=None*, *autospec=None*, *new\_callable=None*, *\*\*kwargs*)[¶](#unittest.mock.patch.object "Link to this definition")
...
patch.dict(*in\_dict*, *values=()*, *clear=False*, *\*\*kwargs*)[¶](#unittest.mock.patch.dict "Link to this definition")
...
patch.multiple(*target*, *spec=None*, *create=False*, *spec\_set=None*, *autospec=None*, *new\_callable=None*, *\*\*kwargs*)[¶](#unittest.mock.patch.multiple "Link to this definition")
:   Perform multiple patches in a single call. It takes the object to be
    ...
    *new\_callable* have the same meaning as for [`patch()`](#unittest.mock.patch "unittest.mock.patch"). These arguments will
    ...
    When used as a class decorator [`patch.multiple()`](#unittest.mock.patch.multiple "unittest.mock.patch.multiple") honours `patch.TEST_PREFIX`
    for choosing which methods to wrap.
...
### patch methods: start and stop[¶](#patch-methods-start-and-stop "Link to this heading")
...
### patch builtins[¶](#patch-builtins "Link to this heading")
...
### Nesting Patch Decorators[¶](#nesting-patch-decorators "Link to this heading")
...
### Where to patch[¶](#where-to-patch "Link to this heading")
...
### Patching Descriptors and Proxy Objects[¶](#patching-descriptors-and-proxy-objects "Link to this heading")
...
## MagicMock and magic method support[¶](#magicmock-and-magic-method-support "Link to this heading")

### Mocking Magic Methods[¶](#mocking-magic-methods "Link to this heading")
...
Because magic methods are looked up differently from normal methods [[2]](#id9), this
...
Changed in version 3.8: Added support for [`os.PathLike.__fspath__()`](os.html#os.PathLike.__fspath__ "os.PathLike.__fspath__").
...
### Magic Mock[¶](#magic-mock "Link to this heading")
...
*class* unittest.mock.MagicMock(*\*args*, *\*\*kw*)[¶](#unittest.mock.MagicMock "Link to this definition")
...
*class* unittest.mock.NonCallableMagicMock(*\*args*, *\*\*kw*)[¶](#unittest.mock.NonCallableMagicMock "Link to this definition")
...
unittest.mock.call(*\*args*, *\*\*kwargs*)[¶](#unittest.mock.call "Link to this definition")
...
unittest.mock.create\_autospec(*spec*, *spec\_set=False*, *instance=False*, *\*\*kwargs*)[¶](#unittest.mock.create_autospec "Link to this definition")
...
Changed in version 3.8: [`create_autospec()`](#unittest.mock.create_autospec "unittest.mock.create_autospec") now returns an [`AsyncMock`](#unittest.mock.AsyncMock "unittest.mock.AsyncMock") if the target is
an async function.
...
Many of the not-very-useful (private to [`Mock`](#unittest.mock.Mock "unittest.mock.Mock") rather than the thing being
...
unittest.mock.mock\_open(*mock=None*, *read\_data=None*)[¶](#unittest.mock.mock_open "Link to this definition")
...
### Autospeccing[¶](#autospeccing "Link to this heading")
...
objects so that introspection is safe [[4]](#id12).
...
It is only attribute lookups - along with calls to [`dir()`](functions.html#dir "dir") - that are done.

### Sealing mocks[¶](#sealing-mocks "Link to this heading")

unittest.mock.seal(*mock*)[¶](#unittest.mock.seal "Link to this definition")
...
## Order of precedence of `side_effect`, `return_value` and *wraps*[¶](#order-of-precedence-of-side-effect-return-value-and-wraps "Link to this heading")
...
If all three are set, mock will return the value from [`side_effect`](#unittest.mock.Mock.side_effect "unittest.mock.Mock.side_effect"),
ignoring [`return_value`](#unittest.mock.Mock.return_value "unittest.mock.Mock.return_value") and the wrapped object altogether. If any
...
As `None` is the default value of [`side_effect`](#unittest.mock.Mock.side_effect "unittest.mock.Mock.side_effect"), if you reassign
its value back to `None`, the order of precedence will be checked between
[`return_value`](#unittest.mock.Mock.return_value "unittest.mock.Mock.return_value") and the wrapped object, ignoring
[`side_effect`](#unittest.mock.Mock.side_effect "unittest.mock.Mock.side_effect").
...
If the value being returned by [`side_effect`](#unittest.mock.Mock.side_effect "unittest.mock.Mock.side_effect") is [`DEFAULT`](#unittest.mock.DEFAULT "unittest.mock.DEFAULT"),
...
When [`Mock`](#unittest.mock.Mock "unittest.mock.Mock") wraps an object, the default value of
[`return_value`](#unittest.mock.Mock.return_value "unittest.mock.Mock.return_value") will be [`DEFAULT`](#unittest.mock.DEFAULT "unittest.mock.DEFAULT").
...
If [`side_effect`](#unittest.mock.Mock.side_effect "unittest.mock.Mock.side_effect") is exhausted, the order of precedence will not
...
* [`unittest.mock` — mock object library](#)
  ...
  + [The Mock Class](#the-mock-class)
    - [Calling](#calling)
    - [Deleting Attributes](#deleting-attributes)
    - [Mock names and the name attribute](#mock-names-and-the-name-attribute)
    - [Attaching Mocks as Attributes](#attaching-mocks-as-attributes)
  + [The patchers](#the-patchers)
    - [patch](#patch)
    - [patch.object](#patch-object)
    - [patch.dict](#patch-dict)
    - [patch.multiple](#patch-multiple)
    - [patch methods: start and stop](#patch-methods-start-and-stop)
    - [patch builtins](#patch-builtins)
    - [TEST\_PREFIX](#test-prefix)
    - [Nesting Patch Decorators](#nesting-patch-decorators)
    - [Where to patch](#where-to-patch)
    - [Patching Descriptors and Proxy Objects](#patching-descriptors-and-proxy-objects)
  + [MagicMock and magic method support](#magicmock-and-magic-method-support)
    - [Mocking Magic Methods](#mocking-magic-methods)
    - [Magic Mock](#magic-mock)
  + [Helpers](#helpers)
    - [sentinel](#sentinel)
    - [DEFAULT](#default)
    - [call](#call)
    - [create\_autospec](#create-autospec)
    - [ANY](#any)
    - [FILTER\_DIR](#filter-dir)
    - [mock\_open](#mock-open)
    - [Autospeccing](#autospeccing)
    - [Sealing mocks](#sealing-mocks)
  + [Order of precedence of `side_effect`, `return_value` and *wraps*](#order-of-precedence-of-side-effect-return-value-and-wraps)

#### Previous topic

[`unittest` — Unit testing framework](unittest.html "previous chapter")

#### Next topic

[`unittest.mock` — getting started](unittest.mock-examples.html "next chapter")

### This page

* [Report a bug](../bugs.html)
* [Improve this page](../improve-page-nojs.html)
* [Show source](https://github.com/python/cpython/blob/main/Doc/library/unittest.mock.rst?plain=1)
