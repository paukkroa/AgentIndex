...
# `typing` — Support for type hints[¶](#typing-support-for-type-hints "Link to this heading")
...
*class* typing.Union[¶](#typing.Union "Link to this definition")
:   Union type; `Union[X, Y]` is equivalent to `X | Y` and means either X or Y.
    ...
    * You cannot write `Union[X][Y]`.
    ...
    Changed in version 3.14: [`types.UnionType`](types.html#types.UnionType "types.UnionType") is now an alias for [`Union`](#typing.Union "typing.Union"), and both
...
typing.ReadOnly[¶](#typing.ReadOnly "Link to this definition")
...
typing.TypeIs[¶](#typing.TypeIs "Link to this definition")
...
*class* typing.TypeVar(*name*, *\*constraints*, *bound=None*, *covariant=False*, *contravariant=False*, *infer\_variance=False*, *default=typing.NoDefault*)[¶](#typing.TypeVar "Link to this definition")
:   Type variable.
    ...
    evaluate\_bound()[¶](#typing.TypeVar.evaluate_bound "Link to this definition")
    :   An [evaluate function](../glossary.html#term-evaluate-function) corresponding to the [`__bound__`](#typing.TypeVar.__bound__ "typing.TypeVar.__bound__") attribute.
        ...
        format, which is equivalent to accessing the [`__bound__`](#typing.TypeVar.__bound__ "typing.TypeVar.__bound__") attribute directly,
    ...
    evaluate\_constraints()[¶](#typing.TypeVar.evaluate_constraints "Link to this definition")
    :   An [evaluate function](../glossary.html#term-evaluate-function) corresponding to the [`__constraints__`](#typing.TypeVar.__constraints__ "typing.TypeVar.__constraints__") attribute.
        When called directly, this method supports only the [`VALUE`](annotationlib.html#annotationlib.Format.VALUE "annotationlib.Format.VALUE")
        format, which is equivalent to accessing the [`__constraints__`](#typing.TypeVar.__constraints__ "typing.TypeVar.__constraints__") attribute directly,
        but the method object can be passed to [`annotationlib.call_evaluate_function()`](annotationlib.html#annotationlib.call_evaluate_function "annotationlib.call_evaluate_function")
        to evaluate the value in a different format.

        Added in version 3.14.

    \_\_default\_\_[¶](#typing.TypeVar.__default__ "Link to this definition")
    :   The default value of the type variable, or [`typing.NoDefault`](#typing.NoDefault "typing.NoDefault") if it
        has no default.

        Added in version 3.13.

    evaluate\_default()[¶](#typing.TypeVar.evaluate_default "Link to this definition")
    :   An [evaluate function](../glossary.html#term-evaluate-function) corresponding to the [`__default__`](#typing.TypeVar.__default__ "typing.TypeVar.__default__") attribute.
        When called directly, this method supports only the [`VALUE`](annotationlib.html#annotationlib.Format.VALUE "annotationlib.Format.VALUE")
        format, which is equivalent to accessing the [`__default__`](#typing.TypeVar.__default__ "typing.TypeVar.__default__") attribute directly,
        but the method object can be passed to [`annotationlib.call_evaluate_function()`](annotationlib.html#annotationlib.call_evaluate_function "annotationlib.call_evaluate_function")
        to evaluate the value in a different format.

        Added in version 3.14.

    has\_default()[¶](#typing.TypeVar.has_default "Link to this definition")
...
*class* typing.TypeVarTuple(*name*, *\**, *default=typing.NoDefault*)[¶](#typing.TypeVarTuple "Link to this definition")
:   Type variable tuple. A specialized form of [type variable](#typevar)
    ...
    *arbitrary* number of types by acting like an *arbitrary* number of type
    ...
    \_\_default\_\_[¶](#typing.TypeVarTuple.__default__ "Link to this definition")
    :   The default value of the type variable tuple, or [`typing.NoDefault`](#typing.NoDefault "typing.NoDefault") if it
        has no default.

        Added in version 3.13.

    evaluate\_default()[¶](#typing.TypeVarTuple.evaluate_default "Link to this definition")
    :   An [evaluate function](../glossary.html#term-evaluate-function) corresponding to the [`__default__`](#typing.TypeVarTuple.__default__ "typing.TypeVarTuple.__default__") attribute.
        When called directly, this method supports only the [`VALUE`](annotationlib.html#annotationlib.Format.VALUE "annotationlib.Format.VALUE")
        format, which is equivalent to accessing the [`__default__`](#typing.TypeVarTuple.__default__ "typing.TypeVarTuple.__default__") attribute directly,
        but the method object can be passed to [`annotationlib.call_evaluate_function()`](annotationlib.html#annotationlib.call_evaluate_function "annotationlib.call_evaluate_function")
        to evaluate the value in a different format.

        Added in version 3.14.

    has\_default()[¶](#typing.TypeVarTuple.has_default "Link to this definition")
...
*class* typing.ParamSpec(*name*, *\**, *bound=None*, *covariant=False*, *contravariant=False*, *default=typing.NoDefault*)[¶](#typing.ParamSpec "Link to this definition")
:   Parameter specification variable. A specialized version of
    ...
    \_\_default\_\_[¶](#typing.ParamSpec.__default__ "Link to this definition")
    :   The default value of the parameter specification, or [`typing.NoDefault`](#typing.NoDefault "typing.NoDefault") if it
        has no default.

        Added in version 3.13.

    evaluate\_default()[¶](#typing.ParamSpec.evaluate_default "Link to this definition")
    :   An [evaluate function](../glossary.html#term-evaluate-function) corresponding to the [`__default__`](#typing.ParamSpec.__default__ "typing.ParamSpec.__default__") attribute.
        When called directly, this method supports only the [`VALUE`](annotationlib.html#annotationlib.Format.VALUE "annotationlib.Format.VALUE")
        format, which is equivalent to accessing the [`__default__`](#typing.ParamSpec.__default__ "typing.ParamSpec.__default__") attribute directly,
        but the method object can be passed to [`annotationlib.call_evaluate_function()`](annotationlib.html#annotationlib.call_evaluate_function "annotationlib.call_evaluate_function")
        to evaluate the value in a different format.

        Added in version 3.14.

    has\_default()[¶](#typing.ParamSpec.has_default "Link to this definition")
...
:   The type of type aliases created through the [`type`](../reference/simple_stmts.html#type) statement.
    ...
    evaluate\_value()[¶](#typing.TypeAliasType.evaluate_value "Link to this definition")
    :   An [evaluate function](../glossary.html#term-evaluate-function) corresponding to the [`__value__`](#typing.TypeAliasType.__value__ "typing.TypeAliasType.__value__") attribute.
        When called directly, this method supports only the [`VALUE`](annotationlib.html#annotationlib.Format.VALUE "annotationlib.Format.VALUE")
        format, which is equivalent to accessing the [`__value__`](#typing.TypeAliasType.__value__ "typing.TypeAliasType.__value__") attribute directly,
        but the method object can be passed to [`annotationlib.call_evaluate_function()`](annotationlib.html#annotationlib.call_evaluate_function "annotationlib.call_evaluate_function")
        to evaluate the value in a different format:
...
:   Special construct to add type hints to a dictionary.
    ...
    \_\_readonly\_keys\_\_[¶](#typing.TypedDict.__readonly_keys__ "Link to this definition")
    ...
    \_\_mutable\_keys\_\_[¶](#typing.TypedDict.__mutable_keys__ "Link to this definition")
...
### ABCs and Protocols for working with I/O[¶](#abcs-and-protocols-for-working-with-i-o "Link to this heading")

*class* typing.IO[*AnyStr*][¶](#typing.IO "Link to this definition")
...
:   Generic class `IO[AnyStr]` and its subclasses `TextIO(IO[str])`
    ...
    [`open()`](functions.html#open "open"). Please note that these classes are not protocols, and
    their interface is fairly broad.

The protocols [`io.Reader`](io.html#io.Reader "io.Reader") and [`io.Writer`](io.html#io.Writer "io.Writer") offer a simpler
...
Also consider using [`collections.abc.Iterable`](collections.abc.html#collections.abc.Iterable "collections.abc.Iterable") for iterating over
...
typing.get\_protocol\_members(*tp*)[¶](#typing.get_protocol_members "Link to this definition")
...
typing.is\_protocol(*tp*)[¶](#typing.is_protocol "Link to this definition")
...
typing.evaluate\_forward\_ref(*forward\_ref*, *\**, *owner=None*, *globals=None*, *locals=None*, *type\_params=None*, *format=annotationlib.Format.VALUE*)[¶](#typing.evaluate_forward_ref "Link to this definition")
...
typing.NoDefault[¶](#typing.NoDefault "Link to this definition")
...
*class* typing.ContextManager(*Generic[T\_co, ExitT\_co]*)[¶](#typing.ContextManager "Link to this definition")
...
*class* typing.AsyncContextManager(*Generic[T\_co, AExitT\_co]*)[¶](#typing.AsyncContextManager "Link to this definition")
