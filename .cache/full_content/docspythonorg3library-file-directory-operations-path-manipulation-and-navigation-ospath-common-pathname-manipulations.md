...
* [next](stat.html "stat — Interpreting stat() results") |
* [previous](pathlib.html "pathlib — Object-oriented filesystem paths") |
...
# `os.path` — Common pathname manipulations[¶](#module-os.path "Link to this heading")
...
files see [`open()`](functions.html#open "open"), and for accessing the filesystem see the [`os`](os.html#module-os "os: Miscellaneous operating system interfaces.")
module. The path parameters can be passed as strings, or bytes, or any object
implementing the [`os.PathLike`](os.html#os.PathLike "os.PathLike") protocol.

Unlike a Unix shell, Python does not do any *automatic* path expansions.
Functions such as [`expanduser()`](#os.path.expanduser "os.path.expanduser") and [`expandvars()`](#os.path.expandvars "os.path.expandvars") can be invoked
explicitly when an application desires shell-like path expansion. (See also
the [`glob`](glob.html#module-glob "glob: Unix shell style pathname pattern expansion.") module.)
...
Changed in version 3.8: [`exists()`](#os.path.exists "os.path.exists"), [`lexists()`](#os.path.lexists "os.path.lexists"), [`isdir()`](#os.path.isdir "os.path.isdir"), [`isfile()`](#os.path.isfile "os.path.isfile"),
[`islink()`](#os.path.islink "os.path.islink"), and [`ismount()`](#os.path.ismount "os.path.ismount") now return `False` instead of
raising an exception for paths that contain characters or bytes
unrepresentable at the OS level.

os.path.abspath(*path*)[¶](#os.path.abspath "Link to this definition")
:   Return a normalized absolutized version of the pathname *path*. On most
    platforms, this is equivalent to calling `normpath(join(os.getcwd(), path))`.

    See also

    [`os.path.join()`](#os.path.join "os.path.join") and [`os.path.normpath()`](#os.path.normpath "os.path.normpath").

    Changed in version 3.6: Accepts a [path-like object](../glossary.html#term-path-like-object).

os.path.basename(*path*, */*)[¶](#os.path.basename "Link to this definition")
:   Return the base name of pathname *path*. This is the second element of the
    pair returned by passing *path* to the function [`split()`](#os.path.split "os.path.split"). Note that
    the result of this function is different
    from the Unix **basename** program; where **basename** for
    `'/foo/bar/'` returns `'bar'`, the [`basename()`](#os.path.basename "os.path.basename") function returns an
    empty string (`''`).

    Changed in version 3.6: Accepts a [path-like object](../glossary.html#term-path-like-object).

os.path.commonpath(*paths*)[¶](#os.path.commonpath "Link to this definition")
:   Return the longest common sub-path of each pathname in the iterable
    *paths*. Raise [`ValueError`](exceptions.html#ValueError "ValueError") if *paths* contain both absolute
    and relative pathnames, if *paths* are on different drives, or
    if *paths* is empty. Unlike [`commonprefix()`](#os.path.commonprefix "os.path.commonprefix"), this returns a
    valid path.
...
os.path.commonprefix(*list*, */*)[¶](#os.path.commonprefix "Link to this definition")
:   Return the longest string prefix (taken character-by-character) that is a
    ...
    [`commonpath()`](#os.path.commonpath "os.path.commonpath") for finding a common path prefix.
...
os.path.dirname(*path*, */*)[¶](#os.path.dirname "Link to this definition")
:   Return the directory name of pathname *path*. This is the first element of
    the pair returned by passing *path* to the function [`split()`](#os.path.split "os.path.split").

    Changed in version 3.6: Accepts a [path-like object](../glossary.html#term-path-like-object).

os.path.exists(*path*)[¶](#os.path.exists "Link to this definition")
:   Return `True` if *path* refers to an existing path or an open
    ...
    not granted to execute [`os.stat()`](os.html#os.stat "os.stat") on the requested file, even
...
os.path.lexists(*path*)[¶](#os.path.lexists "Link to this definition")
:   Return `True` if *path* refers to an existing path, including
    broken symbolic links. Equivalent to [`exists()`](#os.path.exists "os.path.exists") on platforms lacking
    [`os.lstat()`](os.html#os.lstat "os.lstat").

    Changed in version 3.6: Accepts a [path-like object](../glossary.html#term-path-like-object).

os.path.expanduser(*path*)[¶](#os.path.expanduser "Link to this definition")
:   On Unix and Windows, return the argument with an initial component of `~` or
    `~user` replaced by that *user*’s home directory.

    On Unix, an initial `~` is replaced by the environment variable `HOME`
    if it is set; otherwise the current user’s home directory is looked up in the
    password directory through the built-in module [`pwd`](pwd.html#module-pwd "pwd: The password database (getpwnam() and friends)."). An initial `~user`
...
os.path.expandvars(*path*)[¶](#os.path.expandvars "Link to this definition")
...
os.path.getatime(*path*, */*)[¶](#os.path.getatime "Link to this definition")
:   Return the time of last access of *path*. The return value is a floating-point number giving
    the number of seconds since the epoch (see the [`time`](time.html#module-time "time: Time access and conversions.") module). Raise
    [`OSError`](exceptions.html#OSError "OSError") if the file does not exist or is inaccessible.

os.path.getmtime(*path*, */*)[¶](#os.path.getmtime "Link to this definition")
:   Return the time of last modification of *path*. The return value is a floating-point number
    giving the number of seconds since the epoch (see the [`time`](time.html#module-time "time: Time access and conversions.") module).
    Raise [`OSError`](exceptions.html#OSError "OSError") if the file does not exist or is inaccessible.

    Changed in version 3.6: Accepts a [path-like object](../glossary.html#term-path-like-object).

os.path.getctime(*path*, */*)[¶](#os.path.getctime "Link to this definition")
:   Return the system’s ctime which, on some systems (like Unix) is the time of the
    last metadata change, and, on others (like Windows), is the creation time for *path*.
    The return value is a number giving the number of seconds since the epoch (see
    the [`time`](time.html#module-time "time: Time access and conversions.") module). Raise [`OSError`](exceptions.html#OSError "OSError") if the file does not exist or
    is inaccessible.

    Changed in version 3.6: Accepts a [path-like object](../glossary.html#term-path-like-object).

os.path.getsize(*path*, */*)[¶](#os.path.getsize "Link to this definition")
:   Return the size, in bytes, of *path*. Raise [`OSError`](exceptions.html#OSError "OSError") if the file does
    not exist or is inaccessible.

    Changed in version 3.6: Accepts a [path-like object](../glossary.html#term-path-like-object).

os.path.isabs(*path*, */*)[¶](#os.path.isabs "Link to this definition")
:   Return `True` if *path* is an absolute pathname. On Unix, that means it
    ...
    [`abspath()`](#os.path.abspath "os.path.abspath")
...
os.path.isfile(*path*)[¶](#os.path.isfile "Link to this definition")
:   Return `True` if *path* is an [`existing`](#os.path.exists "os.path.exists") regular file.
    This follows symbolic links, so both [`islink()`](#os.path.islink "os.path.islink") and [`isfile()`](#os.path.isfile "os.path.isfile") can
    be true for the same path.

    Changed in version 3.6: Accepts a [path-like object](../glossary.html#term-path-like-object).

os.path.isdir(*path*, */*)[¶](#os.path.isdir "Link to this definition")
:   Return `True` if *path* is an [`existing`](#os.path.exists "os.path.exists") directory. This
    follows symbolic links, so both [`islink()`](#os.path.islink "os.path.islink") and [`isdir()`](#os.path.isdir "os.path.isdir") can be true
    for the same path.

    Changed in version 3.6: Accepts a [path-like object](../glossary.html#term-path-like-object).

os.path.isjunction(*path*)[¶](#os.path.isjunction "Link to this definition")
:   Return `True` if *path* refers to an [`existing`](#os.path.lexists "os.path.lexists") directory
    entry that is a junction. Always return `False` if junctions are not
    supported on the current platform.

    Added in version 3.12.

os.path.islink(*path*)[¶](#os.path.islink "Link to this definition")
:   Return `True` if *path* refers to an [`existing`](#os.path.exists "os.path.exists") directory
    entry that is a symbolic link. Always `False` if symbolic links are not
    supported by the Python runtime.

    Changed in version 3.6: Accepts a [path-like object](../glossary.html#term-path-like-object).

os.path.ismount(*path*)[¶](#os.path.ismount "Link to this definition")
...
os.path.isdevdrive(*path*)[¶](#os.path.isdevdrive "Link to this definition")
...
os.path.isreserved(*path*)[¶](#os.path.isreserved "Link to this definition")
...
os.path.join(*path*, */*, *\*paths*)[¶](#os.path.join "Link to this definition")
...
os.path.normcase(*path*, */*)[¶](#os.path.normcase "Link to this definition")
...
os.path.normpath(*path*)[¶](#os.path.normpath "Link to this definition")
:   Normalize a pathname by collapsing redundant separators and up-level
    references so that `A//B`, `A/B/`, `A/./B` and `A/foo/../B` all
    become `A/B`. This string manipulation may change the meaning of a path
    that contains symbolic links. On Windows, it converts forward slashes to
    backward slashes. To normalize case, use [`normcase()`](#os.path.normcase "os.path.normcase").
...
os.path.realpath(*path*, */*, *\**, *strict=False*)[¶](#os.path.realpath "Link to this definition")
:   Return the canonical path of the specified filename, eliminating any symbolic
    ...
    Changed in version 3.14: The [`ALLOW_MISSING`](#os.path.ALLOW_MISSING "os.path.ALLOW_MISSING") value for the *strict* parameter
    was added.

os.path.ALLOW\_MISSING[¶](#os.path.ALLOW_MISSING "Link to this definition")
:   Special value used for the *strict* argument in [`realpath()`](#os.path.realpath "os.path.realpath").

    Added in version 3.14.

os.path.relpath(*path*, *start=os.curdir*)[¶](#os.path.relpath "Link to this definition")
:   Return a relative filepath to *path* either from the current directory or
    from an optional *start* directory. This is a path computation: the
    filesystem is not accessed to confirm the existence or nature of *path* or
    *start*. On Windows, [`ValueError`](exceptions.html#ValueError "ValueError") is raised when *path* and *start*
    are on different drives.

    *start* defaults to [`os.curdir`](os.html#os.curdir "os.curdir").

    Changed in version 3.6: Accepts a [path-like object](../glossary.html#term-path-like-object).

os.path.samefile(*path1*, *path2*, */*)[¶](#os.path.samefile "Link to this definition")
:   Return `True` if both pathname arguments refer to the same file or directory.
    This is determined by the device number and i-node number and raises an
    exception if an [`os.stat()`](os.html#os.stat "os.stat") call on either pathname fails.
...
os.path.sameopenfile(*fp1*, *fp2*)[¶](#os.path.sameopenfile "Link to this definition")
...
os.path.samestat(*stat1*, *stat2*, */*)[¶](#os.path.samestat "Link to this definition")
:   Return `True` if the stat tuples *stat1* and *stat2* refer to the same file.
    These structures may have been returned by [`os.fstat()`](os.html#os.fstat "os.fstat"),
    [`os.lstat()`](os.html#os.lstat "os.lstat"), or [`os.stat()`](os.html#os.stat "os.stat"). This function implements the
    underlying comparison used by [`samefile()`](#os.path.samefile "os.path.samefile") and [`sameopenfile()`](#os.path.sameopenfile "os.path.sameopenfile").

    Changed in version 3.4: Added Windows support.

os.path.split(*path*, */*)[¶](#os.path.split "Link to this definition")
:   Split the pathname *path* into a pair, `(head, tail)` where *tail* is the
    ...
    *path* is empty, both *head* and *tail* are empty. Trailing slashes are
    ...
    (but the strings may differ). Also see the functions [`join()`](#os.path.join "os.path.join"),
    [`dirname()`](#os.path.dirname "os.path.dirname") and [`basename()`](#os.path.basename "os.path.basename").

    Changed in version 3.6: Accepts a [path-like object](../glossary.html#term-path-like-object).

os.path.splitdrive(*path*, */*)[¶](#os.path.splitdrive "Link to this definition")
...
os.path.splitroot(*path*, */*)[¶](#os.path.splitroot "Link to this definition")
...
os.path.splitext(*path*, */*)[¶](#os.path.splitext "Link to this definition")
...
[`pathlib` — Object-oriented filesystem paths](pathlib.html "previous chapter")

#### Next topic

[`stat` — Interpreting `stat()` results](stat.html "next chapter")
