...
*exception* pathlib.UnsupportedOperation[¶](#pathlib.UnsupportedOperation "Link to this definition")
...
PurePath.full\_match(*pattern*, *\**, *case\_sensitive=None*)[¶](#pathlib.PurePath.full_match "Link to this definition")
...
### Parsing and generating URIs[¶](#parsing-and-generating-uris "Link to this heading")
...
*classmethod* Path.from\_uri(*uri*)[¶](#pathlib.Path.from_uri "Link to this definition")
...
some kinds of [`OSError`](exceptions.html#OSError "OSError") exception are raised, and others suppressed.
...
Path.is\_file(*\**, *follow\_symlinks=True*)[¶](#pathlib.Path.is_file "Link to this definition")
...
Path.is\_dir(*\**, *follow\_symlinks=True*)[¶](#pathlib.Path.is_dir "Link to this definition")
...
:   A [`PathInfo`](#pathlib.types.PathInfo "pathlib.types.PathInfo") object that supports querying file type
    ...
    the parent directory. Merely accessing [`Path.info`](#pathlib.Path.info "pathlib.Path.info") does not perform
...
Path.read\_text(*encoding=None*, *errors=None*, *newline=None*)[¶](#pathlib.Path.read_text "Link to this definition")
...
Path.glob(*pattern*, *\**, *case\_sensitive=None*, *recurse\_symlinks=False*)[¶](#pathlib.Path.glob "Link to this definition")
...
Path.rglob(*pattern*, *\**, *case\_sensitive=None*, *recurse\_symlinks=False*)[¶](#pathlib.Path.rglob "Link to this definition")
...
### Copying, moving and deleting[¶](#copying-moving-and-deleting "Link to this heading")

Path.copy(*target*, *\**, *follow\_symlinks=True*, *preserve\_metadata=False*)[¶](#pathlib.Path.copy "Link to this definition")
...
Path.copy\_into(*target\_dir*, *\**, *follow\_symlinks=True*, *preserve\_metadata=False*)[¶](#pathlib.Path.copy_into "Link to this definition")
...
Path.move(*target*)[¶](#pathlib.Path.move "Link to this definition")
...
Path.move\_into(*target\_dir*)[¶](#pathlib.Path.move_into "Link to this definition")
...
Path.owner(*\**, *follow\_symlinks=True*)[¶](#pathlib.Path.owner "Link to this definition")
...
Path.group(*\**, *follow\_symlinks=True*)[¶](#pathlib.Path.group "Link to this definition")
...
## Pattern language[¶](#pattern-language "Link to this heading")
...
## Comparison to the [`glob`](glob.html#module-glob "glob: Unix shell style pathname pattern expansion.") module[¶](#comparison-to-the-glob-module "Link to this heading")
...
## Comparison to the [`os`](os.html#module-os "os: Miscellaneous operating system interfaces.") and [`os.path`](os.path.html#module-os.path "os.path: Operations on pathnames.") modules[¶](#comparison-to-the-os-and-os-path-modules "Link to this heading")
...
### Corresponding tools[¶](#corresponding-tools "Link to this heading")
...
## Protocols[¶](#module-pathlib.types "Link to this heading")

The `pathlib.types` module provides types for static type checking.

Added in version 3.14.

*class* pathlib.types.PathInfo[¶](#pathlib.types.PathInfo "Link to this definition")
:   A [`typing.Protocol`](typing.html#typing.Protocol "typing.Protocol") describing the
    ...
    exists(*\**, *follow\_symlinks=True*)[¶](#pathlib.types.PathInfo.exists "Link to this definition")
    ...
    is\_dir(*\**, *follow\_symlinks=True*)[¶](#pathlib.types.PathInfo.is_dir "Link to this definition")
    ...
    is\_file(*\**, *follow\_symlinks=True*)[¶](#pathlib.types.PathInfo.is_file "Link to this definition")
