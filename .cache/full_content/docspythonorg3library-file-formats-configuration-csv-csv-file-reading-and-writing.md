...
# `csv` — CSV File Reading and Writing[¶](#module-csv "Link to this heading")
...
The `csv` module’s [`reader`](#csv.reader "csv.reader") and [`writer`](#csv.writer "csv.writer") objects read and
...
csv.reader(*csvfile*, */*, *dialect='excel'*, *\*\*fmtparams*)[¶](#csv.reader "Link to this definition")
...
csv.writer(*csvfile*, */*, *dialect='excel'*, *\*\*fmtparams*)[¶](#csv.writer "Link to this definition")
...
csv.register\_dialect(*name*, */*, *dialect='excel'*, *\*\*fmtparams*)[¶](#csv.register_dialect "Link to this definition")
...
csv.unregister\_dialect(*name*)[¶](#csv.unregister_dialect "Link to this definition")
:   Delete the dialect associated with *name* from the dialect registry. An
    [`Error`](#csv.Error "csv.Error") is raised if *name* is not a registered dialect name.

csv.get\_dialect(*name*)[¶](#csv.get_dialect "Link to this definition")
...
*class* csv.DictReader(*f*, *fieldnames=None*, *restkey=None*, *restval=None*, *dialect='excel'*, *\*args*, *\*\*kwds*)[¶](#csv.DictReader "Link to this definition")
...
*class* csv.DictWriter(*f*, *fieldnames*, *restval=''*, *extrasaction='raise'*, *dialect='excel'*, *\*args*, *\*\*kwds*)[¶](#csv.DictWriter "Link to this definition")
...
*class* csv.Dialect[¶](#csv.Dialect "Link to this definition")
:   The [`Dialect`](#csv.Dialect "csv.Dialect") class is a container class whose attributes contain
    ...
    All available [`Dialect`](#csv.Dialect "csv.Dialect") names are returned by [`list_dialects()`](#csv.list_dialects "csv.list_dialects"),
...
*class* csv.excel[¶](#csv.excel "Link to this definition")
...
*class* csv.excel\_tab[¶](#csv.excel_tab "Link to this definition")
...
*class* csv.unix\_dialect[¶](#csv.unix_dialect "Link to this definition")
...
*class* csv.Sniffer[¶](#csv.Sniffer "Link to this definition")
:   The [`Sniffer`](#csv.Sniffer "csv.Sniffer") class is used to deduce the format of a CSV file.
    ...
    sniff(*sample*, *delimiters=None*)[¶](#csv.Sniffer.sniff "Link to this definition")
    :   Analyze the given *sample* and return a [`Dialect`](#csv.Dialect "csv.Dialect") subclass
        reflecting the parameters found. If the optional *delimiters* parameter
        is given, it is interpreted as a string containing possible valid
        delimiter characters.

    has\_header(*sample*)[¶](#csv.Sniffer.has_header "Link to this definition")
    :   Analyze the sample text (presumed to be in CSV format) and return
        ...
        * the second through n-th rows contain strings where at least one value’s
        ...
        columns + rows meet the criteria, [`True`](constants.html#True "True") is returned.
...
:   Instructs [`writer`](#csv.writer "csv.writer") objects to quote all non-numeric fields.
    ...
    Some numeric types, such as [`bool`](functions.html#bool "bool"), [`Fraction`](fractions.html#fractions.Fraction "fractions.Fraction"),
    or [`IntEnum`](enum.html#enum.IntEnum "enum.IntEnum"), have a string representation that cannot be
    converted to [`float`](functions.html#float "float").
    They cannot be read in the [`QUOTE_NONNUMERIC`](#csv.QUOTE_NONNUMERIC "csv.QUOTE_NONNUMERIC") and
    [`QUOTE_STRINGS`](#csv.QUOTE_STRINGS "csv.QUOTE_STRINGS") modes.
...
*exception* csv.Error[¶](#csv.Error "Link to this definition")
:   Raised by any of the functions when an error is detected.

## Dialects and Formatting Parameters[¶](#dialects-and-formatting-parameters "Link to this heading")
...
:   The string used to terminate lines produced by the [`writer`](#csv.writer "csv.writer"). It defaults
    ...
    The [`reader`](#csv.reader "csv.reader") is hard-coded to recognise either `'\r'` or `'\n'` as
...
:   When [`True`](constants.html#True "True"), spaces immediately following the *delimiter* are ignored.
    The default is [`False`](constants.html#False "False"). When combining `delimiter=' '` with
...
## Reader Objects[¶](#reader-objects "Link to this heading")
...
## Writer Objects[¶](#writer-objects "Link to this heading")
...
csvwriter.writerow(*row*, */*)[¶](#csv.csvwriter.writerow "Link to this definition")
...
csvwriter.writerows(*rows*, */*)[¶](#csv.csvwriter.writerows "Link to this definition")
...
DictWriter.writeheader()[¶](#csv.DictWriter.writeheader "Link to this definition")
:   Write a row with the field names (as specified in the constructor) to
    ...
    Changed in version 3.8: [`writeheader()`](#csv.DictWriter.writeheader "csv.DictWriter.writeheader") now also returns the value returned by
    the [`csvwriter.writerow()`](#csv.csvwriter.writerow "csv.csvwriter.writerow") method it uses internally.
