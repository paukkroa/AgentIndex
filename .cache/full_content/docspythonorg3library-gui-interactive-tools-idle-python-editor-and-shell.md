...
* [next](turtle.html "turtle — Turtle graphics") |
...
# IDLE — Python editor and shell[¶](#idle "Link to this heading")

**Source code:** [Lib/idlelib/](https://github.com/python/cpython/tree/3.14/Lib/idlelib/)
...
The IDLE application is implemented in the [`idlelib`](#module-idlelib "idlelib: Implementation package for the IDLE shell/editor.") package.
...
## Menus[¶](#menus "Link to this heading")
...
### File menu (Shell and Editor)[¶](#file-menu-shell-and-editor "Link to this heading")
...
### Edit menu (Shell and Editor)[¶](#edit-menu-shell-and-editor "Link to this heading")
...
### Format menu (Editor window only)[¶](#format-menu-editor-window-only "Link to this heading")
...
:   Remove trailing space and other whitespace characters after the last
    non-whitespace character of a line by applying [`str.rstrip()`](stdtypes.html#str.rstrip "str.rstrip") to each line,
    including lines within multiline strings. Except for Shell windows,
    remove extra newlines at the end of the file.

### Run menu (Editor window only)[¶](#run-menu-editor-window-only "Link to this heading")
...
:   Same as [Run Module](#run-module), but run the module with customized
    settings. *Command Line Arguments* extend [`sys.argv`](sys.html#sys.argv "sys.argv") as if passed
...
### Shell menu (Shell window only)[¶](#shell-menu-shell-window-only "Link to this heading")
...
### Debug menu (Shell window only)[¶](#debug-menu-shell-window-only "Link to this heading")
...
### Options menu (Shell and Editor)[¶](#options-menu-shell-and-editor "Link to this heading")
...
### Window menu (Shell and Editor)[¶](#window-menu-shell-and-editor "Link to this heading")

Lists the names of all open windows; select one to bring it to the foreground
(deiconifying it if necessary).

### Help menu (Shell and Editor)[¶](#help-menu-shell-and-editor "Link to this heading")
...
### Context menus[¶](#context-menus "Link to this heading")
...
## Editing and Navigation[¶](#editing-and-navigation "Link to this heading")

### Editor windows[¶](#editor-windows "Link to this heading")
...
### Key bindings[¶](#key-bindings "Link to this heading")
...
### Automatic indentation[¶](#automatic-indentation "Link to this heading")
...
### Search and Replace[¶](#search-and-replace "Link to this heading")
...
### Calltips[¶](#calltips "Link to this heading")
...
### Format block[¶](#format-block "Link to this heading")
...
### Code Context[¶](#code-context "Link to this heading")
...
### Shell window[¶](#shell-window "Link to this heading")
...
### Text colors[¶](#text-colors "Link to this heading")
...
## Startup and Code Execution[¶](#startup-and-code-execution "Link to this heading")
...
### Startup failure[¶](#startup-failure "Link to this heading")
...
### Running user code[¶](#running-user-code "Link to this heading")
...
### User output in Shell[¶](#user-output-in-shell "Link to this heading")
...
### Developing tkinter applications[¶](#developing-tkinter-applications "Link to this heading")
...
### Running without a subprocess[¶](#running-without-a-subprocess "Link to this heading")
...
## Help and Preferences[¶](#help-and-preferences "Link to this heading")

### Help sources[¶](#help-sources "Link to this heading")
...
### Setting preferences[¶](#setting-preferences "Link to this heading")
...
### IDLE on macOS[¶](#idle-on-macos "Link to this heading")
...
## idlelib — implementation of IDLE application[¶](#module-idlelib "Link to this heading")
...
* [IDLE — Python editor and shell](#)
  ...
  + [Startup and Code Execution](#startup-and-code-execution)
    ...
    - [User output in Shell](#user-output-in-shell)
  ...
  + [idlelib — implementation of IDLE application](#module-idlelib)
...
[`turtle` — Turtle graphics](turtle.html "next chapter")

### This page

* [Report a bug](../bugs.html)
* [Improve this page](../improve-page-nojs.html)
* [Show source](https://github.com/python/cpython/blob/main/Doc/library/idle.rst?plain=1)
