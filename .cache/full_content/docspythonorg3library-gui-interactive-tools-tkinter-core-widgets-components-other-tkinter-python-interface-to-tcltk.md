...
* [next](tkinter.colorchooser.html "tkinter.colorchooser — Color choosing dialog") |
* [previous](tk.html "Graphical user interfaces with Tk") |
...
# `tkinter` — Python interface to Tcl/Tk[¶](#module-tkinter "Link to this heading")
...
## Tkinter Modules[¶](#tkinter-modules "Link to this heading")
...
*class* tkinter.Tk(*screenName=None*, *baseName=None*, *className='Tk'*, *useTk=True*, *sync=False*, *use=None*)[¶](#tkinter.Tk "Link to this definition")
:   Construct a toplevel Tk widget, which is usually the main window of an
    ...
    The [`Tk`](#tkinter.Tk "tkinter.Tk") class is typically instantiated using all default values.
    ...
    *use*
    ...
    [`Tk`](#tkinter.Tk "tkinter.Tk") reads and interprets profile files, named
    ...
    :   The Tk application object created by instantiating [`Tk`](#tkinter.Tk "tkinter.Tk"). This
        provides access to the Tcl interpreter. Each widget that is attached
        the same instance of [`Tk`](#tkinter.Tk "tkinter.Tk") has the same value for its [`tk`](#tkinter.Tk.tk "tkinter.Tk.tk")
        attribute.

    master[¶](#tkinter.Tk.master "Link to this definition")
    :   The widget object that contains this widget. For [`Tk`](#tkinter.Tk "tkinter.Tk"), the
        `master` is [`None`](constants.html#None "None") because it is the main window. The terms
...
tkinter.Tcl(*screenName=None*, *baseName=None*, *className='Tk'*, *useTk=False*)[¶](#tkinter.Tcl "Link to this definition")
:   The [`Tcl()`](#tkinter.Tcl "tkinter.Tcl") function is a factory function which creates an object much like
    that created by the [`Tk`](#tkinter.Tk "tkinter.Tk") class, except that it does not initialize the Tk
    ...
    created by the [`Tcl()`](#tkinter.Tcl "tkinter.Tcl") object can have a Toplevel window created (and the Tk
...
## Tkinter Life Preserver[¶](#tkinter-life-preserver "Link to this heading")
...
### A Hello World Program[¶](#a-hello-world-program "Link to this heading")
...
### Important Tk Concepts[¶](#important-tk-concepts "Link to this heading")
...
### Understanding How Tkinter Wraps Tcl/Tk[¶](#understanding-how-tkinter-wraps-tcl-tk "Link to this heading")
...
### How do I…? What option does…?[¶](#how-do-i-what-option-does "Link to this heading")
...
### Navigating the Tcl/Tk Reference Manual[¶](#navigating-the-tcl-tk-reference-manual "Link to this heading")
...
## Threading model[¶](#threading-model "Link to this heading")
...
## Handy Reference[¶](#handy-reference "Link to this heading")

### Setting Options[¶](#setting-options "Link to this heading")
...
### The Packer[¶](#the-packer "Link to this heading")
...
### Packer Options[¶](#packer-options "Link to this heading")
...
### Coupling Widget Variables[¶](#coupling-widget-variables "Link to this heading")
...
### The Window Manager[¶](#the-window-manager "Link to this heading")
...
### Tk Option Data Types[¶](#tk-option-data-types "Link to this heading")
...
### Bindings and Events[¶](#bindings-and-events "Link to this heading")
...
### Images[¶](#images "Link to this heading")
...
Widget.tk.createfilehandler(*file*, *mask*, *func*)[¶](#tkinter.Widget.tk.createfilehandler "Link to this definition")
...
Widget.tk.deletefilehandler(*file*)[¶](#tkinter.Widget.tk.deletefilehandler "Link to this definition")
:   Unregisters a file handler.

\_tkinter.READABLE[¶](#tkinter.READABLE "Link to this definition")

\_tkinter.WRITABLE[¶](#tkinter.WRITABLE "Link to this definition")

\_tkinter.EXCEPTION[¶](#tkinter.EXCEPTION "Link to this definition")
...
* [`tkinter` — Python interface to Tcl/Tk](#)
  ...
  + [Tkinter Life Preserver](#tkinter-life-preserver)
    - [A Hello World Program](#a-hello-world-program)
    - [Important Tk Concepts](#important-tk-concepts)
    - [Understanding How Tkinter Wraps Tcl/Tk](#understanding-how-tkinter-wraps-tcl-tk)
    - [How do I…? What option does…?](#how-do-i-what-option-does)
    - [Navigating the Tcl/Tk Reference Manual](#navigating-the-tcl-tk-reference-manual)
  + [Threading model](#threading-model)
  + [Handy Reference](#handy-reference)
    - [Setting Options](#setting-options)
    - [The Packer](#the-packer)
    - [Packer Options](#packer-options)
    - [Coupling Widget Variables](#coupling-widget-variables)
    - [The Window Manager](#the-window-manager)
    - [Tk Option Data Types](#tk-option-data-types)
    - [Bindings and Events](#bindings-and-events)
...
[Graphical user interfaces with Tk](tk.html "previous chapter")

#### Next topic

[`tkinter.colorchooser` — Color choosing dialog](tkinter.colorchooser.html "next chapter")

### This page

* [Report a bug](../bugs.html)
* [Improve this page](../improve-page-nojs.html)
* [Show source](https://github.com/python/cpython/blob/main/Doc/library/tkinter.rst?plain=1)
