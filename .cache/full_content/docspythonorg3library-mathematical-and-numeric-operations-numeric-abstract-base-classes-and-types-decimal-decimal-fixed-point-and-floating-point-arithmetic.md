...
* [next](fractions.html "fractions — Rational numbers") |
* [previous](cmath.html "cmath — Mathematical functions for complex numbers") |
...
# `decimal` — Decimal fixed-point and floating-point arithmetic[¶](#module-decimal "Link to this heading")

**Source code:** [Lib/decimal.py](https://github.com/python/cpython/tree/3.14/Lib/decimal.py)
...
## Quick-start tutorial[¶](#quick-start-tutorial "Link to this heading")
...
Decimals can be formatted (with [`format()`](functions.html#format "format") built-in or [f-strings](../reference/lexical_analysis.html#f-strings)) in
fixed-point or scientific notation, using the same formatting syntax (see
[Format Specification Mini-Language](string.html#formatspec)) as builtin [`float`](functions.html#float "float") type:
...
[`Context()`](#decimal.Context "decimal.Context") constructor. To make an alternate active, use the [`setcontext()`](#decimal.setcontext "decimal.setcontext")
function.
...
## Decimal objects[¶](#decimal-objects "Link to this heading")

*class* decimal.Decimal(*value='0'*, *context=None*)[¶](#decimal.Decimal "Link to this definition")
:   Construct a new [`Decimal`](#decimal.Decimal "decimal.Decimal") object based from *value*.
    ...
    *value* can be an integer, string, tuple, [`float`](functions.html#float "float"), or another [`Decimal`](#decimal.Decimal "decimal.Decimal")
    ...
    Changed in version 3.2: The argument to the constructor is now permitted to be a [`float`](functions.html#float "float")
    instance.
    ...
    *dividend* rather than the sign of the divisor:
    ...
    Changed in version 3.2: Mixed-type comparisons between [`Decimal`](#decimal.Decimal "decimal.Decimal") instances and other
    ...
    compare(*other*, *context=None*)[¶](#decimal.Decimal.compare "Link to this definition")
    ...
    compare\_signal(*other*, *context=None*)[¶](#decimal.Decimal.compare_signal "Link to this definition")
    ...
    compare\_total(*other*, *context=None*)[¶](#decimal.Decimal.compare_total "Link to this definition")
    ...
    compare\_total\_mag(*other*, *context=None*)[¶](#decimal.Decimal.compare_total_mag "Link to this definition")
    :   Compare two operands using their abstract representation rather than their
    ...
    copy\_sign(*other*, *context=None*)[¶](#decimal.Decimal.copy_sign "Link to this definition")
    ...
    exp(*context=None*)[¶](#decimal.Decimal.exp "Link to this definition")
    ...
    *classmethod* from\_float(*f*, */*)[¶](#decimal.Decimal.from_float "Link to this definition")
    ...
    *classmethod* from\_number(*number*, */*)[¶](#decimal.Decimal.from_number "Link to this definition")
    :   Alternative constructor that only accepts instances of
        [`float`](functions.html#float "float"), [`int`](functions.html#int "int") or [`Decimal`](#decimal.Decimal "decimal.Decimal"), but not strings
        or tuples.
    ...
    fma(*other*, *third*, *context=None*)[¶](#decimal.Decimal.fma "Link to this definition")
    ...
    is\_normal(*context=None*)[¶](#decimal.Decimal.is_normal "Link to this definition")
    ...
    is\_subnormal(*context=None*)[¶](#decimal.Decimal.is_subnormal "Link to this definition")
    ...
    logical\_and(*other*, *context=None*)[¶](#decimal.Decimal.logical_and "Link to this definition")
    ...
    logical\_invert(*context=None*)[¶](#decimal.Decimal.logical_invert "Link to this definition")
    :   [`logical_invert()`](#decimal.Decimal.logical_invert "decimal.Decimal.logical_invert") is a logical operation. The
        result is the digit-wise inversion of the operand.

    logical\_or(*other*, *context=None*)[¶](#decimal.Decimal.logical_or "Link to this definition")
    :   [`logical_or()`](#decimal.Decimal.logical_or "decimal.Decimal.logical_or") is a logical operation which takes two *logical
        operands* (see [Logical operands](#logical-operands-label)). The result is the
        digit-wise `or` of the two operands.

    logical\_xor(*other*, *context=None*)[¶](#decimal.Decimal.logical_xor "Link to this definition")
    ...
    max(*other*, *context=None*)[¶](#decimal.Decimal.max "Link to this definition")
    :   Like `max(self, other)` except that the context rounding rule is applied
        before returning and that `NaN` values are either signaled or
        ignored (depending on the context and whether they are signaling or
        quiet).

    max\_mag(*other*, *context=None*)[¶](#decimal.Decimal.max_mag "Link to this definition")
    :   Similar to the [`max()`](#decimal.Decimal.max "decimal.Decimal.max") method, but the comparison is done using the
        absolute values of the operands.

    min(*other*, *context=None*)[¶](#decimal.Decimal.min "Link to this definition")
    :   Like `min(self, other)` except that the context rounding rule is applied
        before returning and that `NaN` values are either signaled or
        ignored (depending on the context and whether they are signaling or
        quiet).

    min\_mag(*other*, *context=None*)[¶](#decimal.Decimal.min_mag "Link to this definition")
    :   Similar to the [`min()`](#decimal.Decimal.min "decimal.Decimal.min") method, but the comparison is done using the
        absolute values of the operands.

    next\_minus(*context=None*)[¶](#decimal.Decimal.next_minus "Link to this definition")
    :   Return the largest number representable in the given context (or in the
        current thread’s context if no context is given) that is smaller than the
        given operand.

    next\_plus(*context=None*)[¶](#decimal.Decimal.next_plus "Link to this definition")
    :   Return the smallest number representable in the given context (or in the
        current thread’s context if no context is given) that is larger than the
        given operand.

    next\_toward(*other*, *context=None*)[¶](#decimal.Decimal.next_toward "Link to this definition")
    :   If the two operands are unequal, return the number closest to the first
        operand in the direction of the second operand. If both operands are
        numerically equal, return a copy of the first operand with the sign set to
        be the same as the sign of the second operand.

    normalize(*context=None*)[¶](#decimal.Decimal.normalize "Link to this definition")
    ...
    number\_class(*context=None*)[¶](#decimal.Decimal.number_class "Link to this definition")
    ...
    quantize(*exp*, *rounding=None*, *context=None*)[¶](#decimal.Decimal.quantize "Link to this definition")
    ...
    remainder\_near(*other*, *context=None*)[¶](#decimal.Decimal.remainder_near "Link to this definition")
    ...
    rotate(*other*, *context=None*)[¶](#decimal.Decimal.rotate "Link to this definition")
    ...
    same\_quantum(*other*, *context=None*)[¶](#decimal.Decimal.same_quantum "Link to this definition")
    ...
    scaleb(*other*, *context=None*)[¶](#decimal.Decimal.scaleb "Link to this definition")
    :   Return the first operand with exponent adjusted by the second.
        Equivalently, return the first operand multiplied by `10**other`. The
        second operand must be an integer.

    shift(*other*, *context=None*)[¶](#decimal.Decimal.shift "Link to this definition")
    ...
    sqrt(*context=None*)[¶](#decimal.Decimal.sqrt "Link to this definition")
    :   Return the square root of the argument to full precision.

    to\_eng\_string(*context=None*)[¶](#decimal.Decimal.to_eng_string "Link to this definition")
    ...
    to\_integral(*rounding=None*, *context=None*)[¶](#decimal.Decimal.to_integral "Link to this definition")
    ...
    to\_integral\_exact(*rounding=None*, *context=None*)[¶](#decimal.Decimal.to_integral_exact "Link to this definition")
    ...
    to\_integral\_value(*rounding=None*, *context=None*)[¶](#decimal.Decimal.to_integral_value "Link to this definition")
...
### Logical operands[¶](#logical-operands "Link to this heading")

The [`logical_and()`](#decimal.Decimal.logical_and "decimal.Decimal.logical_and"), [`logical_invert()`](#decimal.Decimal.logical_invert "decimal.Decimal.logical_invert"), [`logical_or()`](#decimal.Decimal.logical_or "decimal.Decimal.logical_or"),
and [`logical_xor()`](#decimal.Decimal.logical_xor "decimal.Decimal.logical_xor") methods expect their arguments to be *logical
operands*. A *logical operand* is a [`Decimal`](#decimal.Decimal "decimal.Decimal") instance whose
exponent and sign are both zero, and whose digits are all either
`0` or `1`.

## Context objects[¶](#context-objects "Link to this heading")
...
decimal.setcontext(*c*, */*)[¶](#decimal.setcontext "Link to this definition")
...
decimal.localcontext(*ctx=None*, *\*\*kwargs*)[¶](#decimal.localcontext "Link to this definition")
...
decimal.IEEEContext(*bits*)[¶](#decimal.IEEEContext "Link to this definition")
:   Return a context object initialized to the proper values for one of the
    IEEE interchange formats. The argument must be a multiple of 32 and less
    than [`IEEE_CONTEXT_MAX_BITS`](#decimal.IEEE_CONTEXT_MAX_BITS "decimal.IEEE_CONTEXT_MAX_BITS").
...
*class* decimal.Context(*prec=None*, *rounding=None*, *Emin=None*, *Emax=None*, *capitals=None*, *clamp=None*, *flags=None*, *traps=None*)[¶](#decimal.Context "Link to this definition")
:   Creates a new context. If a field is not specified or is [`None`](constants.html#None "None"), the
    ...
    copy\_decimal(*num*, */*)[¶](#decimal.Context.copy_decimal "Link to this definition")
    :   Return a copy of the Decimal instance num.

    create\_decimal(*num='0'*, */*)[¶](#decimal.Context.create_decimal "Link to this definition")
    ...
    create\_decimal\_from\_float(*f*, */*)[¶](#decimal.Context.create_decimal_from_float "Link to this definition")
    ...
    abs(*x*, */*)[¶](#decimal.Context.abs "Link to this definition")
    :   Returns the absolute value of *x*.

    add(*x*, *y*, */*)[¶](#decimal.Context.add "Link to this definition")
    :   Return the sum of *x* and *y*.

    canonical(*x*, */*)[¶](#decimal.Context.canonical "Link to this definition")
    :   Returns the same Decimal object *x*.

    compare(*x*, *y*, */*)[¶](#decimal.Context.compare "Link to this definition")
    :   Compares *x* and *y* numerically.

    compare\_signal(*x*, *y*, */*)[¶](#decimal.Context.compare_signal "Link to this definition")
    :   Compares the values of the two operands numerically.

    compare\_total(*x*, *y*, */*)[¶](#decimal.Context.compare_total "Link to this definition")
    :   Compares two operands using their abstract representation.

    compare\_total\_mag(*x*, *y*, */*)[¶](#decimal.Context.compare_total_mag "Link to this definition")
    :   Compares two operands using their abstract representation, ignoring sign.

    copy\_abs(*x*, */*)[¶](#decimal.Context.copy_abs "Link to this definition")
    :   Returns a copy of *x* with the sign set to 0.

    copy\_negate(*x*, */*)[¶](#decimal.Context.copy_negate "Link to this definition")
    :   Returns a copy of *x* with the sign inverted.

    copy\_sign(*x*, *y*, */*)[¶](#decimal.Context.copy_sign "Link to this definition")
    :   Copies the sign from *y* to *x*.

    divide(*x*, *y*, */*)[¶](#decimal.Context.divide "Link to this definition")
    :   Return *x* divided by *y*.

    divide\_int(*x*, *y*, */*)[¶](#decimal.Context.divide_int "Link to this definition")
    :   Return *x* divided by *y*, truncated to an integer.

    divmod(*x*, *y*, */*)[¶](#decimal.Context.divmod "Link to this definition")
    :   Divides two numbers and returns the integer part of the result.

    exp(*x*, */*)[¶](#decimal.Context.exp "Link to this definition")
    :   Returns `e ** x`.

    fma(*x*, *y*, *z*, */*)[¶](#decimal.Context.fma "Link to this definition")
    :   Returns *x* multiplied by *y*, plus *z*.

    is\_canonical(*x*, */*)[¶](#decimal.Context.is_canonical "Link to this definition")
    :   Returns `True` if *x* is canonical; otherwise returns `False`.

    is\_finite(*x*, */*)[¶](#decimal.Context.is_finite "Link to this definition")
    :   Returns `True` if *x* is finite; otherwise returns `False`.

    is\_infinite(*x*, */*)[¶](#decimal.Context.is_infinite "Link to this definition")
    :   Returns `True` if *x* is infinite; otherwise returns `False`.

    is\_nan(*x*, */*)[¶](#decimal.Context.is_nan "Link to this definition")
    :   Returns `True` if *x* is a qNaN or sNaN; otherwise returns `False`.

    is\_normal(*x*, */*)[¶](#decimal.Context.is_normal "Link to this definition")
    :   Returns `True` if *x* is a normal number; otherwise returns `False`.

    is\_qnan(*x*, */*)[¶](#decimal.Context.is_qnan "Link to this definition")
    :   Returns `True` if *x* is a quiet NaN; otherwise returns `False`.

    is\_signed(*x*, */*)[¶](#decimal.Context.is_signed "Link to this definition")
    :   Returns `True` if *x* is negative; otherwise returns `False`.

    is\_snan(*x*, */*)[¶](#decimal.Context.is_snan "Link to this definition")
    :   Returns `True` if *x* is a signaling NaN; otherwise returns `False`.

    is\_subnormal(*x*, */*)[¶](#decimal.Context.is_subnormal "Link to this definition")
    :   Returns `True` if *x* is subnormal; otherwise returns `False`.

    is\_zero(*x*, */*)[¶](#decimal.Context.is_zero "Link to this definition")
    :   Returns `True` if *x* is a zero; otherwise returns `False`.

    ln(*x*, */*)[¶](#decimal.Context.ln "Link to this definition")
    :   Returns the natural (base e) logarithm of *x*.

    log10(*x*, */*)[¶](#decimal.Context.log10 "Link to this definition")
    :   Returns the base 10 logarithm of *x*.

    logb(*x*, */*)[¶](#decimal.Context.logb "Link to this definition")
    :   Returns the exponent of the magnitude of the operand’s MSD.

    logical\_and(*x*, *y*, */*)[¶](#decimal.Context.logical_and "Link to this definition")
    :   Applies the logical operation *and* between each operand’s digits.

    logical\_invert(*x*, */*)[¶](#decimal.Context.logical_invert "Link to this definition")
    :   Invert all the digits in *x*.

    logical\_or(*x*, *y*, */*)[¶](#decimal.Context.logical_or "Link to this definition")
    :   Applies the logical operation *or* between each operand’s digits.

    logical\_xor(*x*, *y*, */*)[¶](#decimal.Context.logical_xor "Link to this definition")
    :   Applies the logical operation *xor* between each operand’s digits.

    max(*x*, *y*, */*)[¶](#decimal.Context.max "Link to this definition")
    :   Compares two values numerically and returns the maximum.

    max\_mag(*x*, *y*, */*)[¶](#decimal.Context.max_mag "Link to this definition")
    :   Compares the values numerically with their sign ignored.

    min(*x*, *y*, */*)[¶](#decimal.Context.min "Link to this definition")
    :   Compares two values numerically and returns the minimum.

    min\_mag(*x*, *y*, */*)[¶](#decimal.Context.min_mag "Link to this definition")
    :   Compares the values numerically with their sign ignored.

    minus(*x*, */*)[¶](#decimal.Context.minus "Link to this definition")
    :   Minus corresponds to the unary prefix minus operator in Python.

    multiply(*x*, *y*, */*)[¶](#decimal.Context.multiply "Link to this definition")
    :   Return the product of *x* and *y*.

    next\_minus(*x*, */*)[¶](#decimal.Context.next_minus "Link to this definition")
    :   Returns the largest representable number smaller than *x*.

    next\_plus(*x*, */*)[¶](#decimal.Context.next_plus "Link to this definition")
    :   Returns the smallest representable number larger than *x*.

    next\_toward(*x*, *y*, */*)[¶](#decimal.Context.next_toward "Link to this definition")
    :   Returns the number closest to *x*, in direction towards *y*.

    normalize(*x*, */*)[¶](#decimal.Context.normalize "Link to this definition")
    :   Reduces *x* to its simplest form.

    number\_class(*x*, */*)[¶](#decimal.Context.number_class "Link to this definition")
    :   Returns an indication of the class of *x*.

    plus(*x*, */*)[¶](#decimal.Context.plus "Link to this definition")
    :   Plus corresponds to the unary prefix plus operator in Python. This
        operation applies the context precision and rounding, so it is *not* an
        identity operation.

    power(*x*, *y*, *modulo=None*)[¶](#decimal.Context.power "Link to this definition")
    ...
    quantize(*x*, *y*, */*)[¶](#decimal.Context.quantize "Link to this definition")
    :   Returns a value equal to *x* (rounded), having the exponent of *y*.

    radix()[¶](#decimal.Context.radix "Link to this definition")
    :   Just returns 10, as this is Decimal, :)

    remainder(*x*, *y*, */*)[¶](#decimal.Context.remainder "Link to this definition")
    :   Returns the remainder from integer division.

        The sign of the result, if non-zero, is the same as that of the original
        dividend.

    remainder\_near(*x*, *y*, */*)[¶](#decimal.Context.remainder_near "Link to this definition")
    :   Returns `x - y * n`, where *n* is the integer nearest the exact value
        of `x / y` (if the result is 0 then its sign will be the sign of *x*).

    rotate(*x*, *y*, */*)[¶](#decimal.Context.rotate "Link to this definition")
    :   Returns a rotated copy of *x*, *y* times.

    same\_quantum(*x*, *y*, */*)[¶](#decimal.Context.same_quantum "Link to this definition")
    :   Returns `True` if the two operands have the same exponent.

    scaleb(*x*, *y*, */*)[¶](#decimal.Context.scaleb "Link to this definition")
    :   Returns the first operand after adding the second value its exp.

    shift(*x*, *y*, */*)[¶](#decimal.Context.shift "Link to this definition")
    :   Returns a shifted copy of *x*, *y* times.

    sqrt(*x*, */*)[¶](#decimal.Context.sqrt "Link to this definition")
    :   Square root of a non-negative number to context precision.

    subtract(*x*, *y*, */*)[¶](#decimal.Context.subtract "Link to this definition")
    :   Return the difference between *x* and *y*.

    to\_eng\_string(*x*, */*)[¶](#decimal.Context.to_eng_string "Link to this definition")
    :   Convert to a string, using engineering notation if an exponent is needed.
    ...
    to\_integral\_exact(*x*, */*)[¶](#decimal.Context.to_integral_exact "Link to this definition")
    :   Rounds to an integer.

    to\_sci\_string(*x*, */*)[¶](#decimal.Context.to_sci_string "Link to this definition")
...
|  | 32-bit | 64-bit |
| --- | --- | --- |
| decimal.MAX\_PREC[¶](#decimal.MAX_PREC "Link to this definition") | `425000000` | `999999999999999999` |
| decimal.MAX\_EMAX[¶](#decimal.MAX_EMAX "Link to this definition") | `425000000` | `999999999999999999` |
| decimal.MIN\_EMIN[¶](#decimal.MIN_EMIN "Link to this definition") | `-425000000` | `-999999999999999999` |
| decimal.MIN\_ETINY[¶](#decimal.MIN_ETINY "Link to this definition") | `-849999999` | `-1999999999999999997` |
| decimal.IEEE\_CONTEXT\_MAX\_BITS[¶](#decimal.IEEE_CONTEXT_MAX_BITS "Link to this definition") | `256` | `512` |
...
## Rounding modes[¶](#rounding-modes "Link to this heading")
...
*class* decimal.Clamped[¶](#decimal.Clamped "Link to this definition")
...
*class* decimal.DecimalException[¶](#decimal.DecimalException "Link to this definition")
:   Base class for other signals and a subclass of [`ArithmeticError`](exceptions.html#ArithmeticError "ArithmeticError").

*class* decimal.DivisionByZero[¶](#decimal.DivisionByZero "Link to this definition")
...
*class* decimal.Inexact[¶](#decimal.Inexact "Link to this definition")
...
*class* decimal.InvalidOperation[¶](#decimal.InvalidOperation "Link to this definition")
...
*class* decimal.Overflow[¶](#decimal.Overflow "Link to this definition")
:   Numerical overflow.

    Indicates the exponent is larger than [`Context.Emax`](#decimal.Context.Emax "decimal.Context.Emax") after rounding has
...
*class* decimal.Rounded[¶](#decimal.Rounded "Link to this definition")
...
*class* decimal.Subnormal[¶](#decimal.Subnormal "Link to this definition")
:   Exponent was lower than [`Emin`](#decimal.Context.Emin "decimal.Context.Emin") prior to rounding.

    Occurs when an operation result is subnormal (the exponent is too small). If
    not trapped, returns the result unchanged.

*class* decimal.Underflow[¶](#decimal.Underflow "Link to this definition")
...
*class* decimal.FloatOperation[¶](#decimal.FloatOperation "Link to this definition")
...
## Floating-point notes[¶](#floating-point-notes "Link to this heading")

### Mitigating round-off error with increased precision[¶](#mitigating-round-off-error-with-increased-precision "Link to this heading")
...
## Working with threads[¶](#working-with-threads "Link to this heading")
...
[`decimal.DefaultContext`](#decimal.DefaultContext "decimal.DefaultContext") object.

The [`sys.flags.thread_inherit_context`](sys.html#sys.flags.thread_inherit_context "sys.flags.thread_inherit_context") flag affects the context for
new threads. If the flag is false, new threads will start with an empty
context. In this case, [`getcontext()`](#decimal.getcontext "decimal.getcontext") will create a new context object
...
[`threading.Thread.start()`](threading.html#threading.Thread.start "threading.Thread.start").
...
between threads calling [`getcontext()`](#decimal.getcontext "decimal.getcontext"). For example:
...
## Decimal FAQ[¶](#decimal-faq "Link to this heading")
...
arbitrary precision correctly rounded decimal floating-point arithmetic [[1]](#id4).
...
value for [`prec`](#decimal.Context.prec "decimal.Context.prec") as well [[2]](#id5):
...
* [`decimal` — Decimal fixed-point and floating-point arithmetic](#)
  ...
  + [Decimal objects](#decimal-objects)
    - [Logical operands](#logical-operands)
  + [Context objects](#context-objects)
  + [Constants](#constants)
  + [Rounding modes](#rounding-modes)
  + [Signals](#signals)
  + [Floating-point notes](#floating-point-notes)
    - [Mitigating round-off error with increased precision](#mitigating-round-off-error-with-increased-precision)
    - [Special values](#special-values)
  + [Working with threads](#working-with-threads)
  + [Recipes](#recipes)
  + [Decimal FAQ](#decimal-faq)

#### Previous topic

[`cmath` — Mathematical functions for complex numbers](cmath.html "previous chapter")

#### Next topic

[`fractions` — Rational numbers](fractions.html "next chapter")

### This page

* [Report a bug](../bugs.html)
* [Improve this page](../improve-page-nojs.html)
* [Show source](https://github.com/python/cpython/blob/main/Doc/library/decimal.rst?plain=1)
