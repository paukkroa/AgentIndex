...
* [next](http.client.html "http.client — HTTP protocol client") |
* [previous](urllib.robotparser.html "urllib.robotparser — Parser for robots.txt") |
...
# `http` — HTTP modules[¶](#module-http "Link to this heading")

**Source code:** [Lib/http/\_\_init\_\_.py](https://github.com/python/cpython/tree/3.14/Lib/http/__init__.py)
...
* [`http.client`](http.client.html#module-http.client "http.client: HTTP and HTTPS protocol client (requires sockets).") is a low-level HTTP protocol client; for high-level URL
  opening use [`urllib.request`](urllib.request.html#module-urllib.request "urllib.request: Extensible library for opening URLs.")
* [`http.server`](http.server.html#module-http.server "http.server: HTTP server and request handlers.") contains basic HTTP server classes based on [`socketserver`](socketserver.html#module-socketserver "socketserver: A framework for network servers.")
* [`http.cookies`](http.cookies.html#module-http.cookies "http.cookies: Support for HTTP state management (cookies).") has utilities for implementing state management with cookies
* [`http.cookiejar`](http.cookiejar.html#module-http.cookiejar "http.cookiejar: Classes for automatic handling of HTTP cookies.") provides persistence of cookies

The `http` module also defines the following enums that help you work with http related code:

*class* http.HTTPStatus[¶](#http.HTTPStatus "Link to this definition")
:   Added in version 3.5.

    A subclass of [`enum.IntEnum`](enum.html#enum.IntEnum "enum.IntEnum") that defines a set of HTTP status codes,
...
## HTTP status codes[¶](#http-status-codes "Link to this heading")

Supported,
[IANA-registered status codes](https://www.iana.org/assignments/http-status-codes/http-status-codes.xhtml)
available in [`http.HTTPStatus`](#http.HTTPStatus "http.HTTPStatus") are:
...
in the [`http.client`](http.client.html#module-http.client "http.client: HTTP and HTTPS protocol client (requires sockets).") module in the form of constants. The enum name is
...
## HTTP status category[¶](#http-status-category "Link to this heading")
...
*class* http.HTTPMethod[¶](#http.HTTPMethod "Link to this definition")
:   Added in version 3.11.

    A subclass of [`enum.StrEnum`](enum.html#enum.StrEnum "enum.StrEnum") that defines a set of HTTP methods and descriptions written in English.
...
available in [`http.HTTPMethod`](#http.HTTPMethod "http.HTTPMethod") are:
...
[`urllib.robotparser` — Parser for robots.txt](urllib.robotparser.html "previous chapter")

#### Next topic

[`http.client` — HTTP protocol client](http.client.html "next chapter")

### This page

* [Report a bug](../bugs.html)
* [Improve this page](../improve-page-nojs.html)
* [Show source](https://github.com/python/cpython/blob/main/Doc/library/http.rst?plain=1)
