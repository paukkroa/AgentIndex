...
# `uuid` — UUID objects according to [**RFC 9562**](https://datatracker.ietf.org/doc/html/rfc9562.html)[¶](#module-uuid "Link to this heading")
...
| --- | --- |
| Field | Meaning |
| UUID.time\_low[¶](#uuid.UUID.time_low "Link to this definition") | The first 32 bits of the UUID. Only relevant to version 1. |
| UUID.time\_mid[¶](#uuid.UUID.time_mid "Link to this definition") | The next 16 bits of the UUID. Only relevant to version 1. |
| UUID.time\_hi\_version[¶](#uuid.UUID.time_hi_version "Link to this definition") | The next 16 bits of the UUID. Only relevant to version 1. |
| UUID.clock\_seq\_hi\_variant[¶](#uuid.UUID.clock_seq_hi_variant "Link to this definition") | The next 8 bits of the UUID. Only relevant to versions 1 and 6. |
| UUID.clock\_seq\_low[¶](#uuid.UUID.clock_seq_low "Link to this definition") | The next 8 bits of the UUID. Only relevant to versions 1 and 6. |
| UUID.node[¶](#uuid.UUID.node "Link to this definition") | The last 48 bits of the UUID. Only relevant to version 1. |
| UUID.time[¶](#uuid.UUID.time "Link to this definition") | The 60-bit timestamp as a count of 100-nanosecond intervals since Gregorian epoch (1582-10-15 00:00:00) for versions 1 and 6, or the 48-bit timestamp in milliseconds since Unix epoch (1970-01-01 00:00:00) for version 7. |
| UUID.clock\_seq[¶](#uuid.UUID.clock_seq "Link to this definition") | The 14-bit sequence number. Only relevant to versions 1 and 6. |
...
uuid.uuid6(*node=None*, *clock\_seq=None*)[¶](#uuid.uuid6 "Link to this definition")
...
uuid.uuid8(*a=None*, *b=None*, *c=None*)[¶](#uuid.uuid8 "Link to this definition")
...
* [Show source](https://github.com/python/cpython/blob/main/Doc/library/uuid.rst?plain=1)
