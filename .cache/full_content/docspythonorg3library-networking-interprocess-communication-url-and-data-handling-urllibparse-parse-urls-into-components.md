...
urllib.parse.urlsplit(*urlstring*, *scheme=None*, *allow\_fragments=True*)[¶](#urllib.parse.urlsplit "Link to this definition")
...
urllib.parse.urlparse(*urlstring*, *scheme=None*, *allow\_fragments=True*)[¶](#urllib.parse.urlparse "Link to this definition")
:   This is similar to [`urlsplit()`](#urllib.parse.urlsplit "urllib.parse.urlsplit"), but additionally splits the *path*
    ...
    *params* is inserted at index 3, between *path* and *query*.
    ...
    [`urlsplit()`](#urllib.parse.urlsplit "urllib.parse.urlsplit") should generally be used instead of [`urlparse()`](#urllib.parse.urlparse "urllib.parse.urlparse").
