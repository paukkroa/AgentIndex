...
os.reload\_environ()[¶](#os.reload_environ "Link to this definition")
:   The [`os.environ`](#os.environ "os.environ") and [`os.environb`](#os.environb "os.environb") mappings are a cache of
    ...
    Use `os.reload_environ()` to update [`os.environ`](#os.environ "os.environ") and [`os.environb`](#os.environb "os.environb")
...
os.grantpt(*fd*, */*)[¶](#os.grantpt "Link to this definition")
...
os.posix\_openpt(*oflag*, */*)[¶](#os.posix_openpt "Link to this definition")
...
os.ptsname(*fd*, */*)[¶](#os.ptsname "Link to this definition")
...
os.readinto(*fd*, *buffer*, */*)[¶](#os.readinto "Link to this definition")
...
os.splice(*src*, *dst*, *count*, *offset\_src=None*, *offset\_dst=None*, *flags=0*)[¶](#os.splice "Link to this definition")
...
os.unlockpt(*fd*, */*)[¶](#os.unlockpt "Link to this definition")
...
### Timer File Descriptors[¶](#timer-file-descriptors "Link to this heading")
...
os.timerfd\_create(*clockid*, */*, *\**, *flags=0*)[¶](#os.timerfd_create "Link to this definition")
...
os.timerfd\_settime(*fd*, */*, *\**, *flags=flags*, *initial=0.0*, *interval=0.0*)[¶](#os.timerfd_settime "Link to this definition")
...
os.timerfd\_settime\_ns(*fd*, */*, *\**, *flags=0*, *initial=0*, *interval=0*)[¶](#os.timerfd_settime_ns "Link to this definition")
...
os.timerfd\_gettime(*fd*, */*)[¶](#os.timerfd_gettime "Link to this definition")
...
os.timerfd\_gettime\_ns(*fd*, */*)[¶](#os.timerfd_gettime_ns "Link to this definition")
...
os.TFD\_NONBLOCK[¶](#os.TFD_NONBLOCK "Link to this definition")
...
os.TFD\_CLOEXEC[¶](#os.TFD_CLOEXEC "Link to this definition")
:   A flag for the [`timerfd_create()`](#os.timerfd_create "os.timerfd_create") function,
...
os.TFD\_TIMER\_ABSTIME[¶](#os.TFD_TIMER_ABSTIME "Link to this definition")
...
os.TFD\_TIMER\_CANCEL\_ON\_SET[¶](#os.TFD_TIMER_CANCEL_ON_SET "Link to this definition")
...
:   Wraps the `posix_spawn()` C library API for use from Python.
    ...
    os.POSIX\_SPAWN\_CLOSEFROM[¶](#os.POSIX_SPAWN_CLOSEFROM "Link to this definition")
...
os.SCHED\_DEADLINE[¶](#os.SCHED_DEADLINE "Link to this definition")
...
os.SCHED\_NORMAL[¶](#os.SCHED_NORMAL "Link to this definition")
...
:   Return the number of logical CPUs in the **system**. Returns `None` if
    ...
    [`cpu_count()`](#os.cpu_count "os.cpu_count") returns the override value *n*.
...
os.process\_cpu\_count()[¶](#os.process_cpu_count "Link to this definition")
:   Get the number of logical CPUs usable by the calling thread of the **current
    ...
    [`process_cpu_count()`](#os.process_cpu_count "os.process_cpu_count") returns the override value *n*.
...
* [Show source](https://github.com/python/cpython/blob/main/Doc/library/os.rst?plain=1)
