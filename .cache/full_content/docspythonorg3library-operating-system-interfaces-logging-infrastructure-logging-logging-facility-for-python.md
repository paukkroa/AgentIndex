...
* [previous](time.html "time — Time access and conversions") |
...
*class* logging.LoggerAdapter(*logger*, *extra=None*, *merge\_extra=False*)[¶](#logging.LoggerAdapter "Link to this definition")
:   Returns an instance of [`LoggerAdapter`](#logging.LoggerAdapter "logging.LoggerAdapter") initialized with an
    ...
    the [`LoggerAdapter`](#logging.LoggerAdapter "logging.LoggerAdapter") extra.
...
[`time` — Time access and conversions](time.html "previous chapter")
