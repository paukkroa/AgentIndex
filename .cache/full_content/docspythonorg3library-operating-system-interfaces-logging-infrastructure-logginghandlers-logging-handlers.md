...
* [next](platform.html "platform — Access to underlying platform’s identifying data") |
* [previous](logging.config.html "logging.config — Logging configuration") |
...
# `logging.handlers` — Logging handlers[¶](#module-logging.handlers "Link to this heading")
...
## StreamHandler[¶](#streamhandler "Link to this heading")
...
*class* logging.StreamHandler(*stream=None*)[¶](#logging.StreamHandler "Link to this definition")
:   Returns a new instance of the [`StreamHandler`](#logging.StreamHandler "logging.StreamHandler") class. If *stream* is
    specified, the instance will use it for logging output; otherwise, *sys.stderr*
    will be used.

    emit(*record*)[¶](#logging.StreamHandler.emit "Link to this definition")
    ...
    flush()[¶](#logging.StreamHandler.flush "Link to this definition")
    ...
    setStream(*stream*)[¶](#logging.StreamHandler.setStream "Link to this definition")
    ...
    terminator[¶](#logging.StreamHandler.terminator "Link to this definition")
...
## FileHandler[¶](#filehandler "Link to this heading")
...
*class* logging.FileHandler(*filename*, *mode='a'*, *encoding=None*, *delay=False*, *errors=None*)[¶](#logging.FileHandler "Link to this definition")
:   Returns a new instance of the [`FileHandler`](#logging.FileHandler "logging.FileHandler") class. The specified file is
    ...
    *errors* is specified, it’s used to determine how encoding errors are handled.
    ...
    close()[¶](#logging.FileHandler.close "Link to this definition")
    :   Closes the file.

    emit(*record*)[¶](#logging.FileHandler.emit "Link to this definition")
...
## NullHandler[¶](#nullhandler "Link to this heading")
...
*class* logging.NullHandler[¶](#logging.NullHandler "Link to this definition")
:   Returns a new instance of the [`NullHandler`](#logging.NullHandler "logging.NullHandler") class.

    emit(*record*)[¶](#logging.NullHandler.emit "Link to this definition")
    :   This method does nothing.

    handle(*record*)[¶](#logging.NullHandler.handle "Link to this definition")
    :   This method does nothing.

    createLock()[¶](#logging.NullHandler.createLock "Link to this definition")
...
## WatchedFileHandler[¶](#watchedfilehandler "Link to this heading")

The [`WatchedFileHandler`](#logging.handlers.WatchedFileHandler "logging.handlers.WatchedFileHandler") class, located in the `logging.handlers`
...
*class* logging.handlers.WatchedFileHandler(*filename*, *mode='a'*, *encoding=None*, *delay=False*, *errors=None*)[¶](#logging.handlers.WatchedFileHandler "Link to this definition")
:   Returns a new instance of the [`WatchedFileHandler`](#logging.handlers.WatchedFileHandler "logging.handlers.WatchedFileHandler") class. The specified
    ...
    *errors* is provided, it determines how encoding errors are handled.
    ...
    reopenIfNeeded()[¶](#logging.handlers.WatchedFileHandler.reopenIfNeeded "Link to this definition")
    ...
    emit(*record*)[¶](#logging.handlers.WatchedFileHandler.emit "Link to this definition")
...
## BaseRotatingHandler[¶](#baserotatinghandler "Link to this heading")

The [`BaseRotatingHandler`](#logging.handlers.BaseRotatingHandler "logging.handlers.BaseRotatingHandler") class, located in the `logging.handlers`
...
*class* logging.handlers.BaseRotatingHandler(*filename*, *mode*, *encoding=None*, *delay=False*, *errors=None*)[¶](#logging.handlers.BaseRotatingHandler "Link to this definition")
:   The parameters are as for `FileHandler`. The attributes are:

    namer[¶](#logging.handlers.BaseRotatingHandler.namer "Link to this definition")
    ...
    rotator[¶](#logging.handlers.BaseRotatingHandler.rotator "Link to this definition")
    ...
    rotation\_filename(*default\_name*)[¶](#logging.handlers.BaseRotatingHandler.rotation_filename "Link to this definition")
    ...
    rotate(*source*, *dest*)[¶](#logging.handlers.BaseRotatingHandler.rotate "Link to this definition")
...
## RotatingFileHandler[¶](#rotatingfilehandler "Link to this heading")

The [`RotatingFileHandler`](#logging.handlers.RotatingFileHandler "logging.handlers.RotatingFileHandler") class, located in the `logging.handlers`
module, supports rotation of disk log files.

*class* logging.handlers.RotatingFileHandler(*filename*, *mode='a'*, *maxBytes=0*, *backupCount=0*, *encoding=None*, *delay=False*, *errors=None*)[¶](#logging.handlers.RotatingFileHandler "Link to this definition")
:   Returns a new instance of the [`RotatingFileHandler`](#logging.handlers.RotatingFileHandler "logging.handlers.RotatingFileHandler") class. The specified
    ...
    *maxBytes* or *backupCount* is zero, rollover never occurs, so you generally want
    ...
    doRollover()[¶](#logging.handlers.RotatingFileHandler.doRollover "Link to this definition")
    :   Does a rollover, as described above.

    emit(*record*)[¶](#logging.handlers.RotatingFileHandler.emit "Link to this definition")
    :   Outputs the record to the file, catering for rollover as described
        previously.

    shouldRollover(*record*)[¶](#logging.handlers.RotatingFileHandler.shouldRollover "Link to this definition")
    :   See if the supplied record would cause the file to exceed the configured size limit.

## TimedRotatingFileHandler[¶](#timedrotatingfilehandler "Link to this heading")
...
*class* logging.handlers.TimedRotatingFileHandler(*filename*, *when='h'*, *interval=1*, *backupCount=0*, *encoding=None*, *delay=False*, *utc=False*, *atTime=None*, *errors=None*)[¶](#logging.handlers.TimedRotatingFileHandler "Link to this definition")
:   Returns a new instance of the [`TimedRotatingFileHandler`](#logging.handlers.TimedRotatingFileHandler "logging.handlers.TimedRotatingFileHandler") class. The
    ...
    *interval* isn’t used.
    ...
    doRollover()[¶](#logging.handlers.TimedRotatingFileHandler.doRollover "Link to this definition")
    :   Does a rollover, as described above.

    emit(*record*)[¶](#logging.handlers.TimedRotatingFileHandler.emit "Link to this definition")
    :   Outputs the record to the file, catering for rollover as described above.

    getFilesToDelete()[¶](#logging.handlers.TimedRotatingFileHandler.getFilesToDelete "Link to this definition")
    ...
    shouldRollover(*record*)[¶](#logging.handlers.TimedRotatingFileHandler.shouldRollover "Link to this definition")
    :   See if enough time has passed for a rollover to occur and if it has, compute
        the next rollover time.

## SocketHandler[¶](#sockethandler "Link to this heading")

The [`SocketHandler`](#logging.handlers.SocketHandler "logging.handlers.SocketHandler") class, located in the `logging.handlers` module,
sends logging output to a network socket. The base class uses a TCP socket.

*class* logging.handlers.SocketHandler(*host*, *port*)[¶](#logging.handlers.SocketHandler "Link to this definition")
:   Returns a new instance of the [`SocketHandler`](#logging.handlers.SocketHandler "logging.handlers.SocketHandler") class intended to
    ...
    close()[¶](#logging.handlers.SocketHandler.close "Link to this definition")
    :   Closes the socket.

    emit()[¶](#logging.handlers.SocketHandler.emit "Link to this definition")
    ...
    handleError()[¶](#logging.handlers.SocketHandler.handleError "Link to this definition")
    ...
    makeSocket()[¶](#logging.handlers.SocketHandler.makeSocket "Link to this definition")
    :   This is a factory method which allows subclasses to define the precise
        type of socket they want. The default implementation creates a TCP socket
        ([`socket.SOCK_STREAM`](socket.html#socket.SOCK_STREAM "socket.SOCK_STREAM")).

    makePickle(*record*)[¶](#logging.handlers.SocketHandler.makePickle "Link to this definition")
    ...
    send(*packet*)[¶](#logging.handlers.SocketHandler.send "Link to this definition")
    ...
    createSocket()[¶](#logging.handlers.SocketHandler.createSocket "Link to this definition")
...
## DatagramHandler[¶](#datagramhandler "Link to this heading")

The [`DatagramHandler`](#logging.handlers.DatagramHandler "logging.handlers.DatagramHandler") class, located in the `logging.handlers`
...
*class* logging.handlers.DatagramHandler(*host*, *port*)[¶](#logging.handlers.DatagramHandler "Link to this definition")
:   Returns a new instance of the [`DatagramHandler`](#logging.handlers.DatagramHandler "logging.handlers.DatagramHandler") class intended to
    ...
    emit()[¶](#logging.handlers.DatagramHandler.emit "Link to this definition")
    :   Pickles the record’s attribute dictionary and writes it to the socket in
        binary format. If there is an error with the socket, silently drops the
    ...
    makeSocket()[¶](#logging.handlers.DatagramHandler.makeSocket "Link to this definition")
    ...
    send(*s*)[¶](#logging.handlers.DatagramHandler.send "Link to this definition")
...
## SysLogHandler[¶](#sysloghandler "Link to this heading")

The [`SysLogHandler`](#logging.handlers.SysLogHandler "logging.handlers.SysLogHandler") class, located in the `logging.handlers` module,
supports sending logging messages to a remote or local Unix syslog.

*class* logging.handlers.SysLogHandler(*address=('localhost', SYSLOG\_UDP\_PORT)*, *facility=LOG\_USER*, *socktype=socket.SOCK\_DGRAM*, *timeout=None*)[¶](#logging.handlers.SysLogHandler "Link to this definition")
:   Returns a new instance of the [`SysLogHandler`](#logging.handlers.SysLogHandler "logging.handlers.SysLogHandler") class intended to
    ...
    *socktype* argument, which defaults to [`socket.SOCK_DGRAM`](socket.html#socket.SOCK_DGRAM "socket.SOCK_DGRAM") and thus
    ...
    close()[¶](#logging.handlers.SysLogHandler.close "Link to this definition")
    :   Closes the socket to the remote host.

    createSocket()[¶](#logging.handlers.SysLogHandler.createSocket "Link to this definition")
    ...
    emit(*record*)[¶](#logging.handlers.SysLogHandler.emit "Link to this definition")
    ...
    encodePriority(*facility*, *priority*)[¶](#logging.handlers.SysLogHandler.encodePriority "Link to this definition")
    ...
    mapPriority(*levelname*)[¶](#logging.handlers.SysLogHandler.mapPriority "Link to this definition")
...
## NTEventLogHandler[¶](#nteventloghandler "Link to this heading")

The [`NTEventLogHandler`](#logging.handlers.NTEventLogHandler "logging.handlers.NTEventLogHandler") class, located in the `logging.handlers`
module, supports sending logging messages to a local Windows NT, Windows 2000 or
Windows XP event log. Before you can use it, you need Mark Hammond’s Win32
extensions for Python installed.

*class* logging.handlers.NTEventLogHandler(*appname*, *dllname=None*, *logtype='Application'*)[¶](#logging.handlers.NTEventLogHandler "Link to this definition")
:   Returns a new instance of the [`NTEventLogHandler`](#logging.handlers.NTEventLogHandler "logging.handlers.NTEventLogHandler") class. The *appname* is
    ...
    *logtype* is one of `'Application'`, `'System'` or `'Security'`, and
    ...
    close()[¶](#logging.handlers.NTEventLogHandler.close "Link to this definition")
    ...
    emit(*record*)[¶](#logging.handlers.NTEventLogHandler.emit "Link to this definition")
    :   Determines the message ID, event category and event type, and then logs
        the message in the NT event log.

    getEventCategory(*record*)[¶](#logging.handlers.NTEventLogHandler.getEventCategory "Link to this definition")
    :   Returns the event category for the record. Override this if you want to
        specify your own categories. This version returns 0.

    getEventType(*record*)[¶](#logging.handlers.NTEventLogHandler.getEventType "Link to this definition")
    ...
    getMessageID(*record*)[¶](#logging.handlers.NTEventLogHandler.getMessageID "Link to this definition")
...
## SMTPHandler[¶](#smtphandler "Link to this heading")

The [`SMTPHandler`](#logging.handlers.SMTPHandler "logging.handlers.SMTPHandler") class, located in the `logging.handlers` module,
supports sending logging messages to an email address via SMTP.

*class* logging.handlers.SMTPHandler(*mailhost*, *fromaddr*, *toaddrs*, *subject*, *credentials=None*, *secure=None*, *timeout=1.0*)[¶](#logging.handlers.SMTPHandler "Link to this definition")
:   Returns a new instance of the [`SMTPHandler`](#logging.handlers.SMTPHandler "logging.handlers.SMTPHandler") class. The instance is
    ...
    *timeout* argument.
    ...
    emit(*record*)[¶](#logging.handlers.SMTPHandler.emit "Link to this definition")
    :   Formats the record and sends it to the specified addressees.

    getSubject(*record*)[¶](#logging.handlers.SMTPHandler.getSubject "Link to this definition")
    :   If you want to specify a subject line which is record-dependent, override
        this method.

## MemoryHandler[¶](#memoryhandler "Link to this heading")

The [`MemoryHandler`](#logging.handlers.MemoryHandler "logging.handlers.MemoryHandler") class, located in the `logging.handlers` module,
...
*class* logging.handlers.BufferingHandler(*capacity*)[¶](#logging.handlers.BufferingHandler "Link to this definition")
:   Initializes the handler with a buffer of the specified capacity. Here,
    *capacity* means the number of logging records buffered.
    ...
    emit(*record*)[¶](#logging.handlers.BufferingHandler.emit "Link to this definition")
    ...
    flush()[¶](#logging.handlers.BufferingHandler.flush "Link to this definition")
    ...
    shouldFlush(*record*)[¶](#logging.handlers.BufferingHandler.shouldFlush "Link to this definition")
    :   Return `True` if the buffer is up to capacity. This method can be
        overridden to implement custom flushing strategies.

*class* logging.handlers.MemoryHandler(*capacity*, *flushLevel=ERROR*, *target=None*, *flushOnClose=True*)[¶](#logging.handlers.MemoryHandler "Link to this definition")
:   Returns a new instance of the [`MemoryHandler`](#logging.handlers.MemoryHandler "logging.handlers.MemoryHandler") class. The instance is
    ...
    close()[¶](#logging.handlers.MemoryHandler.close "Link to this definition")
    ...
    flush()[¶](#logging.handlers.MemoryHandler.flush "Link to this definition")
    ...
    setTarget(*target*)[¶](#logging.handlers.MemoryHandler.setTarget "Link to this definition")
    :   Sets the target handler for this handler.

    shouldFlush(*record*)[¶](#logging.handlers.MemoryHandler.shouldFlush "Link to this definition")
    :   Checks for buffer full or a record at the *flushLevel* or higher.

## HTTPHandler[¶](#httphandler "Link to this heading")

The [`HTTPHandler`](#logging.handlers.HTTPHandler "logging.handlers.HTTPHandler") class, located in the `logging.handlers` module,
supports sending logging messages to a web server, using either `GET` or
`POST` semantics.

*class* logging.handlers.HTTPHandler(*host*, *url*, *method='GET'*, *secure=False*, *credentials=None*, *context=None*)[¶](#logging.handlers.HTTPHandler "Link to this definition")
:   Returns a new instance of the [`HTTPHandler`](#logging.handlers.HTTPHandler "logging.handlers.HTTPHandler") class. The *host* can be
    ...
    mapLogRecord(*record*)[¶](#logging.handlers.HTTPHandler.mapLogRecord "Link to this definition")
    ...
    emit(*record*)[¶](#logging.handlers.HTTPHandler.emit "Link to this definition")
    ...
    [`setFormatter()`](logging.html#logging.Handler.setFormatter "logging.Handler.setFormatter") to specify a
    [`Formatter`](logging.html#logging.Formatter "logging.Formatter") for a [`HTTPHandler`](#logging.handlers.HTTPHandler "logging.handlers.HTTPHandler") has no effect.
    Instead of calling [`format()`](logging.html#logging.Handler.format "logging.Handler.format"), this handler calls
    [`mapLogRecord()`](#logging.handlers.HTTPHandler.mapLogRecord "logging.handlers.HTTPHandler.mapLogRecord") and then [`urllib.parse.urlencode()`](urllib.parse.html#urllib.parse.urlencode "urllib.parse.urlencode") to encode the
    dictionary in a form suitable for sending to a web server.

## QueueHandler[¶](#queuehandler "Link to this heading")

Added in version 3.2.

The [`QueueHandler`](#logging.handlers.QueueHandler "logging.handlers.QueueHandler") class, located in the `logging.handlers` module,
...
*class* logging.handlers.QueueHandler(*queue*)[¶](#logging.handlers.QueueHandler "Link to this definition")
:   Returns a new instance of the [`QueueHandler`](#logging.handlers.QueueHandler "logging.handlers.QueueHandler") class. The instance is
    ...
    If you are using [`multiprocessing`](multiprocessing.html#module-multiprocessing "multiprocessing: Process-based parallelism."), you should avoid using
    [`SimpleQueue`](queue.html#queue.SimpleQueue "queue.SimpleQueue") and instead use [`multiprocessing.Queue`](multiprocessing.html#multiprocessing.Queue "multiprocessing.Queue").

    Warning

    The [`multiprocessing`](multiprocessing.html#module-multiprocessing "multiprocessing: Process-based parallelism.") module uses an internal logger created and
    accessed via [`get_logger()`](multiprocessing.html#multiprocessing.get_logger "multiprocessing.get_logger").
    [`multiprocessing.Queue`](multiprocessing.html#multiprocessing.Queue "multiprocessing.Queue") will log `DEBUG` level messages upon
    items being queued. If those log messages are processed by a
    [`QueueHandler`](#logging.handlers.QueueHandler "logging.handlers.QueueHandler") using the same [`multiprocessing.Queue`](multiprocessing.html#multiprocessing.Queue "multiprocessing.Queue") instance,
    it will cause a deadlock or infinite recursion.

    emit(*record*)[¶](#logging.handlers.QueueHandler.emit "Link to this definition")
    ...
    prepare(*record*)[¶](#logging.handlers.QueueHandler.prepare "Link to this definition")
    ...
    enqueue(*record*)[¶](#logging.handlers.QueueHandler.enqueue "Link to this definition")
    :   Enqueues the record on the queue using `put_nowait()`; you may
        want to override this if you want to use blocking behaviour, or a
        timeout, or a customized queue implementation.

    listener[¶](#logging.handlers.QueueHandler.listener "Link to this definition")
...
## QueueListener[¶](#queuelistener "Link to this heading")

Added in version 3.2.

The [`QueueListener`](#logging.handlers.QueueListener "logging.handlers.QueueListener") class, located in the `logging.handlers`
...
*class* logging.handlers.QueueListener(*queue*, *\*handlers*, *respect\_handler\_level=False*)[¶](#logging.handlers.QueueListener "Link to this definition")
:   Returns a new instance of the [`QueueListener`](#logging.handlers.QueueListener "logging.handlers.QueueListener") class. The instance is
    ...
    Changed in version 3.14: [`QueueListener`](#logging.handlers.QueueListener "logging.handlers.QueueListener") can now be used as a context manager via
    ...
    [`__enter__()`](stdtypes.html#contextmanager.__enter__ "contextmanager.__enter__") returns the
    [`QueueListener`](#logging.handlers.QueueListener "logging.handlers.QueueListener") object.

    dequeue(*block*)[¶](#logging.handlers.QueueListener.dequeue "Link to this definition")
    ...
    prepare(*record*)[¶](#logging.handlers.QueueListener.prepare "Link to this definition")
    ...
    handle(*record*)[¶](#logging.handlers.QueueListener.handle "Link to this definition")
    :   Handle a record.
    ...
    start()[¶](#logging.handlers.QueueListener.start "Link to this definition")
    :   Starts the listener.

        This starts up a background thread to monitor the queue for
        LogRecords to process.

        Changed in version 3.14: Raises [`RuntimeError`](exceptions.html#RuntimeError "RuntimeError") if called and the listener is already
        running.

    stop()[¶](#logging.handlers.QueueListener.stop "Link to this definition")
    :   Stops the listener.
    ...
    enqueue\_sentinel()[¶](#logging.handlers.QueueListener.enqueue_sentinel "Link to this definition")
...
[`logging.config` — Logging configuration](logging.config.html "previous chapter")

#### Next topic

[`platform` — Access to underlying platform’s identifying data](platform.html "next chapter")

### This page

* [Report a bug](../bugs.html)
* [Improve this page](../improve-page-nojs.html)
* [Show source](https://github.com/python/cpython/blob/main/Doc/library/logging.handlers.rst?plain=1)
