...
* [next](xml.dom.pulldom.html "xml.dom.pulldom — Support for building partial DOM trees") |
* [previous](xml.dom.html "xml.dom — The Document Object Model API") |
...
# `xml.dom.minidom` — Minimal DOM implementation[¶](#module-xml.dom.minidom "Link to this heading")

**Source code:** [Lib/xml/dom/minidom.py](https://github.com/python/cpython/tree/3.14/Lib/xml/dom/minidom.py)
...
xml.dom.minidom.parse(*filename\_or\_file*, *parser=None*, *bufsize=None*)[¶](#xml.dom.minidom.parse "Link to this definition")
...
xml.dom.minidom.parseString(*string*, *parser=None*)[¶](#xml.dom.minidom.parseString "Link to this definition")
...
## DOM Objects[¶](#dom-objects "Link to this heading")

The definition of the DOM API for Python is given as part of the [`xml.dom`](xml.dom.html#module-xml.dom "xml.dom: Document Object Model API for Python.")
...
Node.writexml(*writer*, *indent=''*, *addindent=''*, *newl=''*, *encoding=None*, *standalone=None*)[¶](#xml.dom.minidom.Node.writexml "Link to this definition")
...
Node.toxml(*encoding=None*, *standalone=None*)[¶](#xml.dom.minidom.Node.toxml "Link to this definition")
:   Return a string or byte string containing the XML represented by
    the DOM node.

    With an explicit *encoding* [[1]](#id3) argument, the result is a byte
...
Node.toprettyxml(*indent='\t'*, *newl='\n'*, *encoding=None*, *standalone=None*)[¶](#xml.dom.minidom.Node.toprettyxml "Link to this definition")
...
## DOM Example[¶](#dom-example "Link to this heading")
...
## minidom and the DOM standard[¶](#minidom-and-the-dom-standard "Link to this heading")
...
* [`xml.dom.minidom` — Minimal DOM implementation](#)
  ...
  + [minidom and the DOM standard](#minidom-and-the-dom-standard)

#### Previous topic

[`xml.dom` — The Document Object Model API](xml.dom.html "previous chapter")

#### Next topic

[`xml.dom.pulldom` — Support for building partial DOM trees](xml.dom.pulldom.html "next chapter")

### This page

* [Report a bug](../bugs.html)
* [Improve this page](../improve-page-nojs.html)
* [Show source](https://github.com/python/cpython/blob/main/Doc/library/xml.dom.minidom.rst?plain=1)
