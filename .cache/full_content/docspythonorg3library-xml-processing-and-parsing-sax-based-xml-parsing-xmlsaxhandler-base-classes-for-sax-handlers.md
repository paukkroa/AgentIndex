...
* [next](xml.sax.utils.html "xml.sax.saxutils — SAX Utilities") |
* [previous](xml.sax.html "xml.sax — Support for SAX2 parsers") |
...
# `xml.sax.handler` — Base classes for SAX handlers[¶](#module-xml.sax.handler "Link to this heading")

**Source code:** [Lib/xml/sax/handler.py](https://github.com/python/cpython/tree/3.14/Lib/xml/sax/handler.py)
...
*class* xml.sax.handler.ContentHandler[¶](#xml.sax.handler.ContentHandler "Link to this definition")
...
*class* xml.sax.handler.DTDHandler[¶](#xml.sax.handler.DTDHandler "Link to this definition")
:   Handle DTD events.

    This interface specifies only those DTD events required for basic parsing
    (unparsed entities and attributes).

*class* xml.sax.handler.EntityResolver[¶](#xml.sax.handler.EntityResolver "Link to this definition")
...
*class* xml.sax.handler.ErrorHandler[¶](#xml.sax.handler.ErrorHandler "Link to this definition")
...
*class* xml.sax.handler.LexicalHandler[¶](#xml.sax.handler.LexicalHandler "Link to this definition")
...
## ContentHandler Objects[¶](#contenthandler-objects "Link to this heading")
...
ContentHandler.setDocumentLocator(*locator*)[¶](#xml.sax.handler.ContentHandler.setDocumentLocator "Link to this definition")
...
ContentHandler.startPrefixMapping(*prefix*, *uri*)[¶](#xml.sax.handler.ContentHandler.startPrefixMapping "Link to this definition")
...
ContentHandler.endPrefixMapping(*prefix*)[¶](#xml.sax.handler.ContentHandler.endPrefixMapping "Link to this definition")
...
ContentHandler.startElement(*name*, *attrs*)[¶](#xml.sax.handler.ContentHandler.startElement "Link to this definition")
:   Signals the start of an element in non-namespace mode.

    The *name* parameter contains the raw XML 1.0 name of the element type as a
    string and the *attrs* parameter holds an object of the
    [Attributes](xml.sax.reader.html#attributes-objects) interface containing the attributes of
...
ContentHandler.endElement(*name*)[¶](#xml.sax.handler.ContentHandler.endElement "Link to this definition")
...
ContentHandler.startElementNS(*name*, *qname*, *attrs*)[¶](#xml.sax.handler.ContentHandler.startElementNS "Link to this definition")
:   Signals the start of an element in namespace mode.

    The *name* parameter contains the name of the element type as a `(uri,
    localname)` tuple, the *qname* parameter contains the raw XML 1.0 name used in
    the source document, and the *attrs* parameter holds an instance of the
    [AttributesNS](xml.sax.reader.html#attributes-ns-objects) interface
...
ContentHandler.endElementNS(*name*, *qname*)[¶](#xml.sax.handler.ContentHandler.endElementNS "Link to this definition")
...
ContentHandler.characters(*content*)[¶](#xml.sax.handler.ContentHandler.characters "Link to this definition")
...
ContentHandler.ignorableWhitespace(*whitespace*)[¶](#xml.sax.handler.ContentHandler.ignorableWhitespace "Link to this definition")
...
ContentHandler.processingInstruction(*target*, *data*)[¶](#xml.sax.handler.ContentHandler.processingInstruction "Link to this definition")
...
ContentHandler.skippedEntity(*name*)[¶](#xml.sax.handler.ContentHandler.skippedEntity "Link to this definition")
...
## DTDHandler Objects[¶](#dtdhandler-objects "Link to this heading")

[`DTDHandler`](#xml.sax.handler.DTDHandler "xml.sax.handler.DTDHandler") instances provide the following methods:

DTDHandler.notationDecl(*name*, *publicId*, *systemId*)[¶](#xml.sax.handler.DTDHandler.notationDecl "Link to this definition")
:   Handle a notation declaration event.

DTDHandler.unparsedEntityDecl(*name*, *publicId*, *systemId*, *ndata*)[¶](#xml.sax.handler.DTDHandler.unparsedEntityDecl "Link to this definition")
:   Handle an unparsed entity declaration event.

## EntityResolver Objects[¶](#entityresolver-objects "Link to this heading")

EntityResolver.resolveEntity(*publicId*, *systemId*)[¶](#xml.sax.handler.EntityResolver.resolveEntity "Link to this definition")
...
## ErrorHandler Objects[¶](#errorhandler-objects "Link to this heading")
...
ErrorHandler.error(*exception*)[¶](#xml.sax.handler.ErrorHandler.error "Link to this definition")
...
ErrorHandler.fatalError(*exception*)[¶](#xml.sax.handler.ErrorHandler.fatalError "Link to this definition")
...
ErrorHandler.warning(*exception*)[¶](#xml.sax.handler.ErrorHandler.warning "Link to this definition")
...
## LexicalHandler Objects[¶](#lexicalhandler-objects "Link to this heading")
...
LexicalHandler.comment(*content*)[¶](#xml.sax.handler.LexicalHandler.comment "Link to this definition")
:   Reports a comment anywhere in the document (including the DTD and
    outside the document element).

LexicalHandler.startDTD(*name*, *public\_id*, *system\_id*)[¶](#xml.sax.handler.LexicalHandler.startDTD "Link to this definition")
...
* [`xml.sax.handler` — Base classes for SAX handlers](#)
  ...
  + [DTDHandler Objects](#dtdhandler-objects)
  + [EntityResolver Objects](#entityresolver-objects)
  + [ErrorHandler Objects](#errorhandler-objects)
  + [LexicalHandler Objects](#lexicalhandler-objects)

#### Previous topic

[`xml.sax` — Support for SAX2 parsers](xml.sax.html "previous chapter")

#### Next topic

[`xml.sax.saxutils` — SAX Utilities](xml.sax.utils.html "next chapter")
